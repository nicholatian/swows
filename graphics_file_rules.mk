...
$(INTROGFXDIR)/copyright.4bpp.lz: $(INTROGFXDIR)/copyright.png
	$(GRIT) $< -gzl -gB4 -m -mzl -mRtf -pn16 -fh! -ftb -o$@ ; mv $(INTROGFXDIR)/copyright.img.bin $@ ; mv $(INTROGFXDIR)/copyright.map.bin $(INTROGFXDIR)/copyright.bin.lz ; mv $(INTROGFXDIR)/copyright.pal.bin $(INTROGFXDIR)/copyright.gbapal

$(INTROGFXDIR)/copyright.map.bin: $(INTROGFXDIR)/copyright.4bpp.lz ;
$(INTROGFXDIR)/copyright.bin.lz: $(INTROGFXDIR)/copyright.map.bin ;
$(INTROGFXDIR)/copyright.pal.bin: $(INTROGFXDIR)/copyright.4bpp.lz ;
$(INTROGFXDIR)/copyright.gbapal: $(INTROGFXDIR)/copyright.pal.bin ;
