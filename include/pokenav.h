...
enum
{
	...
	POKENAV_MODE_FORCE_CALL_1, // Used for the script's special. Has to
				   // choose Match Call and make a call.
	POKENAV_MODE_FORCE_CALL_2, // Set after making a call, has to exit
				   // Pokenav.
};
