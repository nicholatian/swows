...
$(EVENTOBJGFXDIR)/people/team_quaz/quaz_member_m.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/team_quaz/quaz_member_f.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/team_ccacc/ccacc_member_m.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/team_ccacc/ccacc_member_f.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/team_magma/courtney.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/team_magma/tabitha.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/team_aqua/shelley.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/team_aqua/matt.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/team_quaz/sammi.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/team_quaz/dean.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/team_ccacc/alexis.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/team_ccacc/jack.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/team_quaz/roland.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/team_ccacc/janis.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/hideki.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))

$(EVENTOBJGFXDIR)/people/interpol_employee.4bpp: %.4bpp: %.png
	$(call COMWRAP,$(GFX) $< $@ -mwidth 2 -mheight 4,$(COMWRAP_GFX))
