...
const u16 CryMeterNeedlePalette[] =
	INCBIN_U16( "graphics/pokedex/cry_meter_needle.gbapal" );
const u8 CryMeterNeedleTiles[] =
	INCBIN_U8( "graphics/pokedex/cry_meter_needle.4bpp" );

const u16 gUnknown_085B8378[] =
	INCBIN_U16( "graphics/pokedex/cry_meter_map.bin" );
const u16 gUnknown_085B8418[] =
	INCBIN_U16( "graphics/pokedex/cry_meter.gbapal" );
const u8 gUnknown_085B8438[] =
	INCBIN_U8( "graphics/pokedex/cry_meter.4bpp.lz" );

const u16 gUnknown_085B8770[][72] = {{0x0000,
					     0x0004,
					     0x0008,
					     0x000C,
					     0x0010,
...
const u16 gUnknown_085B8BF0[] =
	INCBIN_U16( "graphics/pokedex/85B8C10.gbapal" );
const u8 gUnknown_085B8C10[] = INCBIN_U8( "graphics/pokedex/85B8C10.4bpp" );

const u8 gUnknown_085B8C30[]     = {0xF0, 0x0F};
const u8 gUnknown_085B8C32[][16] = {{0x0F,
					    0x0E,
					    0x0D,
					    0x0C,
					    0x0B,
...
const union AnimCmd* const gSpriteAnimTable_85B8C5C[] = {gSpriteAnim_85B8C54};
...
const struct SpriteTemplate gUnknown_085B8C68 = {0x2000,
	0x2000,
	&gOamData_85B8C60,
...
bool8 sub_8145354( struct CryRelatedStruct* arg0, u8 windowId )
{
	...
	case 0:
		...
		{
			sDexCryScreen =
				AllocZeroed( sizeof( *sDexCryScreen ) );
			sCryWaveformWindowTiledata = (u8*)GetWindowAttribute(
				windowId, WINDOW_TILE_DATA );
		}
...
void sub_814545C( u8 windowId )
{
	...
	sub_81456A8( sDexCryScreen->unk16 * 8 + sDexCryScreen->unk11 - 2,
		sDexCryScreen->unk0[var0] );
	sub_81456A8( sDexCryScreen->unk16 * 8 + sDexCryScreen->unk11 - 1,
		sDexCryScreen->unk0[var0 + 1] );
	sDexCryScreen->unk10++;
}
...
static void sub_81455A8( void )
{
	...
	if( gPcmDmaCounter < 2 )
		...
		baseBuffer = gSoundInfo.pcmBuffer +
			( gSoundInfo.pcmDmaPeriod + 1 - gPcmDmaCounter ) *
...
static void sub_81456A8( u8 a0, u8 a1 )
{
	...
	if( i > sDexCryScreen->unk12 )
	{
		do
		{
			offset = gUnknown_085B8770[a0 & 0x7][i] +
				( a0 / 8 ) * TILE_SIZE_4BPP;
			sCryWaveformWindowTiledata[offset] &=
				gUnknown_085B8C30[r6];
			sCryWaveformWindowTiledata[offset] |=
				gUnknown_085B8C32[r6]
						 [( ( i / 3 ) - 1 ) & 0x0F];
			i--;
...
static void sub_8145814( u8 windowId ) { CopyWindowToVram( windowId, 2 ); }
...
bool8 sub_8145850( struct CryRelatedStruct* arg0, u8 windowId )
{
	...
	case 0:
		if( !sCryVolumeMeter )
			sCryVolumeMeter =
				AllocZeroed( sizeof( *sCryVolumeMeter ) );
	...
	case 1:
		...
		sCryVolumeMeter->needleSpriteId =
			CreateSprite( &gUnknown_085B8C68,
				40 + arg0->xPos * 8,
				56 + arg0->yPos * 8,
				1 );
...
void sub_8145914( void )
{
	FreeSpritePaletteByTag( GetSpritePaletteTagByPaletteNum(
		gSprites[sCryVolumeMeter->needleSpriteId].oam.paletteNum ) );
...
static void sub_814596C( struct Sprite* sprite )
{
	...
	gSprites[sCryVolumeMeter->needleSpriteId].oam.affineMode =
