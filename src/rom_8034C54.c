...
// const rom data
static const u8 gUnknown_082FF1C8[][4] = {{0x01, 0x04, 0x10, 0x40},
	{0x02, 0x04, 0x08, 0x20},
	{0x02, 0x04, 0x08, 0x20},
	{0x00, 0x00, 0x00, 0x00}};
...
bool32 sub_8034C54( u32 count )
{
	...
	gUnknown_02022E10->array =
		Alloc( sizeof( struct UnkStruct2 ) * count );
...
bool32 sub_8034D14( u32 id, s32 arg1, const struct UnkStruct3* arg2 )
{
	...
	gUnknown_02022E10->array[id].tileStart =
		GetSpriteTileStartByTag( arg2->spriteSheet->tag );
	if( gUnknown_02022E10->array[id].tileStart == 0xFFFF )
	{
		if( arg2->spriteSheet->size != 0 )
		{
			gUnknown_02022E10->array[id].tileStart =
				LoadSpriteSheet( arg2->spriteSheet );
		}
		else
		{
			struct CompressedSpriteSheet compSpriteSheet;

			compSpriteSheet      = *(struct
                                CompressedSpriteSheet*)( arg2->spriteSheet );
			compSpriteSheet.size = GetDecompressedDataSize(
				arg2->spriteSheet->data );
			gUnknown_02022E10->array[id].tileStart =
	...
	gUnknown_02022E10->array[id].palTagIndex =
		IndexOfSpritePaletteTag( arg2->spritePal->tag );
	if( gUnknown_02022E10->array[id].palTagIndex == 0xFF )
		gUnknown_02022E10->array[id].palTagIndex =
			LoadSpritePalette( arg2->spritePal );
	...
	gUnknown_02022E10->array[id].field_9 =
		sub_80355F8( arg2->shape, arg2->size );
...
static void sub_8034EFC( struct UnkStruct2* arg0 )
{
	...
	CpuFill16( 0,
		...
		sizeof( struct OamData ) * oamCount );
	...
	gMain.oamBuffer[oamId].tileNum =
		arg0->tileStart + ( arg0->field_9 * 10 );
}
...
static void sub_80350B0( struct UnkStruct2* arg0, s32 arg1, bool32 arg2 )
{
	...
	while( r5 != 0 )
	{
		...
		gMain.oamBuffer[oamId].tileNum =
			( r4 * arg0->field_9 ) + arg0->tileStart;
		oamId++;
	}
...
static void sub_8035164( struct UnkStruct2* arg0, s32 arg1, bool32 arg2 )
{
	...
	while( r5 != 0 )
	{
		...
		{
			gMain.oamBuffer[gUnknown_03000DD4].tileNum =
				( r4 * arg0->field_9 ) + arg0->tileStart;
	...
	{
		gMain.oamBuffer[gUnknown_03000DD4].affineMode = 0;
		gMain.oamBuffer[gUnknown_03000DD4].x =
			arg0->x + ( ( gUnknown_03000DDC - 1 ) * arg0->xDelta );
	}
	else
	{
		gMain.oamBuffer[gUnknown_03000DD4].affineMode = 2;
...
static u8 sub_8035518( u8 arg0 )
{
	...
	for( i = 0; i < gUnknown_02022E10->count; i++ )
	{
		...
		{
			if( gUnknown_02022E10->array[i].firstOamId != 0xFF &&
				gUnknown_02022E10->array[i].oamCount <= arg0 )
...
static bool32 SharesTileWithAnyActive( u32 id )
{
	...
	for( i = 0; i < gUnknown_02022E10->count; i++ )
	{
		if( gUnknown_02022E10->array[i].isActive && i != id &&
			gUnknown_02022E10->array[i].tileTag ==
				gUnknown_02022E10->array[id].tileTag )
		{
			return TRUE;
		}
	}
...
static bool32 SharesPalWithAnyActive( u32 id )
{
	...
	{
		if( gUnknown_02022E10->array[i].isActive && i != id &&
			gUnknown_02022E10->array[i].palTag ==
				gUnknown_02022E10->array[id].palTag )
		{
			return TRUE;
		}
	}
