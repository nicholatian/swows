...
static const u8 sText_PkmnPickedUpItem[] =
...
static const u8 sText_PkmnsStatChanged[] =
	_( "{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1}\n{B_BUFF2}" );
const u8 gText_PkmnsStatChanged2[] =
	_( "{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}\n{B_BUFF2}" );
static const u8 sText_UsingXTheYOfZN[] = _(
	"Using {B_LAST_ITEM}, the {B_BUFF1}\nof {B_SCR_ACTIVE_NAME_WITH_PREFIX} {B_BUFF2}" );
static const u8 sText_PkmnsStatChanged3[] =
	_( "{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1}\n{B_BUFF2}" );
static const u8 sText_PkmnsStatChanged4[] =
	_( "{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}\n{B_BUFF2}" );
...
static const u8 sText_WildFled[] =
	_( "{PLAY_SE 0x0011}{B_LINK_OPPONENT1_NAME} fled!" );
static const u8 sText_TwoWildFled[] = _(
	"{PLAY_SE 0x0011}{B_LINK_OPPONENT1_NAME} and\n{B_LINK_OPPONENT2_NAME} fled!" );
...
static const u8 sText_OutOfSafariBalls[] = _(
	"{PLAY_SE 0x0049}ANNOUNCER: You're out of\nSAFARI BALLS! Game over!\p" );
...
static const u8 sText_WildPkmnAppeared2[] =
	_( "Wild {B_OPPONENT_MON1_NAME} appeared!\p" );
...
const u8* const gStatNamesTable[] = {sText_HP2,
	sText_Attack2,
	sText_Defense2,
	sText_Speed,
	sText_SpAtk2,
...
const u8* const gPokeblockWasTooXStringTable[] = {sText_PokeblockWasTooSpicy,
...
const u8* const gBattleStringsTable[BATTLESTRINGS_COUNT] = {
	...
	[STRINGID_PKMNBUFFETEDBYSANDSTORM - 12] =
	...
	[STRINGID_PKMNPREVENTSPARALYSISWITH - 12] =
		sText_PkmnPreventsParalysisWith,
	[STRINGID_PKMNPREVENTSROMANCEWITH - 12] =
		sText_PkmnPreventsRomanceWith,
	[STRINGID_PKMNPREVENTSPOISONINGWITH - 12] =
		sText_PkmnPreventsPoisoningWith,
	[STRINGID_PKMNPREVENTSCONFUSIONWITH - 12] =
		sText_PkmnPreventsConfusionWith,
	[STRINGID_PKMNRAISEDFIREPOWERWITH - 12] =
	...
	[STRINGID_PKMNPREVENTSSTATLOSSWITH - 12] =
	...
	[STRINGID_PKMNSITEMCUREDPARALYSIS - 12] =
	...
	[STRINGID_PKMNSXRESTOREDHPALITTLE2 - 12] =
		sText_PkmnsXRestoredHPALittle2,
	[STRINGID_PKMNSXWHIPPEDUPSANDSTORM - 12] =
	...
	[STRINGID_PLAYERDEFEATEDTRAINER1 - 12] =
	...
	[STRINGID_PKMNSITEMNORMALIZEDSTATUS - 12] =
	...
	[STRINGID_PKMNSXMADEITINEFFECTIVE - 12] =
		sText_PkmnsXMadeItIneffective,
	[STRINGID_PKMNSXPREVENTSFLINCHING - 12] =
	...
	[STRINGID_PKMNOBTAINEDXYOBTAINEDZ - 12] =
	...
	[STRINGID_PKMNGETTINGINTOPOSITION - 12] =
		sText_PkmnGettingIntoPosition,
	[STRINGID_PKMNBEGANGROWLINGDEEPLY - 12] =
		sText_PkmnBeganGrowlingDeeply,
	[STRINGID_PKMNEAGERFORMORE - 12] = sText_PkmnEagerForMore,
	[STRINGID_DEFEATEDOPPONENTBYREFEREE - 12] =
		sText_DefeatedOpponentByReferee,
	[STRINGID_LOSTTOOPPONENTBYREFEREE - 12] =
	...
	[STRINGID_PKMNTRANSFERREDSOMEONESPC - 12] =
		gText_PkmnTransferredSomeonesPC,
	[STRINGID_PKMNTRANSFERREDLANETTESPC - 12] =
...
const u16 gRainContinuesStringIds[] = {STRINGID_RAINCONTINUES,
	STRINGID_DOWNPOURCONTINUES,
	STRINGID_RAINSTOPPED};

const u16 gProtectLikeUsedStringIds[] = {STRINGID_PKMNPROTECTEDITSELF2,
...
const u16 gUproarAwakeStringIds[] = {STRINGID_PKMNCANTSLEEPINUPROAR2,
...
const u16 gFirstTurnOfTwoStringIds[] = {STRINGID_PKMNWHIPPEDWHIRLWIND,
...
const u16 gWrappedStringIds[] = {STRINGID_PKMNSQUEEZEDBYBIND,
...
const u16 gWeatherContinuesStringIds[] = {STRINGID_ITISRAINING,
...
const u16 gSafariPokeblockResultStringIds[] = {STRINGID_PKMNCURIOUSABOUTX,
...
const u16 gBRNPreventionStringIds[] = {STRINGID_PKMNSXPREVENTSBURNS,
	STRINGID_PKMNSXPREVENTSYSZ,
	STRINGID_PKMNSXHADNOEFFECTONY};

const u16 gPRLZPreventionStringIds[] = {STRINGID_PKMNPREVENTSPARALYSISWITH,
	STRINGID_PKMNSXPREVENTSYSZ,
	STRINGID_PKMNSXHADNOEFFECTONY};

const u16 gPSNPreventionStringIds[] = {STRINGID_PKMNPREVENTSPOISONINGWITH,
	STRINGID_PKMNSXPREVENTSYSZ,
	STRINGID_PKMNSXHADNOEFFECTONY};

const u16 gItemSwapStringIds[] = {STRINGID_PKMNOBTAINEDX,
...
const u16 gTrappingMoves[] = {MOVE_BIND,
	MOVE_WRAP,
	MOVE_FIRE_SPIN,
	MOVE_CLAMP,
	MOVE_WHIRLPOOL,
...
const u8 gText_MoveInterfaceDynamicColors[] = _(
	"{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}" );
...
static const u8 sATypeMove_Table[][17] = {_( "a NORMAL move" ),
	_( "a FIGHTING move" ),
	_( "a FLYING move" ),
	_( "a POISON move" ),
	_( "a GROUND move" ),
...
const u8* const gRoundsStringTable[] = {
	sText_Round1, sText_Round2, sText_Semifinal, sText_Final};

const u8 gText_TheGreatNewHope[] = _( "The great new hope!\p" );
const u8 gText_WillChampinshipDreamComeTrue[] =
...
const u16 gStringIds_85CCF0A[] = {STRINGID_GLINTAPPEARSINEYE,
...
static const u8 sText_RefJudgement3[] =
...
static const u8 sText_Trainer1Fled[] =
	_( "{PLAY_SE 0x0011}{B_TRAINER1_CLASS} {B_TRAINER1_NAME} fled!" );
...
// to the default. See the documentation for ChooseTypeOfMoveUsedString for
// more detail.
...
static const u8 sDummyWeirdStatusString[] = {
	EOS, EOS, EOS, EOS, EOS, EOS, EOS, EOS, 0, 0};

static const struct BattleWindowText sTextOnWindowsInfo_Normal[] = {
	// The corresponding WindowTemplate is gStandardBattleWindowTemplates[]
	// within src/battle_bg.c
	{
...
void BufferStringBattle( u16 stringID )
{
	...
	*( &gBattleStruct->stringMoveType ) = gBattleMsgDataPtr->moveType;
	...
	case STRINGID_INTROMSG: // first battle msg
		...
		else
		{
			if( gBattleTypeFlags & BATTLE_TYPE_LEGENDARY )
				...
				BATTLE_TYPE_DOUBLE ) // interesting,
						     // looks like
						     // they had
						     // something
						     // planned for
	...
	case STRINGID_INTROSENDOUT: // poke first send-out
		...
		else
		{
			...
			else
			{
				...
				else if( gTrainerBattleOpponent_A ==
					TRAINER_OPPONENT_C00 )
					stringPtr = sText_Trainer1SentOutPkmn;
				else
					stringPtr =
	...
	case STRINGID_SWITCHINMON: // switch-in msg
		if( GetBattlerSide( gBattleScripting.battler ) ==
			B_SIDE_PLAYER )
		{
			if( *( &gBattleStruct->hpScale ) == 0 ||
				gBattleTypeFlags & BATTLE_TYPE_DOUBLE )
	...
	case STRINGID_USEDMOVE: // pokemon used a move msg
		ChooseMoveUsedParticle(
			gBattleTextBuff1 ); // buff1 doesn't appear in
					    // the string, leftover
					    // from japanese move
					    // names
...
static const u8* TryGetStatusString( u8* src )
{
	...
	{
		if( chars1 ==
				*(u32*)( &gStatusConditionStringsTable[i][0]
								      [0] ) &&
			chars2 ==
				*(u32*)( &gStatusConditionStringsTable[i][0]
								      [4] ) )
...
#define HANDLE_NICKNAME_STRING_CASE( battlerId, monIndex ) \
	...
	{ \
		...
		GetMonData( \
			&gEnemyParty[monIndex], MON_DATA_NICKNAME, text ); \
	} \
	else \
	{ \
		GetMonData( \
			&gPlayerParty[monIndex], MON_DATA_NICKNAME, text ); \
	} \
	StringGetEnd10( text ); \
	toCpy = text;
	...
	while( *src != EOS )
	{
		if( *src == PLACEHOLDER_BEGIN )
		{
			...
			case B_TXT_PLAYER_MON2_NAME: // second player poke name
				...
				toCpy = text;
				break;
			case B_TXT_OPPONENT_MON2_NAME: // second enemy poke
						       // name
				GetMonData(
					&gEnemyParty[gBattlerPartyIndexes[GetBattlerAtPosition(
				...
				toCpy = text;
				break;
			case B_TXT_LINK_PLAYER_MON1_NAME: // link first player
							  // poke name
				GetMonData(
					&gPlayerParty[gBattlerPartyIndexes
							[gLinkPlayers[multiplayerId]
									.id]],
					MON_DATA_NICKNAME,
					text );
				StringGetEnd10( text );
				toCpy = text;
				break;
			case B_TXT_LINK_OPPONENT_MON1_NAME: // link first
							    // opponent poke
							    // name
				GetMonData(
				...
				toCpy = text;
				break;
			case B_TXT_LINK_PLAYER_MON2_NAME: // link second player
							  // poke name
				GetMonData(
					&gPlayerParty[gBattlerPartyIndexes
							[gLinkPlayers[multiplayerId]
				...
				toCpy = text;
				break;
			case B_TXT_LINK_OPPONENT_MON2_NAME: // link second
							    // opponent poke
							    // name
				GetMonData(
					&gEnemyParty[gBattlerPartyIndexes
				...
				toCpy = text;
				break;
			case B_TXT_ATK_NAME_WITH_PREFIX_MON1: // attacker name
							      // with prefix,
							      // only battlerId
							      // 0/1
			...
			case B_TXT_ATK_PARTNER_NAME: // attacker partner name
				if( GetBattlerSide( gBattlerAttacker ) ==
					...
					GetMonData(
						&gPlayerParty[gBattlerPartyIndexes
								[GetBattlerAtPosition( GET_BATTLER_SIDE(
									 gBattlerAttacker ) ) +
									2]],
						MON_DATA_NICKNAME,
						text );
				...
				toCpy = text;
				break;
			case B_TXT_ATK_NAME_WITH_PREFIX: // attacker name with
							 // prefix
				HANDLE_NICKNAME_STRING_CASE( gBattlerAttacker,
					gBattlerPartyIndexes
						[gBattlerAttacker] )
				break;
			case B_TXT_DEF_NAME_WITH_PREFIX: // target name with
							 // prefix
				HANDLE_NICKNAME_STRING_CASE( gBattlerTarget,
					gBattlerPartyIndexes[gBattlerTarget] )
				break;
			case B_TXT_EFF_NAME_WITH_PREFIX: // effect battlerId
							 // name with prefix
				HANDLE_NICKNAME_STRING_CASE( gEffectBattler,
					gBattlerPartyIndexes[gEffectBattler] )
				break;
			case B_TXT_ACTIVE_NAME_WITH_PREFIX: // active battlerId
							    // name with prefix
				HANDLE_NICKNAME_STRING_CASE( gActiveBattler,
					gBattlerPartyIndexes[gActiveBattler] )
				break;
			case B_TXT_SCR_ACTIVE_NAME_WITH_PREFIX: // scripting
								// active
								// battlerId
								// name with
								// prefix
			...
			case B_TXT_CURRENT_MOVE: // current move name
				if( gBattleMsgDataPtr->currentMove >=
					MOVES_COUNT )
					toCpy = sATypeMove_Table
						[gBattleStruct->stringMoveType];
				else
					toCpy = gMoveNames
						[gBattleMsgDataPtr
			...
			case B_TXT_LAST_MOVE: // originally used move name
				if( gBattleMsgDataPtr->originallyUsedMove >=
					MOVES_COUNT )
					toCpy = sATypeMove_Table
						[gBattleStruct->stringMoveType];
				else
						...
						BATTLE_TYPE_x2000000 ) )
				{
						...
						ITEM_ENIGMA_BERRY )
					{
						if( !( gBattleTypeFlags &
							    BATTLE_TYPE_MULTI ) )
						{
							if( ( gBattleScripting.multiplayerId !=
									    0 &&
								    ( gPotentialItemEffectBattler &
									    BIT_SIDE ) ) ||
								( gBattleScripting.multiplayerId ==
										0 &&
									!( gPotentialItemEffectBattler &
										BIT_SIDE ) ) )
							{
						...
						{
							if( gLinkPlayers[gBattleScripting
										 .multiplayerId]
									.id ==
								gPotentialItemEffectBattler )
							{
			...
			case B_TXT_DEF_ABILITY: // target ability
				...
				break;
			case B_TXT_SCR_ACTIVE_ABILITY: // scripting active
						       // ability
				toCpy = gAbilityNames[sBattlerAbilities
						[gBattleScripting.battler]];
				break;
			...
			case B_TXT_TRAINER1_NAME: // trainer1 name
					...
					BATTLE_TYPE_SECRET_BASE )
				{
					...
					TRAINER_OPPONENT_C00 )
				{
					toCpy = gLinkPlayers[multiplayerId ^
						BIT_SIDE]
							.name;
				}
				else if( gTrainerBattleOpponent_A ==
					...
					BATTLE_TYPE_FRONTIER )
				{
					...
					BATTLE_TYPE_TRAINER_HILL )
				{
					GetTrainerHillTrainerName( text,
						gTrainerBattleOpponent_A );
					toCpy = text;
				}
				else if( gBattleTypeFlags &
			...
			case B_TXT_LINK_PARTNER_NAME: // link partner name
				toCpy = gLinkPlayers
						[GetBattlerMultiplayerId( BATTLE_PARTNER(
							 gLinkPlayers
								 [multiplayerId]
									 .id ) )]
							.name;
			...
			case B_TXT_LINK_OPPONENT1_NAME: // link opponent 1 name
				toCpy = gLinkPlayers
						[GetBattlerMultiplayerId( BATTLE_OPPOSITE(
							 gLinkPlayers
								 [multiplayerId]
									 .id ) )]
							.name;
			...
			case B_TXT_LINK_OPPONENT2_NAME: // link opponent 2 name
				toCpy = gLinkPlayers
						[GetBattlerMultiplayerId(
							...
							.name;
				break;
			case B_TXT_LINK_SCR_TRAINER_NAME: // link scripting
							  // active name
				toCpy = gLinkPlayers
						[GetBattlerMultiplayerId(
							 gBattleScripting
			...
			case B_TXT_TRAINER2_CLASS:
				if( gBattleTypeFlags & BATTLE_TYPE_FRONTIER )
					...
					toCpy = gTrainerClassNames
						[gTrainers[gTrainerBattleOpponent_B]
								.trainerClass];
				break;
	...
	*dst = EOS;
	while( src[srcID] != B_BUFF_EOS )
	{
		...
		case B_BUFF_MON_NICK_WITH_PREFIX: // poke nick with prefix
			...
			{
				GetMonData( &gPlayerParty[src[srcID + 2]],
					MON_DATA_NICKNAME,
					text );
			}
			else
			{
				if( gBattleTypeFlags & BATTLE_TYPE_TRAINER )
					StringAppend(
						dst, sText_FoePkmnPrefix );
				else
					StringAppend(
						dst, sText_WildPkmnPrefix );

				GetMonData( &gEnemyParty[src[srcID + 2]],
					MON_DATA_NICKNAME,
					text );
			}
			StringGetEnd10( text );
		...
		case B_BUFF_NEGATIVE_FLAVOR: // flavor table
			StringAppend( dst,
				gPokeblockWasTooXStringTable[src[srcID + 1]] );
			srcID += 2;
			break;
...
void BattlePutTextOnWindow( const u8* text, u8 windowId )
{
	...
	else
	{
		FillWindowPixelBuffer(
			windowId, textInfo[windowId].fillValue );
		copyToVram = TRUE;
	}
	...
	{
		u32 width =
			sub_80397C4( gBattleScripting.windowsType, windowId );
		s32 alignX = GetStringCenterAlignXOffsetWithLetterSpacing(
			printerTemplate.fontId,
	...
	if( windowId == 0 || windowId == 0x16 )
	{
		if( gBattleTypeFlags &
			...
			speed = sRecordedBattleTextSpeeds
...
void SetPpNumbersPaletteInMoveSelection( void )
{
	...
	u8 var            = GetCurrentPpToMaxPpState(
                chooseMoveStruct
                        ->currentPp[gMoveSelectionCursor[gActiveBattler]],
                chooseMoveStruct
                        ->maxPp[gMoveSelectionCursor[gActiveBattler]] );

	gPlttBufferUnfaded[92] = palPtr[( var * 2 ) + 0];
	gPlttBufferUnfaded[91] = palPtr[( var * 2 ) + 1];

	CpuCopy16( &gPlttBufferUnfaded[92],
		&gPlttBufferFaded[92],
		sizeof( u16 ) );
	CpuCopy16( &gPlttBufferUnfaded[91],
		&gPlttBufferFaded[91],
		sizeof( u16 ) );
}
