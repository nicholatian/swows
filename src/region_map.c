...
static void CalcZoomScrollParams(
	s16 scrollX, s16 scrollY, s16 c, s16 d, u16 e, u16 f, u8 rotation );
...
static const u16 sRegionMapCursorPal[] =
	INCBIN_U16( "graphics/pokenav/cursor.gbapal" );
static const u32 sRegionMapCursorSmallGfxLZ[] =
	INCBIN_U32( "graphics/pokenav/cursor_small.4bpp.lz" );
static const u32 sRegionMapCursorLargeGfxLZ[] =
	INCBIN_U32( "graphics/pokenav/cursor_large.4bpp.lz" );
static const u16 sRegionMapBkgnd_Pal[] =
	INCBIN_U16( "graphics/pokenav/region_map.gbapal" );
static const u32 sRegionMapBkgnd_GfxLZ[] =
	INCBIN_U32( "graphics/pokenav/region_map.8bpp.lz" );
static const u32 sRegionMapBkgnd_TilemapLZ[] =
	INCBIN_U32( "graphics/pokenav/region_map_map.bin.lz" );
...
static const u8 sRegionMapPlayerIcon_BrendanGfx[] =
	INCBIN_U8( "graphics/pokenav/brendan_icon.4bpp" );
static const u16 sRegionMapPlayerIcon_MayPal[] =
	INCBIN_U16( "graphics/pokenav/may_icon.gbapal" );
static const u8 sRegionMapPlayerIcon_MayGfx[] =
	INCBIN_U8( "graphics/pokenav/may_icon.4bpp" );
...
static const u16 sRegionMap_MarineCaveMapSecIds[] = {MAPSEC_MARINE_CAVE,
	MAPSEC_UNDERWATER_MARINE_CAVE,
	MAPSEC_UNDERWATER_MARINE_CAVE};

static const u16 sTerraCaveMapSectionIds[] = {MAPSEC_ROUTE_114,
	MAPSEC_ROUTE_114,
	MAPSEC_ROUTE_115,
	MAPSEC_ROUTE_115,
	MAPSEC_ROUTE_116,
...
static const struct UCoords16 sTerraCaveLocationCoords[] = {{0x00, 0x0a},
	{0x00, 0x0c},
	{0x18, 0x03},
	{0x19, 0x04},
	{0x19, 0x06},
...
static const u8 sRegionMap_MapSecAquaHideoutOld[] = {MAPSEC_AQUA_HIDEOUT_OLD};
...
static const struct SpritePalette sRegionMapCursorSpritePalette = {
	.data = sRegionMapCursorPal, .tag = 0};
...
static const u8 sRegionMapEventSectionIds[] = {
	MAPSEC_BIRTH_ISLAND_2, MAPSEC_FARAWAY_ISLAND, MAPSEC_NAVEL_ROCK2};

static const u16 sRegionMapFramePal[] =
	INCBIN_U16( "graphics/pokenav/map_frame.gbapal" );

static const u32 sRegionMapFrameGfxLZ[] =
	INCBIN_U32( "graphics/pokenav/map_frame.4bpp.lz" );

static const u32 sRegionMapFrameTilemapLZ[] =
	INCBIN_U32( "graphics/pokenav/map_frame.bin.lz" );

static const u16 Unknown_085A1D48[] =
	INCBIN_U16( "graphics/pokenav/fly_target_icons.gbapal" );

static const u32 sUnknown_085A1D68[] =
	INCBIN_U32( "graphics/pokenav/fly_target_icons.4bpp.lz" );

static const u8 sMapHealLocations[][3] = {
	{MAP_GROUP( LITTLEROOT_TOWN ),
		MAP_NUM( LITTLEROOT_TOWN ),
		HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
	{MAP_GROUP( OLDALE_TOWN ),
		MAP_NUM( OLDALE_TOWN ),
		HEAL_LOCATION_OLDALE_TOWN},
	{MAP_GROUP( DEWFORD_TOWN ),
		MAP_NUM( DEWFORD_TOWN ),
		HEAL_LOCATION_DEWFORD_TOWN},
	{MAP_GROUP( LAVARIDGE_TOWN ),
		MAP_NUM( LAVARIDGE_TOWN ),
		HEAL_LOCATION_LAVARIDGE_TOWN},
	{MAP_GROUP( FALLARBOR_TOWN ),
		MAP_NUM( FALLARBOR_TOWN ),
		HEAL_LOCATION_FALLARBOR_TOWN},
	{MAP_GROUP( VERDANTURF_TOWN ),
		MAP_NUM( VERDANTURF_TOWN ),
		HEAL_LOCATION_VERDANTURF_TOWN},
	{MAP_GROUP( PACIFIDLOG_TOWN ),
		MAP_NUM( PACIFIDLOG_TOWN ),
		HEAL_LOCATION_PACIFIDLOG_TOWN},
	{MAP_GROUP( PETALBURG_CITY ),
	...
	{MAP_GROUP( MAUVILLE_CITY ),
		MAP_NUM( MAUVILLE_CITY ),
		HEAL_LOCATION_MAUVILLE_CITY},
	{MAP_GROUP( RUSTBORO_CITY ),
		MAP_NUM( RUSTBORO_CITY ),
		HEAL_LOCATION_RUSTBORO_CITY},
	{MAP_GROUP( FORTREE_CITY ),
		MAP_NUM( FORTREE_CITY ),
		HEAL_LOCATION_FORTREE_CITY},
	{MAP_GROUP( LILYCOVE_CITY ),
		MAP_NUM( LILYCOVE_CITY ),
		HEAL_LOCATION_LILYCOVE_CITY},
	{MAP_GROUP( MOSSDEEP_CITY ),
		MAP_NUM( MOSSDEEP_CITY ),
		HEAL_LOCATION_MOSSDEEP_CITY},
	{MAP_GROUP( SOOTOPOLIS_CITY ),
		MAP_NUM( SOOTOPOLIS_CITY ),
		HEAL_LOCATION_SOOTOPOLIS_CITY},
	{MAP_GROUP( EVER_GRANDE_CITY ),
		MAP_NUM( EVER_GRANDE_CITY ),
		HEAL_LOCATION_EVER_GRANDE_CITY_1},
...
static const struct SpritePalette gUnknown_085A1F10 = {
	.data = Unknown_085A1D48, .tag = 2};

static const u16 sUnknown_085A1F18[][2] = {
	{FLAG_LANDMARK_BATTLE_FRONTIER, MAPSEC_BATTLE_FRONTIER},
	{-1, MAPSEC_NONE}};

static const struct OamData gOamData_085A1F20 = {.shape = SPRITE_SHAPE( 8x8 ),
...
static const union AnimCmd* const gUnknown_085A1F60[] = {gUnknown_085A1F28,
	gUnknown_085A1F30,
	gUnknown_085A1F38,
	gUnknown_085A1F40,
	gUnknown_085A1F48,
...
static const struct SpriteTemplate gUnknown_085A1F7C = {.tileTag = 2,
	.paletteTag                                              = 2,
...
void sub_8122CF8( struct RegionMap* regionMap,
	const struct BgTemplate* template,
	bool8 zoomed )
{
	gRegionMap                = regionMap;
	gRegionMap->initStep      = 0;
	gRegionMap->zoomed        = zoomed;
	gRegionMap->inputCallback = zoomed == TRUE
...
bool8 sub_8122DB0( void )
{
	...
	case 0:
		...
		{
			LZ77UnCompVram( sRegionMapBkgnd_GfxLZ,
				(u16*)BG_CHAR_ADDR( 2 ) );
		}
		break;
	case 1:
		...
		{
			LZ77UnCompVram( sRegionMapBkgnd_TilemapLZ,
	...
	case 2:
		...
		break;
	case 3:
		LZ77UnCompWram( sRegionMapCursorSmallGfxLZ,
			gRegionMap->cursorSmallImage );
		break;
	case 4:
		LZ77UnCompWram( sRegionMapCursorLargeGfxLZ,
			gRegionMap->cursorLargeImage );
		break;
	case 5:
		RegionMap_InitializeStateBasedOnPlayerLocation( );
		gRegionMap->playerIconSpritePosX = gRegionMap->cursorPosX;
		gRegionMap->playerIconSpritePosY = gRegionMap->cursorPosY;
		gRegionMap->mapSecId = CorrectSpecialMapSecId_Internal(
			gRegionMap->mapSecId );
		gRegionMap->iconDrawType =
			get_flagnr_blue_points( gRegionMap->mapSecId );
	...
	case 6:
		...
		{
			gRegionMap->scrollX =
				gRegionMap->cursorPosX * 8 - 0x34;
			gRegionMap->scrollY =
				gRegionMap->cursorPosY * 8 - 0x44;
	...
	case 7:
		...
		{
			SetBgAttribute(
				gRegionMap->bgNum, BG_ATTR_SCREENSIZE, 2 );
			SetBgAttribute( gRegionMap->bgNum,
				BG_ATTR_CHARBASEINDEX,
				gRegionMap->charBaseIdx );
			SetBgAttribute( gRegionMap->bgNum,
				BG_ATTR_MAPBASEINDEX,
				gRegionMap->mapBaseIdx );
			SetBgAttribute(
				gRegionMap->bgNum, BG_ATTR_WRAPAROUND, 1 );
			SetBgAttribute(
				gRegionMap->bgNum, BG_ATTR_PALETTEMODE, 1 );
		}
		gRegionMap->initStep++;
		return FALSE;
	default:
...
u8 sub_81230AC( void ) { return gRegionMap->inputCallback( ); }
...
static u8 ProcessRegionMapInput_Full( void )
{
	...
	if( gMain.heldKeys & DPAD_UP &&
		gRegionMap->cursorPosY > MAPCURSOR_Y_MIN )
	{
		gRegionMap->cursorDeltaY = -1;
		input                    = INPUT_EVENT_MOVE_START;
	}
	if( gMain.heldKeys & DPAD_DOWN &&
		gRegionMap->cursorPosY < MAPCURSOR_Y_MAX )
	{
		gRegionMap->cursorDeltaY = +1;
		input                    = INPUT_EVENT_MOVE_START;
	}
	if( gMain.heldKeys & DPAD_LEFT &&
		gRegionMap->cursorPosX > MAPCURSOR_X_MIN )
	{
		gRegionMap->cursorDeltaX = -1;
		input                    = INPUT_EVENT_MOVE_START;
	}
	if( gMain.heldKeys & DPAD_RIGHT &&
		gRegionMap->cursorPosX < MAPCURSOR_X_MAX )
	{
		gRegionMap->cursorDeltaX = +1;
		input                    = INPUT_EVENT_MOVE_START;
	}
...
static u8 MoveRegionMapCursor_Full( void )
{
	...
	mapSecId = GetRegionMapSectionIdAt_Internal(
		gRegionMap->cursorPosX, gRegionMap->cursorPosY );
...
static u8 MoveRegionMapCursor_Zoomed( void )
{
	...
	if( gRegionMap->zoomedCursorMovementFrameCounter == 8 )
	{
		...
		if( x != gRegionMap->zoomedCursorPosX ||
			y != gRegionMap->zoomedCursorPosY )
		{
			...
			{
				gRegionMap->mapSecId = mapSecId;
				GetMapName( gRegionMap->mapSecName,
					gRegionMap->mapSecId,
					16 );
			}
			RegionMap_GetPositionOfCursorWithinMapSection( );
...
bool8 sub_8123514( void )
{
	...
	if( gRegionMap->unk_06e == 16 )
	{
		...
		gRegionMap->unk_04c = ( gRegionMap->zoomed == FALSE )
			? ( 128 << 8 )
			: ( 256 << 8 );
		gRegionMap->zoomed        = !gRegionMap->zoomed;
		gRegionMap->inputCallback = ( gRegionMap->zoomed == FALSE )
			? ProcessRegionMapInput_Full
			: ProcessRegionMapInput_Zoomed;
		CreateRegionMapCursor( gRegionMap->cursorTileTag,
			gRegionMap->cursorPaletteTag );
...
static u16 GetRegionMapSectionIdAt_Internal( u16 x, u16 y )
{
	if( y < MAPCURSOR_Y_MIN || y > MAPCURSOR_Y_MAX ||
		x < MAPCURSOR_X_MIN || x > MAPCURSOR_X_MAX )
	{
		return MAPSEC_NONE;
	}
	y -= MAPCURSOR_Y_MIN;
...
static void RegionMap_InitializeStateBasedOnPlayerLocation( void )
{
	...
	if( gSaveBlock1Ptr->location.mapGroup ==
			MAP_GROUP( SS_TIDAL_CORRIDOR ) &&
		( gSaveBlock1Ptr->location.mapNum ==
				MAP_NUM( SS_TIDAL_CORRIDOR ) ||
			gSaveBlock1Ptr->location.mapNum ==
				MAP_NUM( SS_TIDAL_LOWER_DECK ) ||
			gSaveBlock1Ptr->location.mapNum ==
				MAP_NUM( SS_TIDAL_ROOMS ) ) )
	{
	...
	dimensionScale =
		mapWidth / gRegionMapEntries[gRegionMap->mapSecId].width;
	if( dimensionScale == 0 )
	{
		dimensionScale = 1;
	}
	...
	dimensionScale =
		mapHeight / gRegionMapEntries[gRegionMap->mapSecId].height;
	if( dimensionScale == 0 )
	{
		dimensionScale = 1;
	}
	...
	gRegionMap->cursorPosX = gRegionMapEntries[gRegionMap->mapSecId].x +
		x + MAPCURSOR_X_MIN;
	gRegionMap->cursorPosY = gRegionMapEntries[gRegionMap->mapSecId].y +
		y + MAPCURSOR_Y_MIN;
}
...
static void RegionMap_InitializeStateBasedOnSSTidalLocation( void )
{
	...
	case 0:
		...
		dimensionScale       = mapHeader->mapLayout->width /
			gRegionMapEntries[gRegionMap->mapSecId].width;
		if( dimensionScale == 0 )
			dimensionScale = 1;
		...
		dimensionScale = mapHeader->mapLayout->height /
			gRegionMapEntries[gRegionMap->mapSecId].height;
		if( dimensionScale == 0 )
			dimensionScale = 1;
...
static u8 get_flagnr_blue_points( u16 mapSecId )
{
	...
	case MAPSEC_OLDALE_TOWN:
		return FlagGet( FLAG_VISITED_OLDALE_TOWN )
			? MAPSECTYPE_CITY_CANFLY
			: MAPSECTYPE_CITY_CANTFLY;
	case MAPSEC_DEWFORD_TOWN:
		return FlagGet( FLAG_VISITED_DEWFORD_TOWN )
			? MAPSECTYPE_CITY_CANFLY
			: MAPSECTYPE_CITY_CANTFLY;
	case MAPSEC_LAVARIDGE_TOWN:
		return FlagGet( FLAG_VISITED_LAVARIDGE_TOWN )
			? MAPSECTYPE_CITY_CANFLY
			: MAPSECTYPE_CITY_CANTFLY;
	...
	case MAPSEC_PETALBURG_CITY:
		return FlagGet( FLAG_VISITED_PETALBURG_CITY )
			? MAPSECTYPE_CITY_CANFLY
			: MAPSECTYPE_CITY_CANTFLY;
	case MAPSEC_SLATEPORT_CITY:
		return FlagGet( FLAG_VISITED_SLATEPORT_CITY )
			? MAPSECTYPE_CITY_CANFLY
			: MAPSECTYPE_CITY_CANTFLY;
	case MAPSEC_MAUVILLE_CITY:
		return FlagGet( FLAG_VISITED_MAUVILLE_CITY )
			? MAPSECTYPE_CITY_CANFLY
			: MAPSECTYPE_CITY_CANTFLY;
	...
	case MAPSEC_FORTREE_CITY:
		return FlagGet( FLAG_VISITED_FORTREE_CITY )
			? MAPSECTYPE_CITY_CANFLY
			: MAPSECTYPE_CITY_CANTFLY;
	case MAPSEC_LILYCOVE_CITY:
		return FlagGet( FLAG_VISITED_LILYCOVE_CITY )
			? MAPSECTYPE_CITY_CANFLY
			: MAPSECTYPE_CITY_CANTFLY;
	case MAPSEC_MOSSDEEP_CITY:
		return FlagGet( FLAG_VISITED_MOSSDEEP_CITY )
			? MAPSECTYPE_CITY_CANFLY
			: MAPSECTYPE_CITY_CANTFLY;
	case MAPSEC_SOOTOPOLIS_CITY:
		return FlagGet( FLAG_VISITED_SOOTOPOLIS_CITY )
			? MAPSECTYPE_CITY_CANFLY
			: MAPSECTYPE_CITY_CANTFLY;
...
static u16 CorrectSpecialMapSecId_Internal( u16 mapSecId )
{
	...
	for( i = 0; sRegionMap_SpecialPlaceLocations[i][0] != MAPSEC_NONE;
		i++ )
	{
...
static void RegionMap_GetPositionOfCursorWithinMapSection( void )
{
	...
	while( 1 )
	{
		...
		{
			x--;
			if( GetRegionMapSectionIdAt_Internal( x, y ) ==
				gRegionMap->mapSecId )
			{
				posWithinMapSec++;
			}
...
void CreateRegionMapCursor( u16 tileTag, u16 paletteTag )
{
	...
	if( spriteId != MAX_SPRITES )
	{
		...
		else
		{
			...
			gRegionMap->cursorSprite->pos1.x =
				8 * gRegionMap->cursorPosX + 4;
			gRegionMap->cursorSprite->pos1.y =
				8 * gRegionMap->cursorPosY + 4;
		}
		gRegionMap->cursorSprite->data[1] = 2;
		gRegionMap->cursorSprite->data[2] =
			( IndexOfSpritePaletteTag( paletteTag ) << 4 ) + 0x101;
...
void sub_8124268( void ) { gRegionMap->cursorSprite->data[3] = TRUE; }

void sub_8124278( void ) { gRegionMap->cursorSprite->data[3] = FALSE; }

void CreateRegionMapPlayerIcon( u16 tileTag, u16 paletteTag )
{
	u8 spriteId;
	struct SpriteSheet sheet = {
		sRegionMapPlayerIcon_BrendanGfx, 0x80, tileTag};
	struct SpritePalette palette = {
		sRegionMapPlayerIcon_BrendanPal, paletteTag};
	...
	if( !gRegionMap->zoomed )
	{
		gRegionMap->playerIconSprite->pos1.x =
			gRegionMap->playerIconSpritePosX * 8 + 4;
		gRegionMap->playerIconSprite->pos1.y =
			gRegionMap->playerIconSpritePosY * 8 + 4;
		gRegionMap->playerIconSprite->callback =
			RegionMapPlayerIconSpriteCallback_Full;
	}
	else
	{
		gRegionMap->playerIconSprite->pos1.x =
			gRegionMap->playerIconSpritePosX * 16 - 0x30;
		gRegionMap->playerIconSprite->pos1.y =
			gRegionMap->playerIconSpritePosY * 16 - 0x42;
		gRegionMap->playerIconSprite->callback =
...
static void RegionMapPlayerIconSpriteCallback_Zoomed( struct Sprite* sprite )
{
	...
	sprite->data[0] =
		sprite->pos1.y + sprite->pos2.y + sprite->centerToCornerVecY;
	sprite->data[1] =
		sprite->pos1.x + sprite->pos2.x + sprite->centerToCornerVecX;
	if( sprite->data[0] < -8 || sprite->data[0] > 0xa8 ||
		sprite->data[1] < -8 || sprite->data[1] > 0xf8 )
	{
		sprite->data[2] = FALSE;
	}
	else
...
bool8 sub_8124658( void ) { return gRegionMap->zoomed; }
...
void MCB2_FlyMap( void )
{
	...
	case 5:
		LZ77UnCompVram(
			sRegionMapFrameGfxLZ, (u16*)BG_CHAR_ADDR( 3 ) );
		gMain.state++;
		break;
	case 6:
		LZ77UnCompVram(
			sRegionMapFrameTilemapLZ, (u16*)BG_SCREEN_ADDR( 30 ) );
		gMain.state++;
		break;
	case 7:
		...
		AddTextPrinterParameterized(
			2, 1, gText_FlyToWhere, 0, 1, 0, NULL );
...
static void sub_8124904( void )
{
	...
	if( sFlyMap->regionMap.iconDrawType > MAPSECTYPE_NONE &&
		sFlyMap->regionMap.iconDrawType <= MAPSECTYPE_BATTLE_FRONTIER )
	{
		flag = FALSE;
		for( i = 0; i < ARRAY_COUNT( gUnknown_085A1EDC ); i++ )
		{
			if( sFlyMap->regionMap.mapSecId ==
				gUnknown_085A1EDC[i].mapSecId )
			{
				if( FlagGet( gUnknown_085A1EDC[i].flag ) )
				{
					StringLength(
						gUnknown_085A1EDC[i].name
							[sFlyMap->regionMap
									.posWithinMapSec] );
					flag = TRUE;
					...
					AddTextPrinterParameterized( 1,
						1,
						sFlyMap->regionMap.mapSecName,
						0,
						1,
						0,
						NULL );
					name = gUnknown_085A1EDC[i]
						       .name[sFlyMap->regionMap
								       .posWithinMapSec];
					AddTextPrinterParameterized( 1,
						1,
						name,
...
static void sub_8124BE4( void )
{
	...
	for( i = 0; sUnknown_085A1F18[i][1] != MAPSEC_NONE; i++ )
	{
		if( FlagGet( sUnknown_085A1F18[i][0] ) )
		{
			...
			spriteId =
				CreateSprite( &gUnknown_085A1F7C, x, y, 10 );
			if( spriteId != MAX_SPRITES )
			{
...
static void sub_8124D64( void )
{
	if( sFlyMap->unk_004 == 0 )
	{
		...
		case INPUT_EVENT_A_BUTTON:
			if( sFlyMap->regionMap.iconDrawType ==
					MAPSECTYPE_CITY_CANFLY ||
				sFlyMap->regionMap.iconDrawType ==
					MAPSECTYPE_BATTLE_FRONTIER )
			{
				...
				case MAPSEC_LITTLEROOT_TOWN:
					SetWarpDestinationToHealLocation(
						gSaveBlock2Ptr->playerGender ==
								MALE
							? HEAL_LOCATION_LITTLEROOT_TOWN_1
							: HEAL_LOCATION_LITTLEROOT_TOWN_2 );
					break;
				case MAPSEC_EVER_GRANDE_CITY:
					SetWarpDestinationToHealLocation(
						FlagGet(
							FLAG_LANDMARK_POKEMON_LEAGUE ) &&
								sFlyMap->regionMap
										.posWithinMapSec ==
									0
							? HEAL_LOCATION_EVER_GRANDE_CITY_2
							: HEAL_LOCATION_EVER_GRANDE_CITY_1 );
					break;
				default:
					if( sMapHealLocations[sFlyMap->regionMap
								      .mapSecId]
							     [2] != 0 )
					{
						SetWarpDestinationToHealLocation(
