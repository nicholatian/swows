...
static const u16 gUnknown_0861D140[] =
	INCBIN_U16( "graphics/interface/region_map.gbapal" );
static const u32 gUnknown_0861D1A0[] =
	INCBIN_U32( "graphics/interface/region_map.8bpp.lz" );
static const u32 gUnknown_0861DEF4[] =
	INCBIN_U32( "graphics/interface/region_map.bin.lz" );
static const u32 gUnknown_0861E208[] =
	INCBIN_U32( "graphics/interface/region_map_affine.8bpp.lz" );
static const u32 gUnknown_0861EF64[] =
...
void sub_81C4D70( const struct UnkStruct_1C4D70* template )
{
	...
	if( unk == 0 )
	{
		...
		decompress_and_copy_tile_data_to_vram( template->bg,
			gUnknown_0861D1A0,
			0,
			template->unk2,
			unk );
		sub_8199D3C(
			decompress_and_copy_tile_data_to_vram(
				template->bg, gUnknown_0861DEF4, 0, 0, 1 ),
			template->unk2,
			32,
			32,
			unk );
	...
	else
	{
		...
		sub_8199D3C(
			decompress_and_copy_tile_data_to_vram(
				template->bg, gUnknown_0861EF64, 0, 0, 1 ),
			template->unk2,
			64,
			64,
			1 );
...
void sub_81C4ED0( u32 a0 ) { ChangeBgY( *gUnknown_0203CF28, a0 * 0x100, 0 ); }
