...
static const u16 gUnknown_085B5BFC[] =
	INCBIN_U16( "graphics/roulette/85B5BFC.gbapal" );
static const u32 gUnknown_085B5DFC[] =
	INCBIN_U32( "graphics/roulette/85B5DFC.bin.lz" );
static const u32 gUnknown_085B5FA0[] =
	INCBIN_U32( "graphics/roulette/wheel_map.bin.lz" );
...
static const struct UnkStruct1 gUnknown_085B63F0[] = {{.var00        = 0x53FF,
							      .var02 = 0x0101,
							      .var04 = 5,
							      .var05 = 30,
							      .var06 = 0xFF,
...
static void sub_8140264( void )
{
	...
	{
		DmaCopy16( 3,
			&gUnknown_0203AB88->tilemapBuffers[2][0xE0],
			(void*)BG_SCREEN_ADDR( 4 ) + 0x1C0,
			0x340 );
	...
	case 1:
		...
		ShowBg( 0 );
		DmaCopy16( 3,
			&gUnknown_0203AB88->tilemapBuffers[0][0xE0],
			(void*)BG_SCREEN_ADDR( 31 ) + 0x1C0,
			0x340 );
...
static void sub_8140388( void )
{
	...
	InitBgsFromTemplates(
		1, gUnknown_085B6140, ARRAY_COUNT( gUnknown_085B6140 ) );
	...
	sub_8197200( );
	gUnknown_0203AB8C = 0;
	gUnknown_0203AB88->unk_397C =
		malloc_and_decompress( gUnknown_085B5DFC, &size );
}
...
static void sub_8140470( void )
{
	u8 i;
	u16 arr[3] = {
		RGB( 24, 4, 10 ), RGB( 10, 19, 6 ), RGB( 24, 4, 10 )}; // the
								       // third
								       // is
								       // never
								       // used
	...
	gUnknown_0203AB88->var22 =
		gUnknown_085B6348[gUnknown_0203AB88->var04_0].var03;
	gUnknown_0203AB88->var23 =
		gUnknown_085B6348[gUnknown_0203AB88->var04_0].var04;
	gUnknown_0203AB88->var19 =
		gUnknown_085B6344[gUnknown_0203AB88->var04_0 +
			gUnknown_0203AB88->var04_7 * 2];
	gUnknown_0203AB88->var1A_4 = 1;

	if( gUnknown_0203AB88->var19 == 1 )
		gPlttBufferUnfaded[0]       = gPlttBufferUnfaded[0x51] =
			gPlttBufferFaded[0] = gPlttBufferFaded[0x51] = arr[0];
	else
		gPlttBufferUnfaded[0]       = gPlttBufferUnfaded[0x51] =
			gPlttBufferFaded[0] = gPlttBufferFaded[0x51] = arr[1];
	...
	{
		sub_815168C(
			&gUnknown_0203AB88->varB8, i, &gUnknown_085B6388[i] );
	}
...
static void sub_81405CC( void )
{
	...
	case 1:
		...
		SetGpuReg( REG_OFFSET_BLDCNT,
			BLDCNT_EFFECT_NONE | BLDCNT_TGT2_BG2 |
				BLDCNT_TGT2_BD );
	...
	case 3:
		...
		decompress_and_copy_tile_data_to_vram(
			1, gRouletteMenuTiles, 0, 0, 0 );
		decompress_and_copy_tile_data_to_vram(
			2, gRouletteWheelTiles, 0, 0, 0 );
		break;
	case 4:
	...
	case 6:
		...
		AddTextPrinterParameterized( gUnknown_0203AB8C,
			1,
			gUnknown_082A5B89,
			0,
			1,
	...
	case 8:
		...
		taskId = gUnknown_0203AB88->varA4 =
			CreateTask( sub_81408A8, 0 );
...
static void sub_8140814( u8 unused )
{
	...
	if( gUnknown_0203AB88->var21++ == gUnknown_0203AB88->var23 )
	{
		...
		if( ( gUnknown_0203AB88->var24 -= gUnknown_0203AB88->var22 ) <
			0 )
			gUnknown_0203AB88->var24 =
				360 - gUnknown_0203AB88->var22;
	}
...
static void sub_81409B8( u8 r0 )
{
	...
	{
	case 0:
		sub_8152008( &gUnknown_0203AB88->tilemapBuffers[0][0],
			0,
			14,
			7,
			16,
	...
	case 4:
		...
		sub_8152008( &gUnknown_0203AB88->tilemapBuffers[0][0],
			...
			16,
			13 );
		sub_8152058( &gUnknown_0203AB88->tilemapBuffers[0][0],
			&gUnknown_0203AB88->unk_397C[281],
			temp0,
			7,
			3,
			13 );
	...
	case 0xF:
		...
		sub_8152008( &gUnknown_0203AB88->tilemapBuffers[0][0],
			...
			13 );
		sub_8152058( &gUnknown_0203AB88->tilemapBuffers[0][0],
			&gUnknown_0203AB88->unk_397C[320],
			14,
			temp1,
			16,
			3 );
	...
	default:
		...
		sub_8152008( &gUnknown_0203AB88->tilemapBuffers[0][0],
			...
			13 );
		sub_8152058( &gUnknown_0203AB88->tilemapBuffers[0][0],
			&gUnknown_0203AB88->unk_397C[272],
			temp0,
			temp1,
			3,
			3 );
...
static void sub_8140BD0( u8 taskId )
{
	...
	if( gUnknown_0203AB88->var08 & 0x20 )
	{
		for( i = 11; i < 14; i++ )
		{
			if( ( gUnknown_0203AB88->var08 &
				    gUnknown_085B6154[i].var08 ) == 0 )
				break;
		}
	}
	else
...
static void sub_8140D6C( u8 r0 )
{
	...
	if( !( gMain.newKeys & DPAD_UP ) ||
		( ( var0 = TRUE ), sub_8140CA8( &gTasks[r0].data[4], 0 ) ) )
		if( !( gMain.newKeys & DPAD_DOWN ) ||
			( ( var0 = TRUE ),
				sub_8140CA8( &gTasks[r0].data[4], 1 ) ) )
			if( !( gMain.newKeys & DPAD_LEFT ) ||
				...
				if( !( gMain.newKeys & DPAD_RIGHT ) ||
					...
					if( var0 )
					{
						...
						gTasks[r0].data[1] = z;
						PlaySE( SE_SELECT );
						sub_8151A9C( &gUnknown_0203AB88
								      ->varB8,
							0xFFFF );
						gUnknown_0203AB88->varB8
							.var04[13]
							.var00_7 =
							gUnknown_0203AB88
								->varB8
...
{
	gUnknown_0203AB88->var1B[gUnknown_0203AB88->var1A_0] =
		gTasks[taskId].data[4];
	gTasks[taskId].data[2] = sub_8142758(
		gUnknown_0203AB88->var1B[gUnknown_0203AB88->var1A_0] );
...
static void sub_8141040( u8 taskId )
{
	...
	{
		if( ( gUnknown_0203AB88->var08 &
			    gUnknown_085B6154[gTasks[taskId].data[4]].var08 ) )
			PlaySE( SE_BOO );
		else
		{
...
static void sub_81410FC( u8 taskId )
{
	if( gTasks[taskId].data[1]-- > 0 )
	{
		...
		if( ( gUnknown_0203AB88->var26 += 4 ) == 104 )
			gSprites[gUnknown_0203AB88->var3C[25]].callback =
				&SpriteCallbackDummy;
	}
	else
	{
...
static u8 sub_814118C( u16 r0, u16 r1 )
{
	...
	case 2: // TAILLOW
		...
		if( gLocalTime.hours > 3 && gLocalTime.hours < 10 )
		{
			if( r0 < 12 || ( r1 & 1 ) )
			{
				return gUnknown_085B6348[gUnknown_0203AB88
								 ->var04_0]
					       .var02 /
					2;
			}
		...
		{
			return gUnknown_085B6348[gUnknown_0203AB88->var04_0]
				       .var02 /
				2;
		}
		else
...
static void sub_8141344( u8 taskId )
{
	...
	gUnknown_0203AB88->var7D         = gUnknown_0203AB88->var7E =
		gUnknown_0203AB88->var7F = g;
	...
	gUnknown_0203AB88->var80 = g =
		gUnknown_085B6348[gUnknown_0203AB88->var04_0].var1A +
		randfinal;
	...
	gUnknown_0203AB88->var8C = S16TOPOSFLOAT(
		gUnknown_085B6348[gUnknown_0203AB88->var04_0].var18 );
	gUnknown_0203AB88->var90 = ( ( gUnknown_0203AB88->var8C * 0.5f ) -
					   gUnknown_0203AB88->var8C ) /
		S16TOPOSFLOAT( gUnknown_0203AB88->var82 );
	gUnknown_0203AB88->var94 = 68.0f;
	gUnknown_0203AB88->var9C = 0.0f;
	gUnknown_0203AB88->var98 =
		-( 8.0f / S16TOPOSFLOAT( gUnknown_0203AB88->var82 ) );
...
static void sub_81415D4( u8 taskId )
{
	if( gUnknown_0203AB88->var7D )
	{
		...
		else
		{
			...
			{
				bool8 temp = sub_81421E8(
					sub_81420D0( taskId,
						gUnknown_0203AB88->var7E ),
					gUnknown_0203AB88->var1B
						[gUnknown_0203AB88->var1A_0] );
				gTasks[taskId].data[5] = temp;
				if( temp == TRUE )
					sub_8151A48( &gUnknown_0203AB88->varB8,
						0x1000 );
			}
...
static void sub_8141A18( u8 taskId )
{
	ConvertIntToDecimalStringN( gStringVar1,
		( gUnknown_0203AB88->var19 * gTasks[taskId].data[2] ),
		STR_CONV_MODE_LEFT_ALIGN,
		2 );
	StringExpandPlaceholders( gStringVar4, gUnknown_082A5BEF );
	DrawStdWindowFrame( gUnknown_0203AB8C, FALSE );
	AddTextPrinterParameterized(
		gUnknown_0203AB8C, 1, gStringVar4, 0, 1, TEXT_SPEED_FF, NULL );
	CopyWindowToVram( gUnknown_0203AB8C, 3 );
	gTasks[taskId].data[1] =
		( gUnknown_0203AB88->var19 * gTasks[taskId].data[2] );
	gTasks[taskId].data[7] = 0;
...
static void sub_8141AC0( u8 taskId )
{
	...
	gUnknown_0203AB88->varB8.var04[13].var00_7 =
		gUnknown_0203AB88->varB8.var04[14].var00_7 =
			gUnknown_0203AB88->varB8.var04[15].var00_7 = 0;
	gSprites[gUnknown_0203AB88->var3C[7 +
			 gUnknown_085B6154[gTasks[taskId].data[12]].var00]]
		.invisible  = TRUE;
...
static void sub_8141B58( u8 taskId )
{
	...
	for( i = 0; i < 4; i++ )
	{
		gSprites[gUnknown_0203AB88->var3C[i + 41]].oam.tileNum =
			gSprites[gUnknown_0203AB88->var3C[i + 41]]
				.sheetTileStart +
			( *gSprites[gUnknown_0203AB88->var3C[i + 41]].anims )
				->type;
	}
	if( gTasks[taskId].data[13] >= gUnknown_0203AB88->var19 )
	{
		if( gTasks[taskId].data[6] == 6 )
		{
			...
			CopyWindowToVram( gUnknown_0203AB8C, 3 );
			sub_8141F7C(
				taskId, dp01t_12_3_battle_menu, 0xFFFF, 3 );
		}
...
{
	if( gUnknown_0203AB88->varA8 == 0 ||
		gMain.newKeys & gUnknown_0203AB88->varAA )
	{
...
static u8 sub_81420D0( u8 taskId, u8 r1 )
{
	...
	gUnknown_0203AB88->var0C[gTasks[taskId].data[6] - 1] =
		gUnknown_085B62E4[r1].var02;
...
static void sub_8142284( u8 r0 )
{
	...
	default: {
		...
		{
		case 1:
			var3 = gSprites[gUnknown_0203AB88->var3C[7]]
					.oam.paletteNum *
				16;
			break;
		case 2:
			var3 = gSprites[gUnknown_0203AB88->var3C[8]]
					.oam.paletteNum *
				16;
			break;
		case 3:
			var3 = gSprites[gUnknown_0203AB88->var3C[9]]
					.oam.paletteNum *
				16;
			break;
		case 4:
			var3 = gSprites[gUnknown_0203AB88->var3C[10]]
					.oam.paletteNum *
				16;
			break;
		}
		...
		{
			if( !( gUnknown_0203AB88->var08 &
				    gUnknown_085B6154[r0].var08 ) )
			{
				var1[r0 / 5 - 1].var02 += var3;
				sub_815168C( &gUnknown_0203AB88->varB8,
					13,
					&var1[r0 / 5 - 1] );
			}
			else
		...
		sub_8151A48( &gUnknown_0203AB88->varB8,
			var0 |= gUnknown_085B6154[r0].var10 );
		break;
	}
	}
}
...
static void sub_81424FC( u8 r0 )
{
	...
	sub_8142E70( 0, 0 );
	sub_8152058( gUnknown_0203AB88->tilemapBuffers[2],
		gUnknown_0203AB88->unk_397C,
		14,
		7,
		16,
	...
	for( i = 0; i < l; i++ )
	{
		...
		for( z = 0; z < 3; z++ )
		{
			...
			gUnknown_0203AB88->tilemapBuffers[2][var1 + var2 + 0] =
				gUnknown_0203AB88
					->unk_397C[( var0 + z ) * 3 + 208];
			gUnknown_0203AB88->tilemapBuffers[2][var1 + var2 + 1] =
				gUnknown_0203AB88
					->unk_397C[( var0 + z ) * 3 + 209];
			gUnknown_0203AB88->tilemapBuffers[2][var1 + var2 + 2] =
				gUnknown_0203AB88
					->unk_397C[( var0 + z ) * 3 + 210];
		}
	}
}
...
static void sub_8142814( void )
{
	...
	x1 = 0x7400 -
		gUnknown_0203AB88->var2C.a * ( gSpriteCoordOffsetX + 116 ) -
		gUnknown_0203AB88->var2C.b * ( gSpriteCoordOffsetY + 80 );
	x2 = 0x5400 -
		gUnknown_0203AB88->var2C.c * ( gSpriteCoordOffsetX + 116 ) -
...
static const u16 RouletteSpritePalette_01[] =
	INCBIN_U16( "graphics/roulette/shadow.gbapal" );
static const u16 RouletteSpritePalette_02[] =
	INCBIN_U16( "graphics/roulette/ball.gbapal" );
static const u16 RouletteSpritePalette_03[] =
	INCBIN_U16( "graphics/roulette/ball_counter.gbapal" );
static const u16 RouletteSpritePalette_04[] =
	INCBIN_U16( "graphics/roulette/cursor.gbapal" );
static const u16 RouletteSpritePalette_05[] =
	INCBIN_U16( "graphics/roulette/credit.gbapal" );
static const u16 RouletteSpritePalette_06[] =
	INCBIN_U16( "graphics/roulette/shroomish.gbapal" );
static const u16 RouletteSpritePalette_07[] =
	INCBIN_U16( "graphics/roulette/tailow.gbapal" );
static const u16 RouletteSpritePalette_08[] =
	INCBIN_U16( "graphics/roulette/poke_icons.gbapal" );
static const u16 RouletteSpritePalette_09[] =
	INCBIN_U16( "graphics/roulette/wynaut.gbapal" );
static const u16 RouletteSpritePalette_10[] =
	INCBIN_U16( "graphics/roulette/azurill.gbapal" );
static const u16 RouletteSpritePalette_11[] =
	INCBIN_U16( "graphics/roulette/skitty.gbapal" );
static const u16 RouletteSpritePalette_12[] =
	INCBIN_U16( "graphics/roulette/makuhita.gbapal" );
static const u16 RouletteSpritePalette_13[] =
	INCBIN_U16( "graphics/roulette/85B65D0.gbapal" );
static const u16 RouletteSpritePalette_14[] =
	INCBIN_U16( "graphics/roulette/85B65F0.gbapal" );
static const u16 RouletteSpritePalette_15[] =
	INCBIN_U16( "graphics/roulette/85B6610.gbapal" );
static const u16 RouletteSpritePalette_16[] =
	INCBIN_U16( "graphics/roulette/85B6630.gbapal" );
static const u32 gUnknown_085B6650[] =
	INCBIN_U32( "graphics/roulette/ball.4bpp.lz" );
static const u32 RouletteBallCounterTiles[] =
	INCBIN_U32( "graphics/roulette/ball_counter.4bpp.lz" );
static const u32 gUnknown_085B67FC[] =
	INCBIN_U32( "graphics/roulette/roulette_tilt.4bpp.lz" );
static const u32 RoulettePokeIconsTiles[] =
	INCBIN_U32( "graphics/roulette/poke_icons.4bpp.lz" );
static const u32 RoulettePokeIcons2Tiles[] =
	INCBIN_U32( "graphics/roulette/poke_icons2.4bpp.lz" );
static const u32 gUnknown_085B7290[] =
	INCBIN_U32( "graphics/roulette/shadow.4bpp.lz" );
static const u32 RouletteCursorTiles[] =
	INCBIN_U32( "graphics/roulette/cursor.4bpp.lz" );
...
static const struct CompressedSpriteSheet gUnknown_085B741C = {
	.data = RoulettePokeIcons2Tiles, .size = 0xC00, .tag = 0};

static const union AnimCmd gSpriteAnim_85B7420[] = {ANIMCMD_FRAME( 0, 0 ),
	ANIMCMD_FRAME( 32, 0 ),
	ANIMCMD_FRAME( 64, 0 ),
	ANIMCMD_FRAME( 72, 0 ),
	ANIMCMD_FRAME( 8, 0 ),
...
static const struct CompressedSpriteSheet gUnknown_085B7488 = {
	.data = gRouletteHeadersTiles, .size = 0x1600, .tag = 4};

static const struct CompressedSpriteSheet gUnknown_085B7490 = {
	.data = RoulettePokeIconsTiles, .size = 0x400, .tag = 5};

static const union AnimCmd gSpriteAnim_85B7498[] = {ANIMCMD_FRAME( 0, 0 ),
	ANIMCMD_FRAME( 16, 0 ),
	ANIMCMD_FRAME( 32, 0 ),
	ANIMCMD_FRAME( 48, 0 ),
	ANIMCMD_FRAME( 64, 0 ),
...
static const union AnimCmd gSpriteAnim_85B74C8[] = {ANIMCMD_FRAME( 0, 0 ),
	ANIMCMD_FRAME( 4, 0 ),
	ANIMCMD_FRAME( 8, 0 ),
	ANIMCMD_FRAME( 12, 0 ),
	ANIMCMD_END};
...
static const struct CompressedSpriteSheet gUnknown_085B7750[] = {
	{.data = gRouletteCreditTiles, .size = 0x400, .tag = 7},
	{.data = gRouletteNumbersTiles, .size = 0x280, .tag = 8},
	{.data = gRouletteMultiplierTiles, .size = 0x500, .tag = 9},
	{.data = RouletteBallCounterTiles, .size = 0x140, .tag = 10},
	{.data = RouletteCursorTiles, .size = 0x200, .tag = 11},
	{}};
...
static const union AnimCmd gSpriteAnim_85B77AC[] = {ANIMCMD_FRAME( 0, 0 ),
	ANIMCMD_FRAME( 8, 0 ),
	ANIMCMD_FRAME( 16, 0 ),
	ANIMCMD_FRAME( 24, 0 ),
	ANIMCMD_FRAME( 32, 0 ),
...
static const union AnimCmd gSpriteAnim_85B77C8[] = {ANIMCMD_FRAME( 0, 0 ),
	ANIMCMD_FRAME( 2, 0 ),
	ANIMCMD_FRAME( 4, 0 ),
	ANIMCMD_FRAME( 6, 0 ),
	ANIMCMD_FRAME( 8, 0 ),
...
static const struct SpriteTemplate gSpriteTemplate_85B77E4 = {.tileTag = 7,
	.paletteTag                                                    = 5,
...
static const struct SpriteTemplate gUnknown_085B77FC = {.tileTag = 8,
	.paletteTag                                              = 5,
...
static const struct SpriteTemplate gUnknown_085B7814 = {.tileTag = 9,
	.paletteTag                                              = 5,
...
static const struct SpriteTemplate gUnknown_085B782C = {.tileTag = 10,
	.paletteTag                                              = 3,
...
static const struct SpriteTemplate gUnknown_085B7844 = {.tileTag = 11,
	.paletteTag                                              = 5,
	.oam         = &gOamData_85B73EC,
	.anims       = gDummySpriteAnimTable,
	.images      = NULL,
...
static const struct CompressedSpriteSheet gUnknown_085B7864 = {
	.data = gUnknown_085B6650, .size = 0x200, .tag = 12};

static const union AnimCmd gSpriteAnim_85B786C[] = {ANIMCMD_FRAME( 0, 5 ),
	ANIMCMD_FRAME( 4, 5 ),
	ANIMCMD_FRAME( 8, 5 ),
	ANIMCMD_FRAME( 4, 5 ),
	ANIMCMD_JUMP( 0 )};

static const union AnimCmd gSpriteAnim_85B7880[] = {ANIMCMD_FRAME( 0, 10 ),
	ANIMCMD_FRAME( 4, 10 ),
	ANIMCMD_FRAME( 8, 10 ),
	ANIMCMD_FRAME( 4, 10 ),
	ANIMCMD_JUMP( 0 )};

static const union AnimCmd gSpriteAnim_85B7894[] = {ANIMCMD_FRAME( 0, 15 ),
	ANIMCMD_FRAME( 4, 15 ),
	ANIMCMD_FRAME( 8, 15 ),
	ANIMCMD_FRAME( 4, 15 ),
	ANIMCMD_JUMP( 0 )};

static const union AnimCmd gSpriteAnim_85B78A8[] = {ANIMCMD_FRAME( 4, 2 ),
	ANIMCMD_FRAME( 8, 5 ),
	ANIMCMD_FRAME( 4, 5 ),
	ANIMCMD_FRAME( 12, 5 ),
	ANIMCMD_END};

static const union AnimCmd gSpriteAnim_85B78BC[] = {ANIMCMD_FRAME( 4, 2 ),
	ANIMCMD_FRAME( 0, 4 ),
	ANIMCMD_FRAME( 4, 4 ),
	ANIMCMD_FRAME( 8, 4 ),
	ANIMCMD_FRAME( 12, 4 ),
...
static const union AnimCmd gSpriteAnim_85B78D4[] = {ANIMCMD_FRAME( 0, 2 ),
	ANIMCMD_FRAME( 4, 5 ),
	ANIMCMD_FRAME( 8, 5 ),
	ANIMCMD_FRAME( 12, 5 ),
	ANIMCMD_END};
...
static const union AnimCmd gSpriteAnim_85B78F0[] = {ANIMCMD_FRAME( 8, 2 ),
	ANIMCMD_FRAME( 4, 5 ),
	ANIMCMD_FRAME( 0, 5 ),
	ANIMCMD_FRAME( 12, 5 ),
	ANIMCMD_END};
...
static const struct SpriteTemplate gSpriteTemplate_85B7928 = {.tileTag = 12,
	.paletteTag                                                    = 2,
...
static const struct CompressedSpriteSheet gUnknown_085B7948 = {
	.data = gRouletteCenter_Gfx, .size = 0x800, .tag = 6};

static const struct SpriteTemplate gSpriteTemplate_85B7950 = {.tileTag = 6,
	.paletteTag                                                    = 2,
...
static const struct CompressedSpriteSheet gUnknown_085B7978 = {
	.data = gUnknown_085B67FC, .size = 0xE00, .tag = 13};

static const union AnimCmd gSpriteAnim_85B7980[] = {ANIMCMD_FRAME( 0, 6 ),
	ANIMCMD_FRAME( 16, 6 ),
	ANIMCMD_FRAME( 32, 6 ),
	ANIMCMD_FRAME( 48, 6 ),
	ANIMCMD_FRAME( 32, 6 ),
...
static const struct SpriteTemplate gSpriteTemplate_85B79F8 = {.tileTag = 13,
	.paletteTag                                                    = 6,
...
static const struct SpriteTemplate gSpriteTemplate_85B7A10 = {.tileTag = 13,
	.paletteTag                                                    = 7,
...
static const struct CompressedSpriteSheet gUnknown_085B7A40 = {
	.data = gUnknown_085B7290, .size = 0x180, .tag = 14};
...
static const struct SpriteTemplate gUnknown_085B7AEC = {.tileTag = 14,
	.paletteTag                                              = 1,
...
static void sub_81429F0( u8 taskId )
{
	if( gMain.newKeys & ( A_BUTTON | B_BUTTON ) )
	{
		u32 temp = gUnknown_085B6344[( gSpecialVar_0x8004 & 1 ) +
			( gSpecialVar_0x8004 >> 7 << 1 )];
		ConvertIntToDecimalStringN(
			gStringVar1, temp, STR_CONV_MODE_LEADING_ZEROS, 1 );
		StringExpandPlaceholders( gStringVar4, gUnknown_082A5B12 );
		DrawStdWindowFrame( 0, FALSE );
		AddTextPrinterParameterized(
			0, 1, gStringVar4, 0, 1, TEXT_SPEED_FF, NULL );
...
static void Task_Roulette_0( u8 taskId )
{
	...
	temp = gUnknown_085B6344[( gSpecialVar_0x8004 & 1 ) +
		( gSpecialVar_0x8004 >> 7 << 1 )];
...
static void sub_8142CD0( void )
{
	...
	for( i = 0; i < 3; i++ )
	{
		...
		{
			spriteId =
				gUnknown_0203AB88->var3C[( i * 4 ) + 29 + j] =
					CreateSprite(
						&gSpriteTemplate_85B75B0[j],
						( j * 24 ) + 148,
						o + 92,
						30 );
			gSprites[spriteId].animPaused = TRUE;
	...
	for( i = 0; i < 4; i++ )
	{
		spriteId = gUnknown_0203AB88->var3C[i + 41] =
			CreateSprite( &gSpriteTemplate_85B7508[i],
				( i * 24 ) + 148,
				70,
				30 );
		gSprites[spriteId].animPaused = TRUE;
	...
	for( i = 0; i < 3; i++ )
	{
		spriteId = gUnknown_0203AB88->var3C[i + 45] =
			CreateSprite( &gSpriteTemplate_85B7568[i],
				126,
				( i * 24 ) + 92,
				30 );
		gSprites[spriteId].animPaused = TRUE;
...
static void sub_8142E70( u8 r0, u8 r1 )
{
	...
	case 1:
		for( i = 0; i < 19; i++ )
		{
			gSprites[gUnknown_0203AB88->var3C[i + 29]].invisible =
				TRUE;
		}
		break;
	case 0:
		...
		{
			if( !( gUnknown_0203AB88->var08 &
				    gUnknown_085B62E4[i].var04 ) )
				gSprites[gUnknown_0203AB88->var3C[i + 29]]
					.invisible = FALSE;
...
static void sub_8142F7C( void )
{
	...
	for( i = 0; i < 6; i++ )
	{
		gUnknown_0203AB88->var3C[i + 49] =
			CreateSprite( &gSpriteTemplate_85B7928, 116, 20, 10 );
		gSprites[gUnknown_0203AB88->var3C[i + 49]].invisible = TRUE;
		gSprites[gUnknown_0203AB88->var3C[i + 49]].data[0]   = 1;
		gSprites[gUnknown_0203AB88->var3C[i + 49]].callback =
			sub_814390C;
		gSprites[gUnknown_0203AB88->var3C[i + 49]].oam.priority = 1;
		StartSpriteAnim(
			&gSprites[gUnknown_0203AB88->var3C[i + 49]], 8 );
	}
}
...
static void sub_8143038( u8 r0, u8 r1 )
{
	...
	if( r0 )
	{
		for( ; i < 6; i++ )
		{
			gSprites[gUnknown_0203AB88->var3C[i + 49]].invisible =
				TRUE;
		}
	}
	else
	{
		for( ; i < 6; i++ )
		{
			...
			{
				gSprites[gUnknown_0203AB88->var3C[i + 49]]
					.invisible = TRUE;
			}
			else
			{
				...
				gSprites[gUnknown_0203AB88->var3C[i + 49]]
					.pos1.x =
					( gUnknown_085B6154[gUnknown_0203AB88
								    ->var0C[i]]
							.var03 +
						1 ) *
						8 +
...
static void sub_8143150( u8 r0 )
{
	...
	else
	{
		...
		gSprites[gUnknown_0203AB88->var3C[48]].pos1.x =
			( gUnknown_085B6154[r0].var03 + 2 ) * 8;
		gSprites[gUnknown_0203AB88->var3C[48]].pos1.y =
			( gUnknown_085B6154[r0].var04 + 2 ) * 8;
	}
}
...
static void sub_81431E4( void )
{
	...
	for( i = 0; i < 3; i++ )
	{
		...
		{
			u8 spriteId;
			spriteId = gUnknown_0203AB88
					   ->var3C[( i * 4 ) + 7 + j] =
				sub_8142C60(
					&gSpriteTemplate_85B7610[i * 4 + j],
					40,
					&k );
			gSprites[spriteId].animPaused       = TRUE;
			gSprites[spriteId].affineAnimPaused = TRUE;
...
static void sub_8143314( void )
{
	...
	for( i = 0; i < 5; i++ )
	{
		struct SpriteSheet s;
		LZ77UnCompWram(
			gUnknown_085B7750[i].data, gDecompressionBuffer );
		s.data = gDecompressionBuffer;
		s.size = gUnknown_085B7750[i].size;
		s.tag  = gUnknown_085B7750[i].tag;
		LoadSpriteSheet( &s );
	}
	gUnknown_0203AB88->var3C[20] =
		CreateSprite( &gSpriteTemplate_85B77E4, 208, 16, 4 );
	gSprites[gUnknown_0203AB88->var3C[20]].animPaused = TRUE;
	for( i = 0; i < 4; i++ )
	{
		gUnknown_0203AB88->var3C[i + 21] =
			CreateSprite( &gUnknown_085B77FC, i * 8 + 196, 24, 0 );
		gSprites[gUnknown_0203AB88->var3C[i + 21]].invisible  = TRUE;
		gSprites[gUnknown_0203AB88->var3C[i + 21]].animPaused = TRUE;
	}
	gUnknown_0203AB88->var3C[25] =
		CreateSprite( &gUnknown_085B7814, 120, 68, 4 );
	gSprites[gUnknown_0203AB88->var3C[25]].animPaused = TRUE;
	for( i = 0; i < 3; i++ )
	{
		gUnknown_0203AB88->var3C[i + 26] = CreateSprite(
			&gUnknown_085B782C, i * 16 + 192, 36, 4 );
		gSprites[gUnknown_0203AB88->var3C[i + 26]].invisible  = TRUE;
		gSprites[gUnknown_0203AB88->var3C[i + 26]].animPaused = TRUE;
	}
	gUnknown_0203AB88->var3C[48] =
		CreateSprite( &gUnknown_085B7844, 152, 96, 9 );
...
static void sub_8143514( u16 r0 )
{
	...
	for( i = 0; i < 4; i++ )
	{
		...
		if( t > 0 || v || i == 3 )
		{
			gSprites[gUnknown_0203AB88->var3C[i + 21]].invisible =
				FALSE;
			gSprites[gUnknown_0203AB88->var3C[i + 21]]
				.oam.tileNum =
				gSprites[gUnknown_0203AB88->var3C[i + 21]]
					.sheetTileStart +
				( *gSprites[gUnknown_0203AB88->var3C[i + 21]]
...
static void sub_81436D0( u8 r0 )
{
	...
	s->oam.tileNum =
		s->sheetTileStart + ( *s->anims + s->animCmdIndex )->type;
}
...
static void sub_814372C( u8 r0 )
{
	...
	case 6:
		for( i = 0; i < 3; i++ )
		{
			gSprites[gUnknown_0203AB88->var3C[i + 26]].invisible =
				FALSE;
			gSprites[gUnknown_0203AB88->var3C[i + 26]]
				.oam.tileNum =
				gSprites[gUnknown_0203AB88->var3C[i + 26]]
					.sheetTileStart +
				( *gSprites[gUnknown_0203AB88->var3C[i + 26]]
	...
	case 5:
		gSprites[gUnknown_0203AB88->var3C[28]].oam.tileNum =
			...
			( *gSprites[gUnknown_0203AB88->var3C[28]].anims + t +
				1 )
				->type;
		break;
	case 4:
	...
	case 3:
		gSprites[gUnknown_0203AB88->var3C[27]].oam.tileNum =
			...
			( *gSprites[gUnknown_0203AB88->var3C[27]].anims + t +
				1 )
				->type;
		break;
	case 2:
	...
	case 1:
		gSprites[gUnknown_0203AB88->var3C[26]].oam.tileNum =
			...
			( *gSprites[gUnknown_0203AB88->var3C[26]].anims + t +
				1 )
				->type;
		break;
	case 0:
...
static void sub_81439C8( void )
{
	...
	for( i = 0; i < 6; i++ )
	{
		gUnknown_0203AB88->var3C[i] = CreateSprite(
			&gSpriteTemplate_85B7928, 116, 80, 57 - i );
		if( gUnknown_0203AB88->var3C[i] != MAX_SPRITES )
		{
			gSprites[gUnknown_0203AB88->var3C[i]].invisible = TRUE;
			gSprites[gUnknown_0203AB88->var3C[i]]
...
static s16 sub_8143AC8( struct Sprite* sprite )
{
	...
	{
		sprite->data[6] =
			360 - gUnknown_0203AB88->var24 + sprite->data[3];
...
static void sub_8143B84( struct Sprite* sprite )
{
	...
	if( IsSEPlaying( ) )
	{
		m4aMPlayPanpotControl(
			&gMPlayInfo_SE1, 0xFFFF, sprite->pos2.x );
		m4aMPlayPanpotControl(
			&gMPlayInfo_SE2, 0xFFFF, sprite->pos2.x );
	}
}
...
static void sub_8143CFC( struct Sprite* sprite )
{
	...
	if( sprite->data[2] >= 30 )
	{
		if( !sprite->data[0] )
		{
			if( gUnknown_0203AB88->var94 <=
				gUnknown_0203AB88->varA0 - 2.0f )
			{
				gUnknown_0203AB88->var7D   = 0xFF;
				gUnknown_0203AB88->var03_7 = 0;
				StartSpriteAnim(
					sprite, sprite->animCmdIndex + 0x3 );
				sub_8143B14( sprite );
				sprite->data[4] = 30;
				sub_8143AC8( sprite );
				sprite->data[6] =
					( sprite->data[6] / 30 ) * 30 + 15;
				sprite->callback = sub_8143C90;
				m4aSongNumStartOrChange( SE_HASHI );
				gUnknown_0203AB88->var9C =
...
static void sub_8143E14( struct Sprite* sprite )
{
	...
	case 0:
		if( sprite->data[0] != 1 )
		{
			f0 = sprite->data[7];
			f1 = ( f0 *
					gUnknown_085B6348[gUnknown_0203AB88
								  ->var04_0]
						.var01 +
				( gUnknown_085B6348[gUnknown_0203AB88->var04_0]
						.var02 -
					1 ) );
			f2 = ( f0 /
				gUnknown_085B6348[gUnknown_0203AB88->var04_0]
...
{
	sprite->pos2.y =
		( s16 )( sprite->data[2] * 0.05f * sprite->data[2] ) - 45;
	sprite->data[2]++;
...
static void sub_8144050( struct Sprite* sprite )
{
	if( sprite->data[2]++ < 45 )
	{
		...
		if( sprite->data[2] == 45 )
		{
			if( gSprites[gUnknown_0203AB88->var3C[55]]
					.animCmdIndex == 1 )
				sprite->pos2.y++;
		}
	}
...
static void sub_8144264( struct Sprite* sprite )
{
	...
	sprite->data[2] = 0;
	sub_8143B14( sprite );
	if( !( gUnknown_085B62E4[gUnknown_0203AB88->var7E].var04 &
		    gUnknown_0203AB88->var08 ) )
	{
		gUnknown_0203AB88->var7D   = 0xFF;
		gUnknown_0203AB88->var03_7 = 0;
		StartSpriteAnim( sprite, sprite->animCmdIndex + 3 );
	...
	else
	{
		...
		{
			gUnknown_0203AB88->var8C = 0.0f;
			gUnknown_0203AB88->var7F = t =
				( gUnknown_0203AB88->var7E + 1 ) % 12;
		}
		else
		{
			float temp;
			gUnknown_0203AB88->var8C =
				( temp = gUnknown_085B6348[gUnknown_0203AB88
								   ->var04_0]
						 .var1C ) *
				2.0f;
		...
		{
			sprite->data[0] = gUnknown_085B62E4[t].var04 &
				gUnknown_0203AB88->var08;
...
static void sub_8144410( struct Sprite* sprite )
{
	...
	if( !sub_8143B48( sprite ) )
	{
		...
		gUnknown_0203AB88->var8C -=
			(float)( gUnknown_085B6348[gUnknown_0203AB88->var04_0]
					 .var03 ) /
			( gUnknown_085B6348[gUnknown_0203AB88->var04_0].var04 +
				1 );
		sprite->data[1]  = 4;
...
static void sub_8144514( struct Sprite* sprite )
{
	...
	gUnknown_0203AB88->var90 = -(
		gUnknown_0203AB88->var8C / (float)gUnknown_0203AB88->var86 );
	sprite->animNum       = 2;
	sprite->animBeginning = TRUE;
	sprite->animEnded     = FALSE;
	sprite->data[1]       = 3;
...
static void sub_81445D8( struct Sprite* sprite )
{
	...
	gUnknown_0203AB88->var98 =
		-( 20.0f / (float)gUnknown_0203AB88->var84 );
	gUnknown_0203AB88->var90 = ( ( 1.0f - gUnknown_0203AB88->var8C ) /
		(float)gUnknown_0203AB88->var84 );
	sprite->animNum          = 1;
	sprite->animBeginning    = TRUE;
	sprite->animEnded        = FALSE;
	sprite->data[1]          = 2;
...
static void sub_81446DC( struct Sprite* sprite )
{
	u16 t;
	u8 i;
	s16 s[2][2] = {{116, 44}, {116, 112}};
	struct Roulette* p;

	t = sprite->data[7] - 2;
	p = gUnknown_0203AB88; // why???
	gUnknown_0203AB88->var3C[55] =
		CreateSprite( &gSpriteTemplate_85B79F8, 36, -12, 50 );
	gUnknown_0203AB88->var3C[56] =
		CreateSprite( &gSpriteTemplate_85B7ABC[0],
			s[sprite->data[0]][0],
			s[sprite->data[0]][1],
			59 );
	gUnknown_0203AB88->var3C[57] =
		CreateSprite( &gSpriteTemplate_85B7ABC[1], 36, 140, 51 );
	gSprites[gUnknown_0203AB88->var3C[57]].oam.objMode = 1;
	for( i = 0; i < 3; i++ )
	{
		gSprites[gUnknown_0203AB88->var3C[i + 55]].coordOffsetEnabled =
			FALSE;
		gSprites[gUnknown_0203AB88->var3C[i + 55]].invisible  = TRUE;
		gSprites[gUnknown_0203AB88->var3C[i + 55]].animPaused = TRUE;
		gSprites[gUnknown_0203AB88->var3C[i + 55]].affineAnimPaused =
			TRUE;
		gSprites[gUnknown_0203AB88->var3C[i + 55]].data[4] =
			gUnknown_0203AB88->var3C[55];
		gSprites[gUnknown_0203AB88->var3C[i + 55]].data[5] =
			gUnknown_0203AB88->var3C[56];
		gSprites[gUnknown_0203AB88->var3C[i + 55]].data[6] =
			gUnknown_0203AB88->var3C[57];
		gSprites[gUnknown_0203AB88->var3C[i + 55]].data[2] = t;
		gSprites[gUnknown_0203AB88->var3C[i + 55]].data[3] =
			( sprite->data[7] *
				gUnknown_085B6348[gUnknown_0203AB88->var04_0]
					.var01 ) +
			( gUnknown_085B6348[gUnknown_0203AB88->var04_0].var02 +
				0xFFFF );
	}
...
static void sub_81448B8( struct Sprite* sprite )
{
	u8 i = 0;
	s16 t;
	s16 s[2][2] = {{256, 84}, {-16, 84}};

	t                            = sprite->data[7] - 2;
	gUnknown_0203AB88->var3C[55] = CreateSprite( &gSpriteTemplate_85B7A10,
		s[sprite->data[0]][0],
		s[sprite->data[0]][1],
		50 );
	StartSpriteAnim(
		&gSprites[gUnknown_0203AB88->var3C[55]], sprite->data[0] );
	gUnknown_0203AB88->var3C[56] = CreateSprite( &gUnknown_085B7AEC,
		s[sprite->data[0]][0],
		s[sprite->data[0]][1],
		51 );
	...
	sprite->data[7] =
		( t * gUnknown_085B6348[gUnknown_0203AB88->var04_0].var01 ) +
		( gUnknown_085B6348[gUnknown_0203AB88->var04_0].var10 + 45 );
	for( ; i < 2; i++ )
	{
		gSprites[gUnknown_0203AB88->var3C[55 + i]].data[4] =
			gUnknown_0203AB88->var3C[55];
		gSprites[gUnknown_0203AB88->var3C[55 + i]].data[5] =
			gUnknown_0203AB88->var3C[56];
		gSprites[gUnknown_0203AB88->var3C[55 + i]].data[6] =
			gUnknown_0203AB88->var3C[56];
		gSprites[gUnknown_0203AB88->var3C[55 + i]].data[2] = t;
		gSprites[gUnknown_0203AB88->var3C[55 + i]].data[3] =
			sprite->data[7] - 45;
	}
	gUnknown_0203AB88->var38 = sprite;
}
...
static void sub_8144A24( struct Sprite* sprite )
{
	...
	gUnknown_0203AB88->var98   = 0.0f;
	gUnknown_0203AB88->var8C =
		gUnknown_085B6348[gUnknown_0203AB88->var04_0].var1C;

	o = ( gUnknown_0203AB88->var04_0 * 30 + 33 ) +
		( 0x1 - gUnknown_0203AB88->var03_0 ) * 15;
	for( i = 0; i < 4; i++ )
	{
	...
	if( gUnknown_0203AB88->var03_0 == 1 &&
		gUnknown_0203AB88->var04_0 == 1 )
		j += 6;
	else
		j += val;
...
static void sub_8144CD0( struct Sprite* sprite )
{
	...
	if( sprite->data[1]++ < sprite->data[3] )
	{
		...
		{
			gSpriteCoordOffsetY =
				t[sprite->data[2] / 2][sprite->data[7]];
			p               = sprite->data[7] + 1;
...
static void sub_8144D94( struct Sprite* sprite )
{
	...
	gUnknown_0203AB88->var34 =
		gUnknown_085B7B1A[( gUnknown_0203AB88->var01 - 1 ) / 2];
...
static void sub_8144E60( struct Sprite* sprite )
{
	if( sprite->data[7] == 0 )
	{
		...
		{
			if( gUnknown_0203AB88->var38->data[3] !=
				gUnknown_085B6348[gUnknown_0203AB88->var04_0]
					.var08 )
				return;
		}
	...
	{
		gUnknown_0203AB88->var34 =
			gUnknown_085B7B1A[( gUnknown_0203AB88->var01 - 1 ) /
				2];
		if( gUnknown_0203AB88->var01 < 19 )
			gUnknown_0203AB88->var01++;
...
static void sub_8144F94( struct Sprite* sprite ) { sprite->invisible ^= 1; }
...
static void sub_8144FB0( struct Sprite* sprite )
{
	...
	else
	{
		...
		DestroySprite( sprite );
		FreeOamMatrix(
			gSprites[gUnknown_0203AB88->var3C[56]].oam.matrixNum );
	...
	else
	{
		...
		else
		{
			...
			StartSpriteAnim( sprite,
				gUnknown_0203AB88->var38->data[0] + 4 );
...
static void sub_81450D8( struct Sprite* sprite )
{
	...
	else
	{
		...
		{
			sprite->pos1.x +=
				t[gUnknown_0203AB88->var38->data[0]] *
				z[7 - sprite->data[1]][0];
		...
		else
		{
			...
			if( gUnknown_0203AB88->var38->data[0] == 0 )
				...
				PlayCry1( SPECIES_TAILLOW, -63 );
			StartSpriteAnim( sprite,
				gUnknown_0203AB88->var38->data[0] + 2 );
			sprite->data[1]  = 45;
...
static void sub_8145294( struct Sprite* sprite )
{
	...
	{
		if( gUnknown_0203AB88->var38->data[3] ==
			gUnknown_085B6348[gUnknown_0203AB88->var04_0].var12 +
				90 )
		{
	...
	{
		if( gUnknown_0203AB88->var38->data[3] ==
			gUnknown_085B6348[gUnknown_0203AB88->var04_0].var14 +
				270 )
		{
