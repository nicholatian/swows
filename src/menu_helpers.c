...
static const union AnimCmd sSpriteAnim_859F500[] = {
	ANIMCMD_FRAME( 0, 0, 1, 0 ), ANIMCMD_END};
	...
	void* taskFunc )
{
	...
	AddTextPrinterParameterized2(
		windowId, fontId, gStringVar4, textSpeed, NULL, 2, 1, 3 );
...
bool8 sub_8122148( u16 itemId )
{
	if( itemId != ITEM_ENIGMA_BERRY )
		return TRUE;
	else if( gSaveBlock1Ptr->location.mapGroup ==
			MAP_GROUP( TRADE_CENTER ) &&
...
void sub_812220C( struct ItemSlot* slots,
	u8 count,
	u8* arg2,
	u8* usedSlotsCount,
	u8 maxUsedSlotsCount )
{
	u16 i;
...
void sub_812225C(
	u16* scrollOffset, u16* cursorPos, u8 maxShownItems, u8 numItems )
{
...
void sub_8122344( u8* spriteIds, u8 count )
{
	...
	{
		spriteIds[i] =
			CreateSprite( &gUnknown_0859F524, i * 16, 0, 0 );
		if( i != 0 )
