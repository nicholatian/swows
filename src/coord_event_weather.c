...
static void CoordEventWeather_Clouds( void ) { SetWeather( WEATHER_CLOUDS ); }
...
static void CoordEventWeather_Fog( void ) { SetWeather( WEATHER_FOG_1 ); }
...
static void CoordEventWeather_Ash( void ) { SetWeather( WEATHER_ASH ); }
...
static void CoordEventWeather_Dark( void ) { SetWeather( WEATHER_SHADE ); }
...
void DoCoordEventWeather( u8 coordEventWeather )
{
	...
	{
		if( sCoordEventWeatherFuncs[i].coordEventWeather ==
			coordEventWeather )
		{
