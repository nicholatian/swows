...
const u16 gBirchBallarrow_Pal[] =
	INCBIN_U16( "graphics/misc/birch_ballarrow.gbapal" );

const u16 gBirchCircle_Pal[] =
	INCBIN_U16( "graphics/misc/birch_circle.gbapal" );

const u32 gBirchBagTilemap[] =
	INCBIN_U32( "graphics/misc/birch_bag_map.bin.lz" );

const u32 gBirchGrassTilemap[] =
	INCBIN_U32( "graphics/misc/birch_grass_map.bin.lz" );

const u32 gBirchHelpGfx[] = INCBIN_U32( "graphics/misc/birch_help.4bpp.lz" );

const u32 gUnknown_085B18AC[] =
	INCBIN_U32( "graphics/misc/birch_ballarrow.4bpp.lz" );

const u32 gUnknown_085B1BCC[] =
	INCBIN_U32( "graphics/misc/birch_circle.4bpp.lz" );
...
static const struct WindowTemplate gUnknown_085B1DDC = {.bg = 0,
	.tilemapLeft                                        = 24,
	.tilemapTop                                         = 9,
	.width                                              = 5,
	.height                                             = 4,
...
static const struct WindowTemplate gUnknown_085B1DE4 = {.bg = 0,
	.tilemapLeft                                        = 0,
	.tilemapTop                                         = 0,
	.width                                              = 13,
	.height                                             = 4,
...
static const union AffineAnimCmd* const gUnknown_085B1ED0 = {
	gSpriteAffineAnim_85B1EA0};
static const union AffineAnimCmd* const gSpriteAffineAnimTable_85B1ED4[] = {
	gSpriteAffineAnim_85B1EB8};

static const struct CompressedSpriteSheet gUnknown_085B1ED8[] = {
	{.data = gUnknown_085B18AC, .size = 0x0800, .tag = 0x1000}, {}};

static const struct CompressedSpriteSheet gUnknown_085B1EE8[] = {
	{.data = gUnknown_085B1BCC, .size = 0x0800, .tag = 0x1001}, {}};

static const struct SpritePalette gUnknown_085B1EF8[] = {
	{.data = gBirchBallarrow_Pal, .tag = 0x1000},
	{.data = gBirchCircle_Pal, .tag = 0x1001},
	{},
};

static const struct SpriteTemplate sSpriteTemplate_Hand = {.tileTag = 0x1000,
	.paletteTag                                                 = 0x1000,
...
static const struct SpriteTemplate gUnknown_085B1F40 = {.tileTag = 0x1001,
	.paletteTag                                              = 0x1001,
...
void CB2_ChooseStarter( void )
{
	...
	InitBgsFromTemplates(
		0, gUnknown_085B1E00, ARRAY_COUNT( gUnknown_085B1E00 ) );
	...
	spriteId                   = CreateSprite( &sSpriteTemplate_PokeBall,
                sPokeballCoords[0][0],
                sPokeballCoords[0][1],
                2 );
	gSprites[spriteId].data[0] = taskId;
...
static void Task_StarterChoose1( u8 taskId )
{
	...
	AddTextPrinterParameterized(
		0, 1, gText_BirchInTrouble, 0, 1, 0, NULL );
	PutWindowTilemap( 0 );
...
static void Task_StarterChoose2( u8 taskId )
{
	...
	if( gMain.newKeys & A_BUTTON )
	{
		...
		spriteId = CreateSprite( &gUnknown_085B1F40,
...
static void Task_StarterChoose3( u8 taskId )
{
	if( gSprites[gTasks[taskId].tCircleSpriteId].affineAnimEnded &&
		gSprites[gTasks[taskId].tCircleSpriteId].pos1.x ==
			STARTER_PKMN_POS_X &&
		gSprites[gTasks[taskId].tCircleSpriteId].pos1.y ==
			STARTER_PKMN_POS_Y )
	{
...
static void Task_StarterChoose4( u8 taskId )
{
	...
	AddTextPrinterParameterized(
		0, 1, gText_ConfirmStarterChoice, 0, 1, 0, NULL );
	schedule_bg_copy_tilemap_to_vram( 0 );
...
static void CreateStarterPokemonLabel( u8 selection )
{
	...
	AddTextPrinterParameterized3( sStarterChooseWindowId,
		7,
		width,
		1,
		gUnknown_085B1E0C,
...
{
	sprite->pos1.x =
		gUnknown_085B1E28[gTasks[sprite->data[0]].tStarterSelection]
				 [0];
	sprite->pos1.y =
		gUnknown_085B1E28[gTasks[sprite->data[0]].tStarterSelection]
				 [1];
