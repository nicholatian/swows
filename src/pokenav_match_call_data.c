...
static void MatchCall_GetNameAndDesc_Type0(
	match_call_t, const u8**, const u8** );
static void MatchCall_GetNameAndDesc_Type1(
	match_call_t, const u8**, const u8** );
static void MatchCall_GetNameAndDesc_Type2(
	match_call_t, const u8**, const u8** );
static void MatchCall_GetNameAndDesc_Type3(
	match_call_t, const u8**, const u8** );
static void MatchCall_GetNameAndDesc_Type4(
	match_call_t, const u8**, const u8** );

static void sub_81D1920( const match_call_text_data_t*, u8* );
static void sub_81D199C( const match_call_text_data_t*, u16, u8* );
static void MatchCall_GetNameAndDescByRematchIdx(
...
static const match_call_text_data_t sMrStoneTextScripts[] = {
	...
	{gText_MrStone_Pokenav_2B6664,
		FLAG_GROUDON_AWAKENED_MAGMA_HIDEOUT,
		0xFFFF},
	{gText_MrStone_Pokenav_2B66B1,
...
static const struct MatchCallStruct0 sMrStoneMatchCallHeader = {.type = 0,
	.v1                                                           = 10,
	.flag                                                         = 0xFFFF,
...
static const struct MatchCallStruct5 sNormanMatchCallHeader = {.type = 5,
	.v1                                                          = 7,
...
static const struct MatchCallStruct3 sProfBirchMatchCallHeader = {.type = 3,
	.v1                                                             = 0,
...
static const struct MatchCallStruct0 sMomMatchCallHeader = {.type = 0,
	.v1                                                       = 0,
...
static const struct MatchCallStruct0 sStevenMatchCallHeader = {.type = 0,
	.v1                                                          = 0xD5,
...
static const match_call_text_data_t sMayTextScripts[] = {
	...
	{gText_May_Pokenav_2B3FFB,
		FLAG_GROUDON_AWAKENED_MAGMA_HIDEOUT,
		0xFFFF},
	{gText_May_Pokenav_2B402B, FLAG_MET_TEAM_AQUA_HARBOR, 0xFFFF},
	{gText_May_Pokenav_2B414B,
		FLAG_TEAM_AQUA_ESCAPED_IN_SUBMARINE,
		0xFFFF},
	{gText_May_Pokenav_2B4228,
		FLAG_KYOGRE_ESCAPED_SEAFLOOR_CAVERN,
		0xFFFF},
...
static const struct MatchCallStruct4 sBrendanMatchCallHeader = {.type = 4,
	.gender                                                       = MALE,
...
static const match_call_text_data_t sBrendanTextScripts[] = {
	...
	{gText_Brendan_Pokenav_2B49C4,
		FLAG_GROUDON_AWAKENED_MAGMA_HIDEOUT,
		0xFFFF},
	{gText_Brendan_Pokenav_2B4A44, FLAG_MET_TEAM_AQUA_HARBOR, 0xFFFF},
	{gText_Brendan_Pokenav_2B4B28,
		FLAG_TEAM_AQUA_ESCAPED_IN_SUBMARINE,
		0xFFFF},
	{gText_Brendan_Pokenav_2B4C15,
		FLAG_KYOGRE_ESCAPED_SEAFLOOR_CAVERN,
		0xFFFF},
...
static const struct MatchCallStruct4 sMayMatchCallHeader = {.type = 4,
	.gender                                                   = FEMALE,
	.flag     = FLAG_ENABLE_RIVAL_MATCH_CALL,
	.desc     = gMayBrendanMatchCallDesc,
...
static const match_call_text_data_t sWallyTextScripts[] = {
	...
	{gText_Wally_Pokenav_2B4FF3,
		FLAG_GROUDON_AWAKENED_MAGMA_HIDEOUT,
		0xFFFF},
	{gText_Wally_Pokenav_2B50B1,
		FLAG_KYOGRE_ESCAPED_SEAFLOOR_CAVERN,
		0xFFFF},
...
static const struct MatchCallStruct2 sWallyMatchCallHeader = {.type = 2,
	.v1                                                         = 0,
...
static const struct MatchCallStruct0 sScottMatchCallHeader = {.type = 0,
	.v1                                                         = 0xD5,
...
static const struct MatchCallStruct5 sRoxanneMatchCallHeader = {.type = 5,
	.v1                                                           = 10,
...
static const struct MatchCallStruct5 sBrawlyMatchCallHeader = {.type = 5,
	.v1                                                          = 2,
...
static const struct MatchCallStruct5 sWattsonMatchCallHeader = {.type = 5,
	.v1                                                           = 9,
...
static const struct MatchCallStruct5 sFlanneryMatchCallHeader = {.type = 5,
	.v1                                                            = 3,
...
static const struct MatchCallStruct5 sWinonaMatchCallHeader = {.type = 5,
	.v1                                                          = 11,
...
static const struct MatchCallStruct5 sTateLizaMatchCallHeader = {.type = 5,
	.v1                                                            = 13,
...
static const struct MatchCallStruct5 sJuanMatchCallHeader = {.type = 5,
	.v1                                                        = 14,
...
static const match_call_text_data_t sSidneyTextScripts[] = {
	{gText_Sidney_Pokenav_2B34CC, 0xFFFF, 0xFFFF}, {NULL, 0xFFFF, 0xFFFF}};

static const struct MatchCallStruct5 sSidneyMatchCallHeader = {.type = 5,
	.v1                                                          = 15,
...
static const match_call_text_data_t sPhoebeTextScripts[] = {
	{gText_Phoebe_Pokenav_2B3561, 0xFFFF, 0xFFFF}, {NULL, 0xFFFF, 0xFFFF}};

static const struct MatchCallStruct5 sPhoebeMatchCallHeader = {.type = 5,
	.v1                                                          = 15,
...
static const match_call_text_data_t sGlaciaTextScripts[] = {
	{gText_Glacia_Pokenav_2B35E4, 0xFFFF, 0xFFFF}, {NULL, 0xFFFF, 0xFFFF}};

static const struct MatchCallStruct5 sGlaciaMatchCallHeader = {.type = 5,
	.v1                                                          = 15,
...
static const match_call_text_data_t sDrakeTextScripts[] = {
	{gText_Drake_Pokenav_2B368B, 0xFFFF, 0xFFFF}, {NULL, 0xFFFF, 0xFFFF}};

static const struct MatchCallStruct5 sDrakeMatchCallHeader = {.type = 5,
	.v1                                                         = 15,
...
static const struct MatchCallStruct5 sWallaceMatchCallHeader = {.type = 5,
	.v1                                                           = 15,
...
static u8 ( *const gUnknown_08625310[] )( match_call_t ) = {
	sub_81D1714, sub_81D1718, sub_81D171C, sub_81D1750, sub_81D1754};

static bool32 ( *const sMatchCall_IsRematchableFunctions[] )(
	match_call_t ) = {MatchCall_IsRematchable_Type0,
...
static bool32 ( *const gUnknown_08625338[] )( match_call_t ) = {
	sub_81D1840, sub_81D1844, sub_81D1848, sub_81D184C, sub_81D1850};

static u32 ( *const sMatchCall_GetRematchTableIdxFunctions[] )(
	match_call_t ) = {MatchCall_GetRematchTableIdx_Type0,
...
static void ( *const sMatchCall_GetMessageFunctions[] )(
	match_call_t, u8* ) = {MatchCall_GetMessage_Type0,
...
static void ( *const sMatchCall_GetNameAndDescFunctions[] )( match_call_t,
	const u8**,
	const u8** ) = {MatchCall_GetNameAndDesc_Type0,
...
static const struct UnkStruct_08625388 sMatchCallCheckPageOverrides[] = {
	{7,
		...
		{gMatchCallStevenStrategyText,
			...
			gMatchCall_StevenSelfIntroductionText_Line1_BeforeMeteorFallsBattle,
			gMatchCall_StevenSelfIntroductionText_Line2_BeforeMeteorFallsBattle}}, // STEVEN
	{7,
		0x4B,
		...
		{gMatchCallStevenStrategyText,
			gMatchCall_StevenTrainersPokemonText,
			gMatchCall_StevenSelfIntroductionText_Line1_AfterMeteorFallsBattle,
			gMatchCall_StevenSelfIntroductionText_Line2_AfterMeteorFallsBattle}}, // STEVEN
	{2,
		0x3c,
		0xffff,
		{gMatchCall_BrendanStrategyText,
			...
			gMatchCall_BrendanSelfIntroductionText_Line2}}, // Brendan
	{3,
		0x3f,
		0xffff,
		{gMatchCall_MayStrategyText,
			...
			gMatchCall_MaySelfIntroductionText_Line2}} // May
};
...
static u8 sub_81D1714( match_call_t matchCall ) { return matchCall.type0->v1; }

static u8 sub_81D1718( match_call_t matchCall ) { return matchCall.type1->v1; }
...
static u8 sub_81D1750( match_call_t matchCall ) { return 0xd5; }
...
static bool32 MatchCall_IsRematchable_Type1( match_call_t matchCall )
{
	...
	return gSaveBlock1Ptr
			->trainerRematches[matchCall.type1->rematchTableIdx]
		? TRUE
		: FALSE;
}
...
{
	return gSaveBlock1Ptr
			->trainerRematches[matchCall.type2->rematchTableIdx]
		? TRUE
		: FALSE;
}
...
static bool32 sub_81D1840( match_call_t matchCall ) { return FALSE; }

static bool32 sub_81D1844( match_call_t matchCall ) { return TRUE; }

static bool32 sub_81D1848( match_call_t matchCall ) { return TRUE; }

static bool32 sub_81D184C( match_call_t matchCall ) { return FALSE; }

static bool32 sub_81D1850( match_call_t matchCall ) { return FALSE; }
...
static void MatchCall_GetMessage_Type1( match_call_t matchCall, u8* dest )
{
	if( matchCall.common->type != 5 )
		...
		sub_81D199C( matchCall.type5->textData,
			matchCall.type5->rematchTableIdx,
			dest );
}
...
static void sub_81D199C(
	const match_call_text_data_t* sub0, u16 idx, u8* dest )
{
	u32 i;
	for( i = 0; sub0[i].text != NULL; i++ )
	{
	...
	match_call_t matchCall, const u8** desc, const u8** name )
{
	...
	if( _matchCall.type1->name == NULL )
		MatchCall_GetNameAndDescByRematchIdx(
			_matchCall.type1->rematchTableIdx, desc, name );
	else
...
{
	MatchCall_GetNameAndDescByRematchIdx(
		matchCall.type2->rematchTableIdx, desc, name );
...
static void MatchCall_GetNameAndDescByRematchIdx(
	u32 idx, const u8** desc, const u8** name )
{
	const struct Trainer* trainer =
		gTrainers + GetTrainerIdxByRematchIdx( idx );
	...
	for( i = 0; i < ARRAY_COUNT( sMatchCallCheckPageOverrides ); i++ )
	{
		if( sMatchCallCheckPageOverrides[i].idx == idx )
		{
			for( ; i + 1 < ARRAY_COUNT(
				...
				sMatchCallCheckPageOverrides[i + 1].idx == idx;
				i++ )
			{
				if( !FlagGet(
					    sMatchCallCheckPageOverrides[i + 1]
						    .v4 ) )
					break;
			}
