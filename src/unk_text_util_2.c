...
static const u16 sFont6BrailleGlyphs[] =
	INCBIN_U16( "data/graphics/fonts/font6.fwjpnfont" );
...
u16 Font6Func( struct TextPrinter* textPrinter )
{
	...
	case 0:
		...
		case EXT_CTRL_CODE_BEGIN:
			...
			case 5:
				...
				return 2;
			case 6:
				sub->glyphId = *textPrinter->printerTemplate
							.currentChar;
				textPrinter->printerTemplate.currentChar++;
				return 2;
			case 7:
			...
			case 16:
				...
				return 2;
			case 12:
				char_ = *++textPrinter->printerTemplate
						   .currentChar;
				break;
			case 13:
				textPrinter->printerTemplate.currentX =
	...
	case 4:
		...
		{
			if( textPrinter->scrollDistance <
				sUnknown_08616124[gSaveBlock2Ptr
							  ->optionsTextSpeed] )
			{
				ScrollWindow(
					textPrinter->printerTemplate.windowId,
				...
				ScrollWindow(
					...
					PIXEL_FILL(
						textPrinter->printerTemplate
							.bgColor ) );
				textPrinter
					->scrollDistance -= sUnknown_08616124
					[gSaveBlock2Ptr->optionsTextSpeed];
			}
			CopyWindowToVram(
...
static void DecompressGlyphFont6( u16 glyph )
{
	...
	glyphs = sFont6BrailleGlyphs + 0x100 * ( glyph / 8 ) +
		0x10 * ( glyph % 8 );
	DecompressGlyphTile( glyphs, (u16*)gUnknown_03002F90.unk0 );
	DecompressGlyphTile( glyphs + 0x8, (u16*)( gUnknown_03002F90.unk20 ) );
	DecompressGlyphTile(
		glyphs + 0x80, (u16*)( gUnknown_03002F90.unk40 ) );
	DecompressGlyphTile(
		glyphs + 0x88, (u16*)( gUnknown_03002F90.unk60 ) );
	gUnknown_03002F90.unk80 = 0x10;
	gUnknown_03002F90.unk81 = 0x10;
}

u32 GetGlyphWidthFont6( u16 glyphId, bool32 isJapanese ) { return 0x10; }
