const struct Trainer gTrainers[] = {
	...
	[TRAINER_GRUNT_10] =
		{
			...
			.party = {.NoItemCustomMoves = sParty_Grunt10},
		},
	...
	/*
	      [TRAINER_BRENDAN_4] =
		 {
		    .partyFlags				  = 0,
		    .trainerClass			  =
	   TRAINER_CLASS_PKMN_TRAINER_3, .encounterMusic_gender =
	   TRAINER_ENCOUNTER_MUSIC_MALE, .trainerPic = TRAINER_PIC_BRENDAN,
		    .trainerName			  = _( "BRENDAN" ),
		    .items					  = {},
		    .doubleBattle			  = FALSE,
		    .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE |
	   AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_SETUP_FIRST_TURN, .partySize =
	   ARRAY_COUNT( sParty_Brendan4 ), .party	  =
	   {.NoItemDefaultMoves = sParty_Brendan4},
		 },
	*/
	[TRAINER_BRENDAN_5] =
		{
	...
	/*
	   ...
	   TRAINER_ENCOUNTER_MUSIC_MALE, .trainerPic = TRAINER_PIC_BRENDAN,
		    ...
		    .doubleBattle			  = FALSE,
		    .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE |
	   AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY, .partySize =
	   ARRAY_COUNT( sParty_Brendan7
	...
	*/
	...
	[TRAINER_MAY_1] =
		{
			...
			.party     = {.NoItemCustomMoves = sParty_May1},
		},
	...
	/*
	      [TRAINER_MAY_4] =
		 {
		    ...
		    .aiFlags		  = AI_SCRIPT_CHECK_BAD_MOVE |
	   AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY, .partySize =
	   ARRAY_COUNT( sParty_May4 ), .party	  = {.NoItemDefaultMoves =
	   sParty_May4},
		 },
	*/
	[TRAINER_MAY_5] =
	...
	/*
	      [TRAINER_MAY_7] =
		 {
		    ...
		    .aiFlags		  = AI_SCRIPT_CHECK_BAD_MOVE |
	   AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY, .partySize =
	   ARRAY_COUNT( sParty_May7 ), .party	  = {.NoItemDefaultMoves =
	   sParty_May7},
		 },
	*/
	[TRAINER_MAY_8] =
	...
	[TRAINER_BRENDAN_10] =
		{
			...
			.party     = {.NoItemCustomMoves = sParty_Brendan10},
		},
	...
	[TRAINER_MAY_14] =
		{
			...
			.party     = {.NoItemCustomMoves = sParty_May14},
		},
	...
	[TRAINER_SERA] =
		{
			...
			.doubleBattle = FALSE,
			.aiFlags      = AI_SCRIPT_CHECK_BAD_MOVE,
			.partySize    = ARRAY_COUNT( sParty_Sera ),
			.party        = {.NoItemDefaultMoves = sParty_Sera},
		},
	...
	[TRAINER_GENKI] =
		{
			...
			.doubleBattle          = FALSE,
			.aiFlags               = AI_SCRIPT_CHECK_BAD_MOVE,
			.partySize             = ARRAY_COUNT( sParty_Genki ),
			.party = {.NoItemDefaultMoves = sParty_Genki},
		},
	...
	[TRAINER_MARIANN] =
		{
			...
			.encounterMusic_gender = F_TRAINER_FEMALE |
				TRAINER_ENCOUNTER_MUSIC_TWINS,
			.trainerPic   = TRAINER_PIC_POKEFAN_F,
			.trainerName  = _( "MARIANN" ),
			.items        = {},
			.doubleBattle = FALSE,
			.aiFlags      = AI_SCRIPT_CHECK_BAD_MOVE,
			.partySize    = ARRAY_COUNT( sParty_Mariann ),
			.party        = {.NoItemDefaultMoves = sParty_Mariann},
		},
	...
	[TRAINER_HARROLD] =
		{
			...
			.encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_RICH,
			.trainerPic            = TRAINER_PIC_GENTLEMAN,
			.trainerName           = _( "HARROLD" ),
			.items                 = {},
			.doubleBattle          = FALSE,
			.aiFlags               = AI_SCRIPT_CHECK_BAD_MOVE,
			.partySize             = ARRAY_COUNT( sParty_Harrold ),
			.party = {.NoItemDefaultMoves = sParty_Harrold},
		},
