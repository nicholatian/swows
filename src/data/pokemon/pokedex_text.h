...
const u8 gBulbasaurPokedexText[] =
	_( "BULBASAUR can be seen napping in bright\n"
...
const u8 gCharmanderPokedexText[] =
	_( "The flame that burns at the tip of its\n"
...
const u8 gMetapodPokedexText[] =
	_( "Its shell is as hard as an iron slab.\n"
...
const u8 gKakunaPokedexText[] =
	_( "It remains virtually immobile while it\n"
...
const u8 gRaticatePokedexText[] =
	_( "A RATICATE's sturdy fangs grow steadily.\n"
...
const u8 gFearowPokedexText[] =
	_( "Its long neck and elongated beak are\n"
...
const u8 gRaichuPokedexText[] =
	_( "If it stores too much electricity, its\n"
...
const u8 gNidokingPokedexText[] =
	_( "A NIDOKING's thick tail packs enormously\n"
...
const u8 gVulpixPokedexText[] =
	_( "It can freely control fire, making fiery\n"
...
const u8 gZubatPokedexText[] =
	_( "While living in pitch-black caverns, their\n"
...
const u8 gPsyduckPokedexText[] =
	_( "When its headache intensifies, it starts\n"
	   "using strange powers. However, it has no\n"
	   "recollection of its powers, so it always\n"
	   "looks befuddled and bewildered." );

const u8 gGolduckPokedexText[] =
	_( "A GOLDUCK is an adept swimmer.\n"
...
const u8 gPonytaPokedexText[] =
	_( "A PONYTA is very weak at birth. It can\n"
...
const u8 gMagnemitePokedexText[] =
	_( "The units at its sides are extremely\n"
...
const u8 gDoduoPokedexText[] =
	_( "Even while eating or sleeping, one of the\n"
...
const u8 gDewgongPokedexText[] =
	_( "It loves to snooze on bitterly cold ice.\n"
	   "The sight of this POKéMON sleeping on\n"
	   "a glacier was mistakenly thought to be\n"
	   "a mermaid by a mariner long ago." );

const u8 gGrimerPokedexText[] =
	_( "Born from polluted sludge in the sea,\n"
...
const u8 gCloysterPokedexText[] =
	_( "It swims in the sea by swallowing water,\n"
	   "then jetting it out toward the rear.\n"
	   "The CLOYSTER shoots spikes from its\n"
	   "shell using the same system." );

const u8 gGastlyPokedexText[] =
	_( "When exposed to a strong wind, a GASTLY's\n"
...
const u8 gOnixPokedexText[] =
	_( "There is a magnet in its brain that\n"
...
const u8 gKrabbyPokedexText[] =
	_( "KRABBY live in holes dug into beaches.\n"
	   "On sandy shores with little in the way\n"
	   "of food, they can be seen squabbling with\n"
	   "each other over territory." );

const u8 gKinglerPokedexText[] =
	_( "It waves its huge, oversized claw in the\n"
	   "air to communicate with others.\n"
	   "But since the claw is so heavy, this\n"
	   "POKéMON quickly tires." );

const u8 gVoltorbPokedexText[] =
	_( "It bears an uncanny and unexplained\n"
...
const u8 gCubonePokedexText[] =
	_( "It pines for the mother it will never see\n"
	   "again. Seeing a likeness of its mother in\n"
	   "the full moon, it cries. The stains on the\n"
	   "skull it wears are from its tears." );

const u8 gMarowakPokedexText[] =
	_( "A MAROWAK is the evolved form of a CUBONE\n"
...
const u8 gLickitungPokedexText[] =
	_( "Whenever it sees something unfamiliar,\n"
	   "it always licks the object because it\n"
	   "memorizes things by texture and taste.\n"
	   "It is somewhat put off by sour things." );

const u8 gKoffingPokedexText[] =
	_( "Getting up close to a KOFFING will give\n"
...
const u8 gRhyhornPokedexText[] =
	_( "Once it starts running, it doesn't stop.\n"
	   "Its tiny brain makes it so stupid that it\n"
	   "can't remember why it started running in\n"
	   "the first place." );

const u8 gRhydonPokedexText[] =
	_( "Its horn, which rotates like a drill,\n"
...
const u8 gScytherPokedexText[] =
	_( "Its blindingly fast speed adds to the\n"
	   "sharpness of its twin forearm scythes.\n"
	   "The scythes can slice through thick logs\n"
	   "in one wicked stroke." );

const u8 gJynxPokedexText[] =
	_( "A JYNX sashays rhythmically as if it were\n"
...
const u8 gTaurosPokedexText[] =
	_( "It is not satisfied unless it is rampaging\n"
...
const u8 gLaprasPokedexText[] =
	_( "People have driven LAPRAS almost to the\n"
...
const u8 gVaporeonPokedexText[] =
	_( "VAPOREON underwent a spontaneous\n"
...
const u8 gFlareonPokedexText[] =
	_( "FLAREON's fluffy fur releases heat into\n"
...
const u8 gOmanytePokedexText[] =
	_( "One of the ancient and long-since-extinct\n"
	   "POKéMON that have been regenerated\n"
	   "from fossils by humans. If attacked,\n"
	   "it withdraws into its hard shell." );

const u8 gOmastarPokedexText[] =
	_( "An OMASTAR uses its tentacles to capture\n"
...
const u8 gSnorlaxPokedexText[] =
	_( "SNORLAX's typical day consists of nothing\n"
...
const u8 gMewtwoPokedexText[] =
	_( "A POKéMON that was created by genetic\n"
...
const u8 gBayleefPokedexText[] =
	_( "A BAYLEEF's neck is ringed by curled-up\n"
	   "leaves. Inside each leaf is a small tree\n"
	   "shoot. The fragrance of this shoot\n"
	   "makes people peppy." );

const u8 gMeganiumPokedexText[] =
	_( "The fragrance of a MEGANIUM's flower\n"
...
const u8 gQuilavaPokedexText[] =
	_( "It intimidates foes with intense gusts of\n"
...
const u8 gFurretPokedexText[] =
	_( "A FURRET has a very slim build. When under\n"
	   "attack, it can squirm through narrow\n"
	   "spaces and get away. In spite of its short\n"
	   "limbs, it is very nimble and fleet." );

const u8 gHoothootPokedexText[] =
	_( "It has an internal organ that senses\n"
...
const u8 gLedybaPokedexText[] =
	_( "LEDYBA communicate using a fluid that\n"
...
const u8 gSpinarakPokedexText[] =
	_( "The web it spins can be considered its\n"
...
const u8 gPichuPokedexText[] =
	_( "It is still inept at retaining electricity.\n"
	   "When it is startled, it discharges power\n"
	   "accidentally. It gets better at holding\n"
	   "power as it grows older." );

const u8 gCleffaPokedexText[] =
	_( "On nights with many shooting stars,\n"
...
const u8 gMarillPokedexText[] =
	_( "Its body is covered with water-repellent\n"
...
const u8 gSunkernPokedexText[] =
	_( "SUNKERN try to minimize movement to\n"
	   "conserve the nutrients they have stored\n"
	   "in their bodies for evolution. They will\n"
	   "not eat, subsisting only on morning dew." );

const u8 gSunfloraPokedexText[] =
	_( "SUNFLORA convert solar energy into\n"
...
const u8 gEspeonPokedexText[] =
	_( "An ESPEON is extremely loyal to any\n"
...
const u8 gUnownPokedexText[] =
	_( "This POKéMON is shaped like ancient text\n"
...
const u8 gPinecoPokedexText[] =
	_( "A PINECO hangs from a tree branch and\n"
...
const u8 gSteelixPokedexText[] =
	_( "STEELIX live even further underground\n"
	   "than ONIX. This POKéMON is known to dig\n"
	   "toward the earth's core, reaching a depth\n"
	   "of over six-tenths of a mile underground." );

const u8 gSnubbullPokedexText[] =
	_( "By baring its fangs and making a scary\n"
...
const u8 gQwilfishPokedexText[] =
	_( "A QWILFISH uses the pressure of water\n"
	   "it swallows to shoot toxic quills all at\n"
	   "once from all over its body. It finds\n"
	   "swimming to be somewhat challenging." );

const u8 gScizorPokedexText[] =
	_( "A SCIZOR has a body with the hardness of\n"
...
const u8 gSneaselPokedexText[] =
	_( "A SNEASEL scales trees by punching its\n"
...
const u8 gSwinubPokedexText[] =
	_( "It roots for food by rubbing its snout\n"
...
const u8 gDelibirdPokedexText[] =
	_( "It carries food bundled up in its tail.\n"
	   "There was a famous explorer who\n"
	   "managed to scale Mt. Everest thanks\n"
	   "to a DELIBIRD sharing its food." );

const u8 gMantinePokedexText[] =
	_( "On sunny days, schools of MANTINE can be\n"
	   "seen elegantly leaping over the waves.\n"
	   "It is not bothered by the REMORAID that\n"
	   "hitches rides." );

const u8 gSkarmoryPokedexText[] =
	_( "A POKéMON that has a body and wings of\n"
	   "steel. People in the past used feathers\n"
	   "fallen from SKARMORY to make swords and\n"
	   "knives." );

const u8 gHoundourPokedexText[] =
	_( "HOUNDOUR communicate with each other\n"
...
const u8 gKingdraPokedexText[] =
	_( "It sleeps quietly, deep on the seafloor.\n"
...
const u8 gDonphanPokedexText[] =
	_( "A DONPHAN is so strong it can easily haul\n"
...
const u8 gTyroguePokedexText[] =
	_( "TYROGUE become stressed out if they do\n"
...
const u8 gElekidPokedexText[] =
	_( "If it touches metal and discharges the\n"
	   "electricity it has stored in its body, an\n"
	   "ELEKID begins swinging its arms in circles\n"
	   "to recharge itself." );

const u8 gMagbyPokedexText[] =
	_( "If a MAGBY is spouting yellow flames from\n"
...
const u8 gEnteiPokedexText[] =
	_( "ENTEI embodies the passion of magma.\n"
...
const u8 gLugiaPokedexText[] =
	_( "LUGIA is so powerful even a light\n"
	   "fluttering of its wings can blow apart\n"
	   "houses. As a result, it chooses to live out\n"
	   "of sight deep under the sea." );

const u8 gHoOhPokedexText[] =
	_( "Its feathers--which glow in seven colors\n"
...
const u8 gCelebiPokedexText[] =
	_( "This POKéMON came from the future by\n"
...
const u8 gGrovylePokedexText[] =
	_( "Leaves grow out of this POKéMON's body.\n"
...
const u8 gTorchicPokedexText[] =
	_( "If attacked, it strikes back by spitting\n"
	   "balls of fire it forms in its stomach.\n"
	   "A TORCHIC dislikes darkness because it\n"
	   "can't see its surroundings." );

const u8 gCombuskenPokedexText[] =
	_( "It lashes out with 10 kicks per second.\n"
	   "Its strong fighting instinct compels it\n"
	   "to keep up its offensive until the\n"
	   "opponent gives up." );

const u8 gBlazikenPokedexText[] =
	_( "It learns martial arts that use punches\n"
...
const u8 gPoochyenaPokedexText[] =
	_( "It savagely threatens foes with bared\n"
	   "fangs. It chases after fleeing targets\n"
	   "tenaciously. It turns tail and runs,\n"
	   "however, if the foe strikes back." );

const u8 gMightyenaPokedexText[] =
	_( "In the wild, MIGHTYENA live in a pack.\n"
...
const u8 gSilcoonPokedexText[] =
	_( "It prepares for evolution using the\n"
...
const u8 gDustoxPokedexText[] =
	_( "It is a nocturnal POKéMON that flies from\n"
...
const u8 gNuzleafPokedexText[] =
	_( "A forest-dwelling POKéMON that is skilled\n"
...
const u8 gSwellowPokedexText[] =
	_( "A SWELLOW dives upon prey from far above.\n"
	   "It never misses its targets. It takes to\n"
	   "the skies in search of lands with a warm\n"
	   "climate." );

const u8 gWingullPokedexText[] =
	_( "It makes its nest on a sheer cliff at the\n"
...
const u8 gKirliaPokedexText[] =
	_( "A KIRLIA has the psychic power to create \n"
	   "a rip in the dimensions and see into the\n"
	   "future. It is said to dance with pleasure\n"
	   "on sunny mornings." );

const u8 gGardevoirPokedexText[] =
	_( "It apparently does not feel the pull of\n"
	   "gravity because it supports itself with\n"
	   "psychic power. It will give its life to\n"
	   "protect its TRAINER." );

const u8 gSurskitPokedexText[] =
	_( "They gather on puddles after evening\n"
...
const u8 gShroomishPokedexText[] =
	_( "It loves to eat damp, composted soil in\n"
	   "forests. If you enter a forest after a\n"
	   "long rain, you can see many SHROOMISH\n"
	   "feasting on composted soil." );

const u8 gBreloomPokedexText[] =
	_( "It scatters spores from holes in the cap\n"
...
const u8 gLoudredPokedexText[] =
	_( "It positions the round speakers on its\n"
...
const u8 gHariyamaPokedexText[] =
	_( "It has the habit of challenging others\n"
...
const u8 gAronPokedexText[] =
	_( "A POKéMON that is clad in steel armor.\n"
...
const u8 gAggronPokedexText[] =
	_( "Its iron horns grow longer a little at\n"
...
const u8 gPluslePokedexText[] =
	_( "It has the trait of cheering on its fellow\n"
...
const u8 gVolbeatPokedexText[] =
	_( "With their taillights lit, VOLBEAT fly in\n"
...
const u8 gRoseliaPokedexText[] =
	_( "A ROSELIA that drinks nutritionally rich\n"
...
const u8 gFlygonPokedexText[] =
	_( "The flapping of its wings sounds like\n"
...
const u8 gAltariaPokedexText[] =
	_( "It hums in a beautiful soprano voice.\n"
...
const u8 gSeviperPokedexText[] =
	_( "SEVIPER and ZANGOOSE are eternal rivals.\n"
...
const u8 gSolrockPokedexText[] =
	_( "Solar energy is the source of this \n"
...
const u8 gBaltoyPokedexText[] =
	_( "A BALTOY moves by spinning on its single\n"
...
const u8 gLileepPokedexText[] =
	_( "It disguises itself as seaweed by making\n"
...
const u8 gArmaldoPokedexText[] =
	_( "ARMALDO usually lives on land. However,\n"
...
const u8 gCastformPokedexText[] =
	_( "It alters its form depending on the\n"
...
const u8 gShuppetPokedexText[] =
	_( "This POKéMON roams about deep in the\n"
	   "night seeking such negative emotions as\n"
	   "grudges and envy. It retreats to its nest\n"
	   "when the sun begins to rise." );

const u8 gBanettePokedexText[] =
	_( "An abandoned plush doll became this\n"
...
const u8 gTropiusPokedexText[] =
	_( "It flies by flapping its broad leaves.\n"
...
const u8 gAbsolPokedexText[] =
	_( "It sharply senses even subtle changes in\n"
	   "the sky and the land to predict natural\n"
	   "disasters. It is a long-lived POKéMON that\n"
	   "has a life-span of 100 years." );

const u8 gWynautPokedexText[] =
	_( "A WYNAUT loves to eat sweet fruits.\n"
...
const u8 gGlaliePokedexText[] =
	_( "A GLALIE has the power to instantaneously\n"
	   "freeze moisture in the atmosphere.\n"
	   "A dazzling cloud of diamondlike ice\n"
	   "crystals forms around its body." );

const u8 gSphealPokedexText[] =
	_( "It is completely covered with plushy fur.\n"
...
const u8 gLuvdiscPokedexText[] =
	_( "LUVDISC make the branches of CORSOLA\n"
	   "their nests. There is a custom from long\n"
	   "ago of giving a LUVDISC as a gift to\n"
	   "express one's feelings of love." );

const u8 gBagonPokedexText[] =
	_( "Although it is small, this POKéMON is very\n"
	   "powerful because its body is a bundle of\n"
	   "muscles. It launches head-butts with its\n"
	   "ironlike skull." );

const u8 gShelgonPokedexText[] =
	_( "It hardly eats while it awaits evolution.\n"
...
const u8 gBeldumPokedexText[] =
	_( "When BELDUM gather in a swarm, they move\n"
	   "in perfect unison as if they were but one\n"
	   "POKéMON. They communicate with each other\n"
	   "using brain waves." );

const u8 gMetangPokedexText[] =
	_( "The claws tipping its arms pack the\n"
...
const u8 gRegicePokedexText[] =
	_( "Its entire body is made of Antarctic ice.\n"
...
const u8 gKyogrePokedexText[] =
	_( "KYOGRE has appeared in mythology as the\n"
	   "creator of the sea. After long years of\n"
	   "feuding with GROUDON, it took to sleep at\n"
	   "the bottom of the sea." );

const u8 gGroudonPokedexText[] =
	_( "GROUDON has appeared in mythology as the\n"
	   "creator of the land. It sleeps in magma\n"
	   "underground and is said to make volcanoes\n"
	   "erupt on awakening." );

const u8 gRayquazaPokedexText[] =
	_( "A POKéMON that flies endlessly in the\n"
...
const u8 gDeoxysPokedexText[] =
	_( "A POKéMON that mutated from an\n"
