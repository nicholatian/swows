...
const struct SpriteFrameImage gEventObjectPicTable_MysteryEventDeliveryman[] =
	{
		overworld_frame(
			gEventObjectPic_MysteryEventDeliveryman, 2, 4, 0 ),
		overworld_frame(
			gEventObjectPic_MysteryEventDeliveryman, 2, 4, 1 ),
		overworld_frame(
			gEventObjectPic_MysteryEventDeliveryman, 2, 4, 2 ),
		overworld_frame(
			gEventObjectPic_MysteryEventDeliveryman, 2, 4, 0 ),
		overworld_frame(
			gEventObjectPic_MysteryEventDeliveryman, 2, 4, 0 ),
...
const struct SpriteFrameImage gEventObjectPicTable_QuazMemberM[] = {
	overworld_frame( gEventObjectPic_QuazMemberM, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_QuazMemberM, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_QuazMemberM, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_QuazMemberM, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_QuazMemberM, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_QuazMemberM, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_QuazMemberM, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_QuazMemberM, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_QuazMemberM, 2, 4, 8 ),
};

const struct SpriteFrameImage gEventObjectPicTable_QuazMemberF[] = {
	overworld_frame( gEventObjectPic_QuazMemberF, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_QuazMemberF, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_QuazMemberF, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_QuazMemberF, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_QuazMemberF, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_QuazMemberF, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_QuazMemberF, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_QuazMemberF, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_QuazMemberF, 2, 4, 8 ),
};

const struct SpriteFrameImage gEventObjectPicTable_CCACCMemberM[] = {
	overworld_frame( gEventObjectPic_CCACCMemberM, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_CCACCMemberM, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_CCACCMemberM, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_CCACCMemberM, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_CCACCMemberM, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_CCACCMemberM, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_CCACCMemberM, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_CCACCMemberM, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_CCACCMemberM, 2, 4, 8 ),
};

const struct SpriteFrameImage gEventObjectPicTable_CCACCMemberF[] = {
	overworld_frame( gEventObjectPic_CCACCMemberF, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_CCACCMemberF, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_CCACCMemberF, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_CCACCMemberF, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_CCACCMemberF, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_CCACCMemberF, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_CCACCMemberF, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_CCACCMemberF, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_CCACCMemberF, 2, 4, 8 ),
};

const struct SpriteFrameImage gEventObjectPicTable_Courtney[] = {
	overworld_frame( gEventObjectPic_Courtney, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_Courtney, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_Courtney, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_Courtney, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_Courtney, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_Courtney, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_Courtney, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_Courtney, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_Courtney, 2, 4, 8 ),
};

const struct SpriteFrameImage gEventObjectPicTable_Tabitha[] = {
	overworld_frame( gEventObjectPic_Tabitha, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_Tabitha, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_Tabitha, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_Tabitha, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_Tabitha, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_Tabitha, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_Tabitha, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_Tabitha, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_Tabitha, 2, 4, 8 ),
};

const struct SpriteFrameImage gEventObjectPicTable_Shelley[] = {
	overworld_frame( gEventObjectPic_Shelley, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_Shelley, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_Shelley, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_Shelley, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_Shelley, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_Shelley, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_Shelley, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_Shelley, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_Shelley, 2, 4, 8 ),
};
...
const struct SpriteFrameImage gEventObjectPicTable_Sammi[] = {
	overworld_frame( gEventObjectPic_Sammi, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_Sammi, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_Sammi, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_Sammi, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_Sammi, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_Sammi, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_Sammi, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_Sammi, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_Sammi, 2, 4, 8 ),
};

const struct SpriteFrameImage gEventObjectPicTable_Dean[] = {
	overworld_frame( gEventObjectPic_Dean, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_Dean, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_Dean, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_Dean, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_Dean, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_Dean, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_Dean, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_Dean, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_Dean, 2, 4, 8 ),
};

const struct SpriteFrameImage gEventObjectPicTable_Alexis[] = {
	overworld_frame( gEventObjectPic_Alexis, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_Alexis, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_Alexis, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_Alexis, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_Alexis, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_Alexis, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_Alexis, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_Alexis, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_Alexis, 2, 4, 8 ),
};

const struct SpriteFrameImage gEventObjectPicTable_Jack[] = {
	overworld_frame( gEventObjectPic_Jack, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_Jack, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_Jack, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_Jack, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_Jack, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_Jack, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_Jack, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_Jack, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_Jack, 2, 4, 8 ),
};

const struct SpriteFrameImage gEventObjectPicTable_Roland[] = {
	overworld_frame( gEventObjectPic_Roland, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_Roland, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_Roland, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_Roland, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_Roland, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_Roland, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_Roland, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_Roland, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_Roland, 2, 4, 8 ),
};

const struct SpriteFrameImage gEventObjectPicTable_Janis[] = {
	overworld_frame( gEventObjectPic_Janis, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_Janis, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_Janis, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_Janis, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_Janis, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_Janis, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_Janis, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_Janis, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_Janis, 2, 4, 8 ),
};

const struct SpriteFrameImage gEventObjectPicTable_Hideki[] = {
	overworld_frame( gEventObjectPic_Hideki, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_Hideki, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_Hideki, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_Hideki, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_Hideki, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_Hideki, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_Hideki, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_Hideki, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_Hideki, 2, 4, 8 ),
};

const struct SpriteFrameImage gEventObjectPicTable_InterpolEmployee[] = {
	overworld_frame( gEventObjectPic_InterpolEmployee, 2, 4, 0 ),
	overworld_frame( gEventObjectPic_InterpolEmployee, 2, 4, 1 ),
	overworld_frame( gEventObjectPic_InterpolEmployee, 2, 4, 2 ),
	overworld_frame( gEventObjectPic_InterpolEmployee, 2, 4, 3 ),
	overworld_frame( gEventObjectPic_InterpolEmployee, 2, 4, 4 ),
	overworld_frame( gEventObjectPic_InterpolEmployee, 2, 4, 5 ),
	overworld_frame( gEventObjectPic_InterpolEmployee, 2, 4, 6 ),
	overworld_frame( gEventObjectPic_InterpolEmployee, 2, 4, 7 ),
	overworld_frame( gEventObjectPic_InterpolEmployee, 2, 4, 8 ),
};
