...
const struct Subsprite gEventObjectSpriteOamTable_16x16_2[] = {
	{-8, -8, 1, 0, 0, 2}, {-8, 0, 1, 0, 2, 3}};

const struct Subsprite gEventObjectSpriteOamTable_16x16_3[] = {
	{-8, -8, 0, 1, 0, 2}, {-8, -8, 0, 1, 0, 3}};

const struct Subsprite gEventObjectSpriteOamTable_16x16_4[] = {
	{-8, -8, 0, 1, 0, 1}, {-8, -8, 0, 1, 0, 3}};

const struct SubspriteTable gEventObjectSpriteOamTables_16x16[] = {{0, NULL},
...
const struct Subsprite gEventObjectSpriteOamTable_16x32_2[] = {
	{-8, -16, 0, 1, 0, 2}, {-8, 0, 1, 0, 4, 2}, {-8, 8, 1, 0, 6, 3}};

const struct Subsprite gEventObjectSpriteOamTable_16x32_3[] = {
	{-8, -16, 0, 1, 0, 2}, {-8, 0, 0, 1, 4, 3}};

const struct Subsprite gEventObjectSpriteOamTable_16x32_4[] = {
	{-8, -16, 0, 1, 0, 1}, {-8, 0, 0, 1, 4, 3}};

const struct SubspriteTable gEventObjectSpriteOamTables_16x32[] = {{0, NULL},
...
const struct Subsprite gEventObjectSpriteOamTable_32x32_2[] = {
	{-16, -16, 1, 2, 0, 2}, {-16, 0, 1, 1, 8, 2}, {-16, 8, 1, 1, 12, 3}};

const struct Subsprite gEventObjectSpriteOamTable_32x32_3[] = {
	{-16, -16, 1, 2, 0, 2}, {-16, 0, 1, 2, 8, 3}};

const struct Subsprite gEventObjectSpriteOamTable_32x32_4[] = {
	{-16, -16, 1, 2, 0, 1}, {-16, 0, 1, 2, 8, 3}};

const struct SubspriteTable gEventObjectSpriteOamTables_32x32[] = {{0, NULL},
...
const struct SubspriteTable gEventObjectSpriteOamTables_Unused[] = {{0, NULL},
...
const struct SubspriteTable gEventObjectSpriteOamTables_64x64[] = {{0, NULL},
