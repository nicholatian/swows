const struct OamData gEventObjectBaseOam_8x8 = {.shape = SPRITE_SHAPE( 8x8 ),
	.size                                          = SPRITE_SIZE( 8x8 ),
	.priority                                      = 2};

const struct OamData gEventObjectBaseOam_16x8 = {.shape = SPRITE_SHAPE( 16x8 ),
...
const struct OamData gEventObjectBaseOam_32x8 = {.shape = SPRITE_SHAPE( 32x8 ),
