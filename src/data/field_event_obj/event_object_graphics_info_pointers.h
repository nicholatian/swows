...
const struct EventObjectGraphicsInfo* const
	gEventObjectGraphicsInfoPointers[] = {
		...
		&gEventObjectGraphicsInfo_QuazMemberM,
		&gEventObjectGraphicsInfo_QuazMemberF,
		&gEventObjectGraphicsInfo_CCACCMemberM,
		&gEventObjectGraphicsInfo_CCACCMemberF,
		...
		&gEventObjectGraphicsInfo_Sammi,
		&gEventObjectGraphicsInfo_Dean,
		&gEventObjectGraphicsInfo_Alexis,
		&gEventObjectGraphicsInfo_Jack,
		&gEventObjectGraphicsInfo_Roland,
		&gEventObjectGraphicsInfo_Janis,
		&gEventObjectGraphicsInfo_Hideki,
		&gEventObjectGraphicsInfo_InterpolEmployee,
		&gEventObjectGraphicsInfo_HoOh,
};

const struct EventObjectGraphicsInfo* const
	gMauvilleOldManGraphicsInfoPointers[] = {
		&gEventObjectGraphicsInfo_Bard,
