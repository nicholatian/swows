...
const struct Item gItems[] =
	{
		...
		[ITEM_COMET_DUST] =
			{
				.name         = _( "COMET DUST" ),
				.itemId       = ITEM_COMET_DUST,
				.price        = 2000,
				.description  = sCometDustDesc,
				.pocket       = POCKET_ITEMS,
				.type         = 4,
				.fieldUseFunc = ItemUseOutOfBattle_CannotUse,
				.secondaryId  = 0,
		...
		[ITEM_SOUL_SCALE] =
			{
				.name         = _( "SOUL SCALE" ),
				.itemId       = ITEM_SOUL_SCALE,
				.price        = 0,
				.description  = sSoulScaleDesc,
				.importance   = 2,
				.pocket       = POCKET_KEY_ITEMS,
				.type         = 4,
				.fieldUseFunc = ItemUseOutOfBattle_CannotUse,
		...
		[ITEM_GAIA_ORB] =
			{
				.name         = _( "GAIA ORB" ),
				.itemId       = ITEM_GAIA_ORB,
				.price        = 0,
				.description  = sGaiaOrbDesc,
				.importance   = 2,
				.pocket       = POCKET_KEY_ITEMS,
				.type         = 4,
				.fieldUseFunc = ItemUseOutOfBattle_CannotUse,
		...
		[ITEM_GOLD_LEAF] =
			{
				.name         = _( "GOLD LEAF" ),
				.itemId       = ITEM_GOLD_LEAF,
				.price        = 0,
				.description  = sGoldLeafDesc,
				.importance   = 2,
				.pocket       = POCKET_ITEMS,
				.type         = 4,
				.fieldUseFunc = ItemUseOutOfBattle_CannotUse,
		...
		[ITEM_SILVER_LEAF] =
			{
				.name         = _( "SILVER LEAF" ),
				.itemId       = ITEM_SILVER_LEAF,
				.price        = 0,
				.description  = sSilverLeafDesc,
				.importance   = 2,
				.pocket       = POCKET_ITEMS,
				.type         = 4,
				.fieldUseFunc = ItemUseOutOfBattle_CannotUse,
		...
		[ITEM_CRYSTAL_LEAF] =
			{
				.name         = _( "CRYSTAL LEAF" ),
				.itemId       = ITEM_CRYSTAL_LEAF,
				.price        = 0,
				.description  = sCrystalLeafDesc,
				.importance   = 2,
				.pocket       = POCKET_ITEMS,
				.type         = 4,
				.fieldUseFunc = ItemUseOutOfBattle_CannotUse,
		...
		[ITEM_SLOWPOKETAIL] =
			{
				.name         = _( "SLOWPOKETAIL" ),
				.itemId       = ITEM_SLOWPOKETAIL,
				.price        = 0,
				.description  = sSlowpoketailDesc,
				.importance   = 2,
				.pocket       = POCKET_ITEMS,
				.type         = 4,
				.fieldUseFunc = ItemUseOutOfBattle_CannotUse,
		...
		[ITEM_RELIC_BRONZE] =
			{
				.name         = _( "RELIC BRONZE" ),
				.itemId       = ITEM_RELIC_BRONZE,
				.price        = 0,
				.description  = sRelicBronzeDesc,
				.importance   = 2,
				.pocket       = POCKET_ITEMS,
				.type         = 4,
				.fieldUseFunc = ItemUseOutOfBattle_CannotUse,
		...
		[ITEM_MOON_SHARD] =
			{
				.name         = _( "MOON SHARD" ),
				.itemId       = ITEM_MOON_SHARD,
				.price        = 0,
				.description  = sMoonShardDesc,
				.importance   = 2,
				.pocket       = POCKET_ITEMS,
				.type         = 4,
				.fieldUseFunc = ItemUseOutOfBattle_CannotUse,
		...
		[ITEM_SUN_SHARD] =
			{
				.name         = _( "SUN SHARD" ),
				.itemId       = ITEM_SUN_SHARD,
				.price        = 0,
				.description  = sSunShardDesc,
				.importance   = 2,
				.pocket       = POCKET_ITEMS,
				.type         = 4,
				.fieldUseFunc = ItemUseOutOfBattle_CannotUse,
		...
		[ITEM_VINTAGE_BALL] =
			{
				.name         = _( "VINTAGE BALL" ),
				.itemId       = ITEM_VINTAGE_BALL,
				.price        = 0,
				.description  = sVintageBallDesc,
				.importance   = 2,
				.pocket       = POCKET_POKE_BALLS,
				.type         = 4,
				.fieldUseFunc = ItemUseInBattle_PokeBall,
		...
		[ITEM_DARK_BALL] =
			{
				.name         = _( "DARK BALL" ),
				.itemId       = ITEM_DARK_BALL,
				.price        = 0,
				.description  = sDarkBallDesc,
				.importance   = 2,
				.pocket       = POCKET_POKE_BALLS,
				.type         = 4,
				.fieldUseFunc = ItemUseInBattle_PokeBall,
		...
		[ITEM_LAKE_BALL] =
			{
				.name         = _( "LAKE BALL" ),
				.itemId       = ITEM_LAKE_BALL,
				.price        = 0,
				.description  = sLakeBallDesc,
				.importance   = 2,
				.pocket       = POCKET_POKE_BALLS,
				.type         = 4,
				.fieldUseFunc = ItemUseInBattle_PokeBall,
		...
		[ITEM_QUAZ_BALL] =
			{
				.name         = _( "QUAZ BALL" ),
				.itemId       = ITEM_QUAZ_BALL,
				.price        = 0,
				.description  = sQuazBallDesc,
				.importance   = 2,
				.pocket       = POCKET_POKE_BALLS,
				.type         = 4,
				.fieldUseFunc = ItemUseInBattle_PokeBall,
		...
		[ITEM_CCACC_BALL] =
			{
				.name         = _( "CCACC BALL" ),
				.itemId       = ITEM_CCACC_BALL,
				.price        = 0,
				.description  = sCCACCBallDesc,
				.importance   = 2,
				.pocket       = POCKET_POKE_BALLS,
				.type         = 4,
				.fieldUseFunc = ItemUseInBattle_PokeBall,
		...
		[ITEM_ROCKET_BALL] =
			{
				.name         = _( "ROCKET BALL" ),
				.itemId       = ITEM_ROCKET_BALL,
				.price        = 0,
				.description  = sRocketBallDesc,
				.importance   = 2,
				.pocket       = POCKET_POKE_BALLS,
				.type         = 4,
				.fieldUseFunc = ItemUseInBattle_PokeBall,
