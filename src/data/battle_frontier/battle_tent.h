...
const struct BattleFrontierTrainer gSlateportBattleTentTrainers[] = {
	...
	[2]  = {.facilityClass = FACILITY_CLASS_TUBER_F,
	...
	[3]  = {.facilityClass = FACILITY_CLASS_TUBER_M,
                .trainerName  = _( "DAVON" ),
	...
	[4]  = {.facilityClass = FACILITY_CLASS_LADY,
	...
	[5]  = {.facilityClass = FACILITY_CLASS_BEAUTY,
	...
	[6]  = {.facilityClass = FACILITY_CLASS_RICH_BOY,
	...
	[7]  = {.facilityClass = FACILITY_CLASS_POKEMANIAC,
                ...
                .speechBefore = {EC_WORD_GRAAAH,
                        ...
                        EC_WORD_GRAAAH,
                        EC_WORD_EXCL_EXCL},
                .speechWin    = {EC_MOVE2( ROAR ),
                        EC_WORD_EXCL,
                        -1,
                        EC_MOVE2( ROAR ),
                        EC_WORD_EXCL_EXCL,
                        -1},
                .speechLose   = {EC_WORD_URGH,
                        EC_WORD_WAAAH,
                        EC_WORD_EXCL_EXCL,
                        -1,
                        -1,
	...
	[8]  = {.facilityClass = FACILITY_CLASS_SWIMMER_M,
	...
	[11] = {.facilityClass = FACILITY_CLASS_GENTLEMAN,
		.trainerName   = _( "SHAUN" ),
	...
	[12] = {.facilityClass = FACILITY_CLASS_GUITARIST,
		.trainerName   = _( "KYLER" ),
	...
	[13] = {.facilityClass = FACILITY_CLASS_SCHOOL_KID_F,
	...
	[14] = {.facilityClass = FACILITY_CLASS_COOLTRAINER_M,
	...
	[15] = {.facilityClass = FACILITY_CLASS_COOLTRAINER_F,
	...
	[16] = {.facilityClass = FACILITY_CLASS_POKEFAN_M,
	...
	[17] = {.facilityClass = FACILITY_CLASS_POKEFAN_F,
		.trainerName   = _( "JANAE" ),
		.speechBefore  = {EC_WORD_I,
                        EC_WORD_JUST,
                        EC_WORD_ADORE,
	...
	[18] = {.facilityClass = FACILITY_CLASS_EXPERT_M,
	...
	[19] = {.facilityClass = FACILITY_CLASS_EXPERT_F,
	...
	[21] = {.facilityClass = FACILITY_CLASS_FISHERMAN,
	...
	[23] = {.facilityClass = FACILITY_CLASS_NINJA_BOY,
		.trainerName   = _( "DWANE" ),
	...
	[24] = {.facilityClass = FACILITY_CLASS_PARASOL_LADY,
	...
	[25] = {.facilityClass = FACILITY_CLASS_SWIMMER_F,
	...
	[26] = {.facilityClass = FACILITY_CLASS_PICNICKER,
	...
	[27] = {.facilityClass = FACILITY_CLASS_SAILOR,
	...
	[28] = {.facilityClass = FACILITY_CLASS_COLLECTOR,
	...
	[29] = {.facilityClass = FACILITY_CLASS_LASS,
		.trainerName   = _( "TAMIA" ),
		.speechBefore  = {EC_WORD_I_AM,
                        EC_WORD_ANGRY,
                        EC_WORD_WITH,
...
const struct FacilityMon gSlateportBattleTentMons[] = {
	...
	[10] = {.species     = SPECIES_LOMBRE,
		...
		.nature      = NATURE_MODEST},
	[11] = {.species     = SPECIES_LOTAD,
		.moves       = {MOVE_SYNTHESIS,
                        MOVE_NATURE_POWER,
                        MOVE_RAIN_DANCE,
                        MOVE_MEGA_DRAIN},
	...
	[16] = {.species     = SPECIES_GRAVELER,
		.moves       = {MOVE_MUD_SPORT,
                        MOVE_BLOCK,
                        MOVE_ROCK_TOMB,
                        MOVE_MAGNITUDE},
		.itemTableId = BATTLE_FRONTIER_ITEM_NONE,
	...
	[20] = {.species     = SPECIES_LINOONE,
		...
		.evSpread    = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK |
			F_EV_SPREAD_HP,
		.nature = NATURE_JOLLY},
	[21] = {.species     = SPECIES_GOLDEEN,
		.moves       = {MOVE_WATER_SPORT,
                        MOVE_HORN_ATTACK,
                        MOVE_WATERFALL,
                        MOVE_SUPERSONIC},
	...
	[32] = {.species     = SPECIES_SPINDA,
		...
		.evSpread    = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE |
			F_EV_SPREAD_ATTACK,
		.nature = NATURE_ADAMANT},
	[33] = {.species     = SPECIES_MAGNEMITE,
		.moves       = {MOVE_METAL_SOUND,
                        MOVE_SUPERSONIC,
                        MOVE_THUNDER_WAVE,
                        MOVE_SPARK},
	...
	[46] = {.species     = SPECIES_SHROOMISH,
		...
		.nature      = NATURE_BRAVE},
	[47] = {.species     = SPECIES_LOMBRE,
		.moves       = {MOVE_NATURE_POWER,
                        MOVE_ASTONISH,
                        MOVE_GROWL,
                        MOVE_ABSORB},
		.itemTableId = BATTLE_FRONTIER_ITEM_NONE,
	...
	[52] = {.species     = SPECIES_MARILL,
		...
		.evSpread    = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
		.nature      = NATURE_MODEST},
	[53] = {.species = SPECIES_SKITTY,
		.moves   = {MOVE_ASSIST, MOVE_ATTRACT, MOVE_SING, MOVE_CHARM},
		.itemTableId = BATTLE_FRONTIER_ITEM_PETAYA_BERRY,
		.evSpread    = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK |
			F_EV_SPREAD_HP,
		.nature = NATURE_CAREFUL},
	[54] = {.species = SPECIES_SEVIPER,
		.moves =
			{MOVE_SWAGGER, MOVE_WRAP, MOVE_POISON_TAIL, MOVE_HAZE},
		.itemTableId = BATTLE_FRONTIER_ITEM_NONE,
		.evSpread    = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SP_ATTACK |
			F_EV_SPREAD_DEFENSE,
		.nature = NATURE_BRAVE},
	[55] = {.species     = SPECIES_GOLBAT,
		.moves       = {MOVE_BITE,
                        MOVE_TORMENT,
                        MOVE_SCREECH,
                        MOVE_POISON_FANG},
	...
	[57] = {.species     = SPECIES_SANDSHREW,
		...
		.evSpread    = 0,
		.nature      = NATURE_HARDY},
	[58] = {.species = SPECIES_SWALOT,
		.moves   = {MOVE_YAWN, MOVE_SLUDGE, MOVE_ENCORE, MOVE_POUND},
		.itemTableId = BATTLE_FRONTIER_ITEM_NONE,
		.evSpread    = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE |
			F_EV_SPREAD_ATTACK,
		.nature = NATURE_IMPISH},
	[59] = {.species     = SPECIES_VOLBEAT,
		.moves       = {MOVE_TACKLE,
                        MOVE_CONFUSE_RAY,
                        MOVE_QUICK_ATTACK,
                        MOVE_DOUBLE_TEAM},
		...
		.evSpread    = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK,
		.nature      = NATURE_HARDY},
	[60] = {.species = SPECIES_ILLUMISE,
		.moves =
			{MOVE_CHARM, MOVE_TACKLE, MOVE_ENCORE, MOVE_MOONLIGHT},
		.itemTableId = BATTLE_FRONTIER_ITEM_CHERI_BERRY,
		.evSpread    = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK |
			F_EV_SPREAD_HP,
		.nature = NATURE_ADAMANT},
	[61] = {.species     = SPECIES_KADABRA,
		.moves       = {MOVE_DISABLE,
                        MOVE_CONFUSION,
                        MOVE_REFLECT,
                        MOVE_RECOVER},
		...
		.evSpread    = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
		.nature      = NATURE_QUIRKY},
	[62] = {.species     = SPECIES_KIRLIA,
		.moves       = {MOVE_CALM_MIND,
                        MOVE_CONFUSION,
                        MOVE_DOUBLE_TEAM,
                        MOVE_GROWL},
...
const u16 gVerdanturfBattleTentTrainerMons_Brenna[] = {4, 11, 13, 18, 26, -1};

const u16 gVerdanturfBattleTentTrainerMons_Dilan[] = {30, 37, 13, 29, 42, -1};

const u16 gVerdanturfBattleTentTrainerMons_Eliana[] = {6, 7, 17, 18, 40, -1};

const u16 gVerdanturfBattleTentTrainerMons_Markus[] = {6, 7, 18, 24, 38, -1};

const u16 gVerdanturfBattleTentTrainerMons_Caitlyn[] = {
	0, 12, 25, 28, 22, 44, -1};

const u16 gVerdanturfBattleTentTrainerMons_Desiree[] = {8, 12, 21, 22, 31, -1};

const u16 gVerdanturfBattleTentTrainerMons_Ronald[] = {1, 20, 23, 25, 32, -1};

const u16 gVerdanturfBattleTentTrainerMons_Ashten[] = {9, 12, 27, 37, 43, -1};

const u16 gVerdanturfBattleTentTrainerMons_Gerard[] = {36, 7, 34, 6, 40, -1};

const u16 gVerdanturfBattleTentTrainerMons_Bradly[] = {26, 3, 0, 2, 17, -1};

const u16 gVerdanturfBattleTentTrainerMons_Dennis[] = {14, 37, 2, 38, 27, -1};

const u16 gVerdanturfBattleTentTrainerMons_Prestin[] = {
	31, 28, 22, 25, 44, 43, 41, -1};
...
const u16 gVerdanturfBattleTentTrainerMons_Ashlyn[] = {
	29, 36, 32, 30, 17, 6, 44, -1};

const u16 gVerdanturfBattleTentTrainerMons_Addison[] = {0, 1, 16, 31, 6, -1};

const u16 gVerdanturfBattleTentTrainerMons_Justine[] = {0, 1, 16, 36, 18, -1};

const u16 gVerdanturfBattleTentTrainerMons_Tyson[] = {
	5, 15, 22, 30, 16, 39, 43, -1};

const u16 gVerdanturfBattleTentTrainerMons_Laila[] = {
	5, 15, 19, 24, 41, 43, -1};

const u16 gVerdanturfBattleTentTrainerMons_Waren[] = {0, 9, 10, 11, 23, -1};

const u16 gVerdanturfBattleTentTrainerMons_Tobias[] = {6, 7, 24, 38, 40, -1};

const u16 gVerdanturfBattleTentTrainerMons_Josiah[] = {8, 16, 23, 34, 3, -1};
...
const u16 gVerdanturfBattleTentTrainerMons_Lillian[] = {24, 34, 36, 38, 5, -1};

const u16 gVerdanturfBattleTentTrainerMons_Lesley[] = {26, 0, 18, 13, 25, -1};

const u16 gVerdanturfBattleTentTrainerMons_Marquis[] = {
	24, 34, 5, 15, 7, 42, -1};

const u16 gVerdanturfBattleTentTrainerMons_Freddy[] = {18, 21, 26, 29, 41, -1};
...
const struct BattleFrontierTrainer gVerdanturfBattleTentTrainers[] = {
	...
	[17] = {.facilityClass = FACILITY_CLASS_POKEFAN_F,
		...
		.speechWin     = {EC_WORD_YOU_RE,
                        ...
                        EC_WORD_EXCL},
		.speechLose =
			{EC_WORD_WOWEE, EC_WORD_EXCL_EXCL, -1, -1, -1, -1},
...
const struct FacilityMon gVerdanturfBattleTentMons[] = {
	...
	[34] = {.species     = SPECIES_PELIPPER,
		...
		.evSpread    = 0,
		.nature      = NATURE_BRAVE},
	[35] = {.species = SPECIES_LOUDRED,
		.moves   = {MOVE_HOWL, MOVE_UPROAR, MOVE_REST, MOVE_SCREECH},
		.itemTableId = BATTLE_FRONTIER_ITEM_LEFTOVERS,
		.evSpread    = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE |
			F_EV_SPREAD_HP,
		.nature = NATURE_CALM},
	[36] = {.species     = SPECIES_MARILL,
		.moves       = {MOVE_ROLLOUT,
                        MOVE_DEFENSE_CURL,
                        MOVE_TAIL_WHIP,
                        MOVE_BUBBLE_BEAM},
	...
	[41] = {.species     = SPECIES_ILLUMISE,
		...
		.evSpread    = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE |
			F_EV_SPREAD_HP,
		.nature = NATURE_QUIRKY},
	[42] = {.species = SPECIES_MACHOKE,
		.moves =
			{MOVE_LEER, MOVE_KARATE_CHOP, MOVE_BULK_UP, MOVE_REST},
		.itemTableId = BATTLE_FRONTIER_ITEM_CHESTO_BERRY,
		.evSpread    = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
		.nature      = NATURE_CALM},
	[43] = {.species     = SPECIES_WHISMUR,
...
const u16 gFallarborBattleTentTrainerMons_Natalie[] = {5, 29, 30, 32, 34, -1};

const u16 gFallarborBattleTentTrainerMons_Treve[] = {28, 29, 30, 32, 33, -1};

const u16 gFallarborBattleTentTrainerMons_Arianna[] = {18, 23, 24, 27, 44, -1};

const u16 gFallarborBattleTentTrainerMons_Jadyn[] = {
	0, 22, 24, 27, 32, 39, -1};

const u16 gFallarborBattleTentTrainerMons_Gerardo[] = {6, 18, 23, 24, 29, -1};

const u16 gFallarborBattleTentTrainerMons_Jonn[] = {16, 17, 21, 22, 37, -1};

const u16 gFallarborBattleTentTrainerMons_Esteban[] = {5, 28, 30, 33, 42, -1};

const u16 gFallarborBattleTentTrainerMons_Jameson[] = {1, 2, 3, 5, 9, -1};

const u16 gFallarborBattleTentTrainerMons_Alanzo[] = {
	9, 10, 11, 12, 13, 14, 15, -1};

const u16 gFallarborBattleTentTrainerMons_Howard[] = {18, 23, 31, 38, 43, -1};

const u16 gFallarborBattleTentTrainerMons_Conrad[] = {18, 19, 20, 21, 22, -1};

const u16 gFallarborBattleTentTrainerMons_Makenna[] = {4, 21, 25, 36, 40, -1};

const u16 gFallarborBattleTentTrainerMons_Brayan[] = {
	0, 4, 6, 12, 19, 23, 28, -1};

const u16 gFallarborBattleTentTrainerMons_Mariana[] = {
	0, 4, 13, 19, 28, 30, 37, -1};

const u16 gFallarborBattleTentTrainerMons_Sheldon[] = {2, 3, 21, 31, 39, -1};

const u16 gFallarborBattleTentTrainerMons_Gianna[] = {1, 2, 30, 32, 41, -1};

const u16 gFallarborBattleTentTrainerMons_Yahir[] = {4, 8, 15, 17, 22, 24, -1};

const u16 gFallarborBattleTentTrainerMons_Britney[] = {
	4, 7, 14, 20, 23, 43, -1};

const u16 gFallarborBattleTentTrainerMons_Hecter[] = {0, 1, 2, 5, 9, 35, -1};

const u16 gFallarborBattleTentTrainerMons_Tannor[] = {5, 30, 31, 33, 34, -1};

const u16 gFallarborBattleTentTrainerMons_Benji[] = {25, 26, 27, 28, 29, -1};

const u16 gFallarborBattleTentTrainerMons_Rory[] = {9, 11, 14, 15, 27, 39, -1};

const u16 gFallarborBattleTentTrainerMons_Eleanor[] = {
	23, 28, 31, 36, 38, 42, 44, -1};

const u16 gFallarborBattleTentTrainerMons_Evelyn[] = {29, 31, 32, 33, 34, -1};

const u16 gFallarborBattleTentTrainerMons_Arielle[] = {1, 3, 38, 39, 41, -1};

const u16 gFallarborBattleTentTrainerMons_Connar[] = {
	7, 8, 28, 29, 31, 32, -1};

const u16 gFallarborBattleTentTrainerMons_Maurice[] = {4, 5, 6, 12, 13, -1};
...
const struct FacilityMon gFallarborBattleTentMons[] = {
	...
	[4]  = {.species      = SPECIES_KECLEON,
                ...
                .evSpread    = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED |
                        F_EV_SPREAD_ATTACK,
                .nature = NATURE_MODEST},
	[5]  = {.species = SPECIES_MAGIKARP,
                .moves  = {MOVE_SPLASH, MOVE_TACKLE, MOVE_FLAIL, MOVE_NONE},
                .itemTableId = BATTLE_FRONTIER_ITEM_DRAGON_SCALE,
                .evSpread    = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
                .nature      = NATURE_QUIRKY},
	[6]  = {.species      = SPECIES_SOLROCK,
                .moves       = {MOVE_ROCK_THROW,
                        MOVE_FLASH,
                        MOVE_SANDSTORM,
                        MOVE_PSYWAVE},
	...
	[10] = {.species     = SPECIES_BEAUTIFLY,
		...
		.evSpread    = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SPEED |
			F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
		.nature = NATURE_QUIRKY},
	[11] = {.species     = SPECIES_DUSTOX,
		.moves       = {MOVE_MOONLIGHT,
                        MOVE_HARDEN,
                        MOVE_POISON_STING,
                        MOVE_PSYBEAM},
		.itemTableId = BATTLE_FRONTIER_ITEM_FOCUS_BAND,
	...
	[21] = {.species     = SPECIES_WHISMUR,
		...
		.evSpread    = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK |
			F_EV_SPREAD_HP,
		.nature = NATURE_ADAMANT},
	[22] = {.species = SPECIES_LOUDRED,
		.moves   = {MOVE_STOMP, MOVE_REST, MOVE_SCREECH, MOVE_UPROAR},
		.itemTableId = BATTLE_FRONTIER_ITEM_CHESTO_BERRY,
		.evSpread    = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
		.nature      = NATURE_ADAMANT},
	[23] = {.species     = SPECIES_LINOONE,
		.moves       = {MOVE_FURY_SWIPES,
                        MOVE_SAND_ATTACK,
                        MOVE_SHOCK_WAVE,
                        MOVE_GROWL},
