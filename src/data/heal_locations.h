static const struct HealLocation sHealLocations[] = {
	{MAP_GROUP( LITTLEROOT_TOWN_BRENDANS_HOUSE_2F ),
		MAP_NUM( LITTLEROOT_TOWN_BRENDANS_HOUSE_2F ),
		4,
		2},
	{MAP_GROUP( LITTLEROOT_TOWN_MAYS_HOUSE_2F ),
	...
	{MAP_GROUP( SOUTHERN_ISLAND_EXTERIOR ),
		MAP_NUM( SOUTHERN_ISLAND_EXTERIOR ),
		15,
		20},
	{MAP_GROUP( BATTLE_FRONTIER_OUTSIDE_EAST ),
