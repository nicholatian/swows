...
static bool32 sub_81D4E60( void )
{
	...
	*(u64*)sp4 = *(u64*)gLink.tempRecvBuffer;
	REG_IME    = backupIME;
	if( sp4[0] == 0xB9A0 && sp4[1] == 0xCCD0 && sp4[2] == 0xFFFF &&
		sp4[3] == 0xFFFF )
	{
		return TRUE;
	}
...
static void sub_81D505C( u16* arg0 ) { *arg0 = 0; }
...
static void sub_81D5084( u8 taskId )
{
	...
	case 14:
		...
		break;
	case 15:
		data->unkE = EReader_IsReceivedDataValid(
	...
	case 16:
		...
		break;
	case 17:
		if( TryWriteTrainerHill( (struct
			    EReaderTrainerHillSet*)&gDecompressionBuffer ) )
		{
	...
	case 21:
		if( MG_PrintTextOnWindow1AndWaitButton(
			    &data->unk9, gUnknown_085EE0BF ) )
			data->unk8 = 0;
		break;
	case 22:
		if( MG_PrintTextOnWindow1AndWaitButton(
			    &data->unk9, gUnknown_085EE12D ) )
			data->unk8 = 0;
		break;
	case 26:
		Free( data->unk10 );
