...
static const u8 LandmarkName_TunnelersRestHouse[] =
	_( "TUNNELER'S RESTHOUSE" );
...
static const u8 LandmarkName_SafariZoneEntrance[] =
	_( "SAFARI ZONE ENTRANCE" );
...
static const u8 LandmarkName_FossilManiacsHouse[] =
	_( "FOSSIL MANIAC'S HOUSE" );
...
static const struct Landmark Landmark_FlowerShop = {
	LandmarkName_FlowerShop, FLAG_LANDMARK_FLOWER_SHOP};
...
static const struct Landmark Landmark_CyclingRoad = {
	LandmarkName_CyclingRoad, -1};
...
static const struct Landmark Landmark_TrickHouse = {
	LandmarkName_TrickHouse, FLAG_LANDMARK_TRICK_HOUSE};
...
static const struct Landmark Landmark_MeteorFalls = {
	LandmarkName_MeteorFalls, -1};
...
static const struct Landmark Landmark_GraniteCave = {
	LandmarkName_GraniteCave, -1};
static const struct Landmark Landmark_OceanCurrent = {
	LandmarkName_OceanCurrent, -1};
static const struct Landmark Landmark_LanettesHouse = {
	LandmarkName_LanettesHouse, FLAG_LANDMARK_LANETTES_HOUSE};
static const struct Landmark Landmark_FieryPath = {
	LandmarkName_FieryPath, FLAG_LANDMARK_FIERY_PATH};
static const struct Landmark Landmark_JaggedPass = {
	LandmarkName_JaggedPass, -1};
static const struct Landmark Landmark_BerryMastersHouse = {
	LandmarkName_BerryMastersHouse, FLAG_LANDMARK_BERRY_MASTERS_HOUSE};
static const struct Landmark Landmark_IslandCave = {
	LandmarkName_IslandCave, FLAG_LANDMARK_ISLAND_CAVE};
...
const u8* GetLandmarkName( u8 mapSection, u8 id, u8 count )
{
	...
	while( 1 )
	{
		...
		if( landmark->flag == 0xFFFF ||
			FlagGet( landmark->flag ) == TRUE )
		{
			if( count == 0 )
				break;
			else
