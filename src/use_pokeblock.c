...
// code
void ChooseMonToGivePokeblock(
	struct Pokeblock* pokeblock, void ( *callback )( void ) )
{
...
void sub_8166380( void )
{
	...
	case 10:
		...
		break;
	case 11:
		sub_81D2754( gUnknown_0203BCAC->field_7C58.unk0[0],
			gUnknown_0203BCAC->field_7C58.unk14[0] );
	...
	case 12:
		...
		{
			sub_81D1F84( &gUnknown_0203BCAC->field_7C58,
				gUnknown_0203BCAC->field_7C58.unk14[0],
				gUnknown_0203BCAC->field_7C58.unk14[0] );
			gUnknown_0203BC90->field_50++;
		}
...
void sub_8166564( void )
{
	...
	case 1:
		if( !gPaletteFade.active )
		{
			...
			if( gUnknown_0203BCAC->info.field_71 !=
				gUnknown_0203BCAC->info.field_70 - 1 )
			{
				u8 var0 =
					gUnknown_0203BCAC->unk7FB0
						[gUnknown_0203BCAC
								->field_7FB3];
				sub_81D3480( gUnknown_0203BCAC->field_7B1C,
					gUnknown_0203BCAC->field_7B10,
					var0 );
			}
...
void sub_816681C( void )
{
	...
	case 0:
		gPokeblockMonId =
			sub_81672A4( gUnknown_0203BCAC->info.field_71 );
...
void sub_8166A34( void )
{
	...
	case 0:
		...
		gUnknown_0203BC90->mon +=
			gUnknown_0203BCAC
				->field_7FB8[gUnknown_0203BCAC->info.field_71]
				.unk1;
		sub_81D3520( gUnknown_0203BCAC->field_7B1C );
		gUnknown_0203BC90->field_50++;
		break;
	...
	case 2:
		sub_8167104( );
		sub_81D2754( gUnknown_0203BC90->field_5c,
			gUnknown_0203BCAC->field_7C58.unk14[3] );
		sub_81D1F84( &gUnknown_0203BCAC->field_7C58,
			gUnknown_0203BCAC->field_7C58
				.unk14[gUnknown_0203BCAC->field_7FB3],
			gUnknown_0203BCAC->field_7C58.unk14[3] );
		sub_8167338( );
		gUnknown_0203BC90->field_50++;
		break;
	case 3:
		...
		if( !var )
		{
			sub_81681F4( sub_81672A4(
				gUnknown_0203BCAC->info.field_71 ) );
			if( gUnknown_0203BCAC->info.field_71 !=
				gUnknown_0203BCAC->info.field_70 - 1 )
			{
				u8 var0 =
...
void sub_8166BEC( void )
{
	...
	case 3:
		...
		for( i = 0; i < 7; i++ )
			DestroySprite(
				&gSprites[gUnknown_0203BCAC->field_7B06[i]] );
		...
		if( gUnknown_0203BCAC->field_7B10 != 0xFF )
			DestroySprite(
				&gSprites[gUnknown_0203BCAC->field_7B10] );
...
void sub_8166D44( void )
{
	...
	GetMonData(
		&gPlayerParty[sub_81672A4( gUnknown_0203BCAC->info.field_71 )],
		MON_DATA_NICKNAME,
		stringBuffer );
...
void sub_8166E24( void )
{
	...
	for( gUnknown_0203BC90->field_53 = 0; gUnknown_0203BC90->field_53 < 5;
		gUnknown_0203BC90->field_53++ )
	{
		if( gUnknown_0203BC90->field_61[gUnknown_0203BC90->field_53] !=
			0 )
			break;
	}

	if( gUnknown_0203BC90->field_53 < 5 )
		Pokeblock_BufferEnhancedStatText( gStringVar4,
			gUnknown_0203BC90->field_53,
			gUnknown_0203BC90
				->field_61[gUnknown_0203BC90->field_53] );
	else
		Pokeblock_BufferEnhancedStatText(
			gStringVar4, gUnknown_0203BC90->field_53, 0 );
...
bool8 sub_8166EDC( void )
{
	...
	while( 1 )
	{
		...
		if( gUnknown_0203BC90->field_53 < 5 )
		{
			if( gUnknown_0203BC90->field_61[gUnknown_0203BC90
								->field_53] !=
				0 )
				break;
		}
	...
	Pokeblock_BufferEnhancedStatText( gStringVar4,
		gUnknown_0203BC90->field_53,
		gUnknown_0203BC90->field_61[gUnknown_0203BC90->field_53] );
	Pokeblock_MenuWindowTextPrint( gStringVar4 );
...
void sub_8166F50( void )
{
	...
	AddTextPrinterParameterized(
		2, 1, gText_WontEatAnymore, 0, 1, 0, NULL );
	PutWindowTilemap( 2 );
	CopyWindowToVram( 2, 3 );
}
...
void sub_8167054( struct Pokeblock* pokeblock, struct Pokemon* mon )
{
	...
	if( GetMonData( mon, MON_DATA_SHEEN ) != 255 )
	{
		...
		cstat = ( u8 )( GetMonData( mon, MON_DATA_SHEEN ) ) +
			pokeblock->feel;
		if( cstat > 255 )
			cstat = 255;
...
void sub_8167104( void )
{
	...
	mon += gUnknown_0203BCAC
		       ->unk7FB0[gUnknown_0203BCAC->info.field_71 * 4 + 9];
	...
	for( i = 0; i < 5; i++ )
		gUnknown_0203BC90->field_61[i] =
			gUnknown_0203BC90->field_5c[i] -
			gUnknown_0203BC90->field_57[i];
}
...
u8 sub_8167324( u8 a0 ) { return sub_81672A4( a0 ); }
...
void sub_8167338( void )
{
	...
	for( i = 0; i < 5; i++ )
	{
		...
		{
			spriteId = CreateSprite( &gSpriteTemplate_085DFD5C,
				gUnknown_085DFD28[i][0],
				gUnknown_085DFD28[i][1],
				0 );
...
void sub_816753C( s16 id1, u8 id2 )
{
	...
	sub_81D2ED4( gUnknown_0203BCAC->field_7B4D[id2],
		gUnknown_0203BCAC->field_7B95[id2],
		boxId,
		monId,
		id1,
		r6,
		r8 );
	sub_81D2F78( &gUnknown_0203BCAC->field_7C58,
		gUnknown_0203BCAC->unk7FB0,
		boxId,
		monId,
		id1,
		...
		r6,
		r8 );
	sub_81D3094( gUnknown_0203BCAC->field_304[id2],
		gUnknown_0203BCAC->field_4[id2],
		boxId,
		monId,
		id1,
		r6,
...
void sub_8167608( u8 arg0 )
{
	...
	if( gUnknown_0203BCAC->field_7B10 == 0xFF )
	{
		...
		gUnknown_0203BCAC->field_7B12 =
			LoadSpritePalette( &spritePal );
		gUnknown_0203BCAC->field_7B14 =
		...
		{
			gUnknown_0203BCAC->field_7B10 = spriteId;
			gSprites[gUnknown_0203BCAC->field_7B10].callback =
				sub_8168168;
			gSprites[gUnknown_0203BCAC->field_7B10].pos2.y -= 34;
			gUnknown_0203BCAC->field_7B18 = (void*)( OBJ_VRAM0 +
				( gUnknown_0203BCAC->field_7B14 * 32 ) );
			gUnknown_0203BCAC->field_7B12 =
				( gUnknown_0203BCAC->field_7B12 * 16 ) + 0x100;
		}
	}
	else
	{
		do
		{
		} while( 0 ); // Surprised to see something like this? It's a
			      // very neat trick for generating the same
			      // assembly. It has no practical purpose, feel
			      // free to remove it.
		DmaCopy16Defvars( 3,
			gUnknown_0203BCAC->field_304[arg0],
			gUnknown_0203BCAC->field_7B18,
			0x800 );
		LoadPalette( gUnknown_0203BCAC->field_4[arg0],
			gUnknown_0203BCAC->field_7B12,
			32 );
	}
}
...
bool8 sub_8167930( void )
{
	...
	case 7:
		LZ77UnCompVram(
			gUsePokeblockGraph_Tilemap, gUnknown_0203BCA0 );
	...
	case 9:
		...
		CopyToBgTilemapBufferRect(
			1, gUsePokeblockNatureWin_Pal, 0, 13, 12, 4 );
		CopyBgTilemapBufferToVram( 1 );
		break;
	case 10:
		LZ77UnCompVram(
			gUnknown_085DFC0C, gUnknown_0203BCAC->tilemapBuffer );
		break;
	case 11:
...
void sub_8167BA0( u16 arg0, u8 copyToVramMode )
{
		...
		gUnknown_0203BCAC->info.field_70 - 1 )
	{
		AddTextPrinterParameterized( 0,
			1,
			gUnknown_0203BCAC->field_7B95[arg0],
			0,
			1,
			0,
			NULL );
		...
		str        = StringCopy(
                        gUnknown_0203BCAC->info.field_7A, gText_NatureSlash );
		...
		AddTextPrinterParameterized3( 1,
			...
			gUnknown_085DFCC9,
			0,
			gUnknown_0203BCAC->info.field_7A );
	}
...
static void sub_8167CA0( bool8 arg0 )
{
	...
	r8 = ( gUnknown_0203BCAC->info.field_71 ^
		     ( gUnknown_0203BCAC->info.field_70 - 1 ) )
		? 1
		: 0;
	if( arg0 )
	...
	r4 = ( gUnknown_0203BCAC->info.field_71 ^
		     ( gUnknown_0203BCAC->info.field_70 - 1 ) )
		? 1
		: 0;
	sub_81D3520( gUnknown_0203BCAC->field_7B1C );
...
static u8 sub_8167EA4( void )
{
	...
	case 1:
		...
		break;
	case 2:
		if( !sub_81D3178( &gUnknown_0203BCAC->field_7C58,
			    &gUnknown_0203BCAC->field_7B0E ) )
		{
			sub_816753C( gUnknown_0203BCAC->field_7B4C,
				gUnknown_0203BCAC->field_7FB6 );
			gUnknown_0203BCAC->info.unk78++;
		}
		break;
	case 3:
		...
		if( gUnknown_0203BCAC->info.field_71 !=
			gUnknown_0203BCAC->info.field_70 - 1 )
		{
			u8 var0 = gUnknown_0203BCAC->unk7FB0
					  [gUnknown_0203BCAC->field_7FB3];
			sub_81D3480( gUnknown_0203BCAC->field_7B1C,
				gUnknown_0203BCAC->field_7B10,
				var0 );
		}
...
static u8 sub_8167FA4( void )
{
	...
	{
	case 0:
		if( !sub_81D31A4( &gUnknown_0203BCAC->field_7C58,
			    &gUnknown_0203BCAC->field_7B0E ) )
			gUnknown_0203BCAC->info.unk78++;
		break;
	case 1:
...
void sub_81681F4( u8 monIndex )
{
	...
	gUnknown_0203BCAC->unk7FB0[gUnknown_0203BCAC->field_7FB3] =
		( sheen != 255 ) ? sheen / 29 : 9;
}
...
static void sub_8168294( void )
{
	...
	for( i = 0, xDiff = 64, xStart = -96; i < 2; i++ )
	{
		u8 spriteId = CreateSprite(
			template, i * xDiff + xStart, yStart, 0 );
		if( spriteId != MAX_SPRITES )
		{
