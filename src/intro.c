...
//.rodata
static const u16 gIntro1DropsPal[] =
	INCBIN_U16( "graphics/intro/intro1_drops.gbapal" );
static const u16 gIntro1GFLogoPal[] =
	INCBIN_U16( "graphics/intro/intro1_gflogo.gbapal" );
static const u32 gIntroTiles[] = INCBIN_U32( "graphics/intro/intro.4bpp.lz" );
static const u16 gIntro1BGPals[16][16] =
	INCBIN_U16( "graphics/intro/intro1_bgpal.gbapal" );
static const u32 gIntro1BG0_Tilemap[] =
	INCBIN_U32( "graphics/intro/intro1_bg0_map.bin.lz" );
static const u32 gIntro1BG1_Tilemap[] =
	INCBIN_U32( "graphics/intro/intro1_bg1_map.bin.lz" );
static const u32 gIntro1BG2_Tilemap[] =
	INCBIN_U32( "graphics/intro/intro1_bg2_map.bin.lz" );
static const u32 gIntro1BG3_Tilemap[] =
	INCBIN_U32( "graphics/intro/intro1_bg3_map.bin.lz" );
static const u32 gIntro1BGLeavesGfx[] =
	INCBIN_U32( "graphics/intro/introgfx.4bpp.lz" );
static const u16 gIntro3PokeballPal[] =
	INCBIN_U16( "graphics/intro/intro3_pokeball.gbapal" );
static const u32 gIntro3Pokeball_Tilemap[] =
	INCBIN_U32( "graphics/intro/intro3_pokeball_map.bin.lz" );
static const u32 gIntro3Pokeball_Gfx[] =
	INCBIN_U32( "graphics/intro/intro3_pokeball.8bpp.lz" );
static const u16 gIntro3Streaks_Pal_Unused[] =
	INCBIN_U16( "graphics/intro/intro3_streaks.gbapal" );
static const u32 gIntro3Streaks_Gfx_Unused[] =
	INCBIN_U32( "graphics/intro/intro3_streaks.4bpp.lz" );
static const u32 gIntro3Streaks_Tilemap_Unused[] =
	INCBIN_U32( "graphics/intro/intro3_streaks_map.bin.lz" );
static const u16 gIntro3Misc1Palette[] =
	INCBIN_U16( "graphics/intro/intro3_misc1.gbapal" );
static const u16 gIntro3Misc2Palette_Unused[] =
	INCBIN_U16( "graphics/intro/intro3_misc2.gbapal" );
static const u32 gIntro3MiscTiles[] =
	INCBIN_U32( "graphics/intro/intro3_misc.4bpp.lz" );
static const u16 gIntro1FlygonPalette[] =
	INCBIN_U16( "graphics/intro/intro1_flygon.gbapal" );
static const u32 gIntro1EonTiles_Unused[] =
	INCBIN_U32( "graphics/intro/intro1_eon.4bpp.lz" );
...
static void LoadCopyrightGraphics(
	u16 tilesetAddress, u16 tilemapAddress, u16 paletteAddress )
{
	LZ77UnCompVram(
		gIntroCopyright_Gfx, (void*)( VRAM + tilesetAddress ) );
	LZ77UnCompVram(
		gIntroCopyright_Tilemap, (void*)( VRAM + tilemapAddress ) );
...
static u8 SetUpCopyrightScreen( void )
{
	...
	case 0:
		...
		*(u16*)PLTT = 0x7FFF;
		...
		ResetPaletteFade( );
		LoadCopyrightGraphics( 0, 0x4000, 0 );
		ScanlineEffect_Stop( );
		ResetTasks( );
		ResetSpriteData( );
		FreeAllSpritePalettes( );
		BeginNormalPaletteFade(
			0xFFFFFFFF, 0, 0x10, 0, RGB_WHITEALPHA );
		SetGpuReg( REG_OFFSET_BG0CNT,
			BGCNT_PRIORITY( 0 ) | BGCNT_CHARBASE( 0 ) |
				BGCNT_SCREENBASE( 8 ) | BGCNT_16COLOR |
				BGCNT_TXT256x256 );
	...
	case 141:
		...
		if( gMultibootProgramStruct.gcmb_field_2 != 0 )
		{
			...
			{
				// check the multiboot ROM header game code to
				// see if we already did this
				if( *(u32*)( EWRAM_START + 0xAC ) ==
					0x65366347 ) // "Gc6e" in
						     // ASCII
				{
					CpuCopy16(
...
static void Task_IntroLoadPart1Graphics( u8 taskId )
{
	...
	SetGpuReg( REG_OFFSET_BG1CNT,
		BGCNT_PRIORITY( 1 ) | BGCNT_CHARBASE( 0 ) |
	...
	CpuCopy16(
		gPlttBufferUnfaded + 0x100, gPlttBufferUnfaded + 0x1F0, 0x20 );
	CpuCopy16(
		gPlttBufferUnfaded + 0x100, gPlttBufferUnfaded + 0x1E1, 0x1E );
	CpuCopy16(
		gPlttBufferUnfaded + 0x100, gPlttBufferUnfaded + 0x1D2, 0x1C );
	CpuCopy16(
		gPlttBufferUnfaded + 0x100, gPlttBufferUnfaded + 0x1C3, 0x1A );
	CpuCopy16(
		gPlttBufferUnfaded + 0x100, gPlttBufferUnfaded + 0x1B4, 0x18 );
	CpuCopy16(
		gPlttBufferUnfaded + 0x100, gPlttBufferUnfaded + 0x1A5, 0x16 );
	CpuCopy16(
		gPlttBufferUnfaded + 0x100, gPlttBufferUnfaded + 0x196, 0x14 );
...
static void Task_IntroFadeIn( u8 taskId )
{
	...
	SetGpuReg( REG_OFFSET_DISPCNT,
		DISPCNT_MODE_0 | DISPCNT_OBJ_1D_MAP | DISPCNT_BG_ALL_ON |
			DISPCNT_OBJ_ON );
...
static void Task_IntroScrollDownAndShowFlygon( u8 taskId )
{
	...
	else
	{
		...
		{
			BeginNormalPaletteFade(
				0xFFFFFFFF, 0, 0, 16, RGB_WHITEALPHA );
...
static void Task_IntroStartBikeRide( u8 taskId )
{
	...
	for( spriteId = 0; spriteId < 3; spriteId++ )
	{
		LoadCompressedSpriteSheet(
			&gIntroPokemonRunningSpriteSheet[spriteId] );
	}
	...
	SetVBlankCallback( VBlankCB_Intro );
	gTasks[taskId].data[0] =
		CreateBicycleAnimationTask( 1, 0x4000, 0x400, 0x10 );
	sub_817B150( 1 );
...
static void Task_IntroLoadPart3Graphics( u8 taskId )
{
	...
	LZ77UnCompVram(
		gIntro3Pokeball_Tilemap, (void*)( BG_CHAR_ADDR( 1 ) ) );
...
static void Task_IntroSpinAndZoomPokeball( u8 taskId )
{
	...
	PanFadeAndZoomScreen( 0x78,
		0x50,
		0x10000 / gTasks[taskId].data[1],
		gTasks[taskId].data[0] );

	if( gIntroFrameCounter == 28 )
		BeginNormalPaletteFade(
			0xFFFFFFFF, 0, 0, 0x10, RGB_WHITEALPHA );
}
...
static void Task_IntroLoadGroudonScene( u8 taskId )
{
	if( !gPaletteFade.active )
	{
		...
		LZDecompressVram(
			gIntro3GroudonTilemap, (void*)( BG_CHAR_ADDR( 3 ) ) );
		LZDecompressVram(
			gIntro3LegendBgGfx, (void*)( BG_CHAR_ADDR( 1 ) ) );
		LZDecompressVram( gIntro3GroudonBgTilemap,
			(void*)( BG_SCREEN_ADDR( 28 ) ) );
		LoadCompressedSpriteSheetUsingHeap(
			&gBattleAnimPicTable[GET_TRUE_SPRITE_INDEX(
				ANIM_TAG_ROCKS )] );
		LoadCompressedSpritePaletteUsingHeap(
			&gBattleAnimPaletteTable[GET_TRUE_SPRITE_INDEX(
				ANIM_TAG_ROCKS )] );
		CpuCopy16( gIntro3BgPal,
			gPlttBufferUnfaded,
			sizeof( gIntro3BgPal ) );
...
static void Task_IntroLoadPart3Graphics1( u8 taskId )
{
	...
	SetGpuReg( REG_OFFSET_BG2CNT,
		BGCNT_PRIORITY( 0 ) | BGCNT_CHARBASE( 0 ) |
			BGCNT_SCREENBASE( 24 ) | BGCNT_256COLOR | BGCNT_WRAP |
			BGCNT_AFF512x512 );
	SetGpuReg( REG_OFFSET_BG1CNT,
		BGCNT_PRIORITY( 1 ) | BGCNT_CHARBASE( 1 ) |
...
static void CreateGroudonRockSprites( u8 a0 )
{
	...
	for( i = 0; i < 6; i++ )
	{
		spriteId                    = CreateSprite( gUnknown_08596C10,
                        gIntroGroudonRockData[i][0],
                        0xA0,
                        i );
		...
		StartSpriteAnim(
			&gSprites[spriteId], gIntroGroudonRockData[i][1] );
	}
}
...
static void Task_IntroLoadKyogreScene( u8 taskId )
{
	...
	LZDecompressVram(
		gIntro3KyogreBgTilemap, (void*)( BG_SCREEN_ADDR( 28 ) ) );
...
static void CreateKyogreBubbleSprites_0( u8 taskId )
{
	...
	for( i = 0; i < 6; i++ )
	{
		spriteId = CreateSprite( &gUnknown_085E4D14,
			gIntroKyogreBubbleData[i][0],
			gIntroKyogreBubbleData[i][1],
			i );
		gSprites[spriteId].invisible = TRUE;
...
static void Task_IntroLoadClouds1( u8 taskId )
{
	SetGpuReg( REG_OFFSET_BLDCNT,
		BLDCNT_TGT1_BG0 | BLDCNT_TGT1_BG1 | BLDCNT_TGT1_BG2 |
	...
	SetGpuReg( REG_OFFSET_BG0CNT,
		BGCNT_PRIORITY( 0 ) | BGCNT_CHARBASE( 0 ) |
			...
			BGCNT_TXT512x256 );
	SetGpuReg( REG_OFFSET_BG1CNT,
		BGCNT_PRIORITY( 0 ) | BGCNT_CHARBASE( 1 ) |
	...
	LZDecompressVram(
		gIntro3Clouds3Tilemap, (void*)( BG_SCREEN_ADDR( 28 ) ) );
...
{
	LZDecompressVram(
		gIntro3Clouds1Tilemap, (void*)( BG_CHAR_ADDR( 3 ) ) );
	LZDecompressVram(
		gIntro3Clouds2Tilemap, (void*)( BG_SCREEN_ADDR( 26 ) ) );
...
static void Task_IntroCloudScene( u8 taskId )
{
	...
	case 0:
		...
		{
			BeginNormalPaletteFade(
				0xFFFFFFFE, 0, 16, 0, RGB_WHITEALPHA );
			data[6] = 0x5000;
			data[0]++;
		}
		break;
...
{
	LZDecompressVram(
		gIntro3RayquazaTilemap, (void*)( BG_SCREEN_ADDR( 28 ) ) );
	LZDecompressVram(
		gIntro3Clouds4Tilemap, (void*)( BG_CHAR_ADDR( 3 ) ) );
...
static void Task_IntroRayquazaLightningScene( u8 taskId )
{
	...
	case 0:
		if( --data[6] == 0 )
		{
			...
			spriteId = CreateSprite(
				&gIntroLightningSprite, 200, 80, 1 );
			StartSpriteAnim( &gSprites[spriteId], 1 );
			spriteId = CreateSprite(
				&gIntroLightningSprite, 200, 112, 2 );
	...
	case 1:
		if( --data[6] == 0 )
		{
			...
			spriteId = CreateSprite(
				&gIntroLightningSprite, 40, 80, 1 );
			StartSpriteAnim( &gSprites[spriteId], 1 );
			spriteId = CreateSprite(
				&gIntroLightningSprite, 40, 112, 2 );
			StartSpriteAnim( &gSprites[spriteId], 2 );
			data[0]++;
			data[6] = 48;
		}
...
static void SpriteCB_IntroRayquazaLightning( struct Sprite* sprite )
{
	...
	case 0:
		...
		sprite->data[0]++;
	case 1:
		CpuCopy16( &gIntro3BgPal[sprite->data[1]],
			&gPlttBufferFaded[93],
			2 );
		sprite->data[1] += 2;
...
static void Task_IntroRayquazaGlowScene_1( u8 taskId )
{
	...
	case 0:
		if( ( data[2] & 1 ) != 0 )
		{
			CpuCopy16( &gIntro3BgPal[0x1A2 + data[1] * 2],
				&gPlttBufferFaded[94],
				2 );
			data[1]++;
		}
	...
	case 2:
		if( data[3] == 0 )
		{
			if( ( data[2] & 1 ) != 0 )
			{
				CpuCopy16( &gIntro3BgPal[0x182 + data[1] * 2],
					&gPlttBufferFaded[92],
					2 );
				data[1]++;
			}
	...
	default:
		SetGpuReg( REG_OFFSET_BLDCNT,
			BLDCNT_EFFECT_BLEND | BLDCNT_TGT2_BG0 |
				...
				BLDCNT_TGT2_BD );
		SetGpuReg(
			REG_OFFSET_BLDALPHA, gIntroWaterDropAlphaBlend[31] );
		SetGpuReg( REG_OFFSET_BLDY, 0 );
	...
	case 1:
		if( gTasks[taskId].data[1] != 0 )
		{
			...
			SetGpuReg( REG_OFFSET_BLDALPHA,
				gIntroWaterDropAlphaBlend[tmp] );
		}
		else
		{
			SetGpuReg( REG_OFFSET_BLDALPHA,
				gIntroWaterDropAlphaBlend[0] );
...
static void sub_816F46C( struct Sprite* sprite )
{
	...
	else
	{
		...
		SetOamMatrix(
			sprite->data[1] + 2, var1, var3, var2 * 2, var4 * 2 );
	}
}
...
static void sub_816F5B4( struct Sprite* sprite )
{
	SetOamMatrix( sprite->data[1],
		...
		0,
		sprite->data[6] + 64 );
	SetOamMatrix( sprite->data[1] + 1,
		sprite->data[6] + 64,
		0,
		0,
		sprite->data[6] + 64 );
	SetOamMatrix( sprite->data[1] + 2,
		sprite->data[6] + 64,
		0,
		0,
		sprite->data[6] + 64 );
...
static u8 CreateWaterDrop(
	s16 x, s16 y, u16 c, u16 d, u16 e, u8 fallImmediately )
{
	u8 spriteId;
	u8 oldSpriteId;
...
static void SpriteCB_IntroGraphicsFlygon( struct Sprite* sprite )
{
	...
	sprite->pos2.y =
		Sin( (u8)sprite->data[1], 8 ) - gIntroGraphicsFlygonYOffset;
	sprite->data[1] += 4;
}
...
static void sub_816FB38( struct Sprite* sprite )
{
	...
	case 2:
		if( sprite->data[3] == 0 )
		{
			...
			if( sprite->data[1] != 0 )
			{
				CpuCopy16( &gIntro1GameFreakTextFadePal
						   [sprite->data[1]],
					&gPlttBufferFaded[0x11F],
					2 );
				CpuCopy16( &gIntro1GameFreakTextFadePal
						   [sprite->data[1] + 0x10],
...
static u8 CreatePart1Animations( s16 a0, s16 a1, s16 a2 )
{
	...
	for( i = 0; i < 9; i++ )
	{
		spriteId                   = CreateSprite( &gUnknown_085E4F5C,
                        gUnknown_085E4E94[i][1] + a0,
                        a1 - 4,
                        0 );
		gSprites[spriteId].data[0] = 0;
		...
		StartSpriteAnim(
			&gSprites[spriteId], gUnknown_085E4E94[i][0] );
