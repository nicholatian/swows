...
static const u8 gUnknown_082F2AA8[] = {CHAR_SPACE,
	0x16,
	0x17,
	0x68,
	0x19,
...
const u8* const gUnknown_082F2BA8[][10] = {{gUnknown_0862B9F9,
						   gUnknown_0862B9FF,
						   gUnknown_0862BA05,
						   gUnknown_0862BA0B,
						   gUnknown_0862BA11,
...
const u16 gUnknown_082F2C20[] =
	INCBIN_U16( "graphics/interface/unk_palette1.gbapal" );
const u16 gUnknown_082F2C40[] =
	INCBIN_U16( "graphics/interface/unk_palette2.gbapal" );

const struct BgTemplate gUnknown_082F2C60[] = {{.bg                   = 0,
						       .charBaseIndex = 0,
						       .mapBaseIndex  = 7,
						       .screenSize    = 0,
						       .paletteMode   = 0,
...
const struct Unk82F2C98 gUnknown_082F2C98[] = {{0x00000000, sub_801F658},
...
const u16 gUnknown_082F2DF0[] =
	INCBIN_U16( "graphics/interface/unk_palette3.gbapal" );
const u32 gUnknown_082F2E10[] =
	INCBIN_U32( "graphics/interface/unk_cursor.4bpp.lz" );
const u32 gUnknown_082F3094[] =
	INCBIN_U32( "graphics/interface/unk_dash.4bpp.lz" );
const u32 gUnknown_082F30B4[] =
	INCBIN_U32( "graphics/interface/unk_cursor_arrow.4bpp.lz" );
const u32 gUnknown_082F30E0[] =
	INCBIN_U32( "graphics/interface/unk_rbutton.4bpp.lz" );
...
const struct SpritePalette gUnknown_082F315C = {gUnknown_082F2DF0, 0x0000};

const struct OamData gUnknown_082F3164 = {
	.shape = ST_OAM_H_RECTANGLE, .size = 3, .priority = 1};
...
const union AnimCmd* const gUnknown_082F318C[] = {gUnknown_082F316C,
	gUnknown_082F3174,
	gUnknown_082F317C,
	gUnknown_082F3184};

const struct SpriteTemplate gUnknown_082F319C = {.tileTag = 0x0000,
	.paletteTag                                       = 0x0000,
...
const struct OamData gUnknown_082F31B4 = {
	.shape = ST_OAM_V_RECTANGLE, .size = 0, .priority = 2};

const struct SpriteTemplate gUnknown_082F31BC = {.tileTag = 0x0002,
	.paletteTag                                       = 0x0000,
...
const struct SpriteTemplate gUnknown_082F31D4 = {.tileTag = 0x0001,
	.paletteTag                                       = 0x0000,
	.oam                                              = &gUnknown_082F31B4,
	.anims       = gDummySpriteAnimTable,
	.images      = NULL,
...
const struct OamData gUnknown_082F31EC = {
	.shape = ST_OAM_SQUARE, .size = 1, .priority = 2};

const struct OamData gUnknown_082F31F4 = {
	.shape = ST_OAM_H_RECTANGLE, .size = 2, .priority = 2};

const union AnimCmd gUnknown_082F31FC[] = {
	ANIMCMD_FRAME( 0x00, 2 ), ANIMCMD_END};
...
const union AnimCmd gUnknown_082F3214[] = {
	ANIMCMD_FRAME( 0x18, 2 ), ANIMCMD_END};

const union AnimCmd* const gUnknown_082F321C[] = {gUnknown_082F31FC,
	gUnknown_082F3204,
	gUnknown_082F320C,
	gUnknown_082F3214};

const struct SpriteTemplate gUnknown_082F322C = {.tileTag = 0x0003,
	.paletteTag                                       = 0x0000,
...
const struct SpriteTemplate gUnknown_082F3244 = {.tileTag = 0x0004,
	.paletteTag                                       = 0x0000,
...
static void sub_801DDD0( struct UnionRoomChat* unionRoomChat )
{
	...
	for( i = 0; i < 10; i++ )
		StringCopy(
			unionRoomChat->unkB9[i], gSaveBlock1Ptr->unk3C88[i] );
}
...
static void sub_801DFAC( void )
{
	...
	case 1:
		...
		{
			if( SendBlock( 0,
				    gUnknown_02022C84->unk190,
				    sizeof( gUnknown_02022C84->unk190 ) ) )
				gUnknown_02022C84->unk6++;
		}
		break;
	case 2:
...
static void sub_801E5C4( void )
{
	...
	case 0:
		...
		break;
	case 1:
		if( !sub_801F644( 0 ) && IsLinkTaskFinished( ) &&
			!sub_8011A9C( ) )
		{
			sub_800AC34( );
			gUnknown_02022C84->unkA = 0;
...
static void sub_801E668( void )
{
	...
	case 1:
		...
		break;
	case 2:
		if( sub_801F644( 0 ) != TRUE && IsLinkTaskFinished( ) &&
			!sub_8011A9C( ) )
		{
			sub_800AC34( );
			gUnknown_02022C84->unkA = 0;
	...
	if( !( gMain.newAndRepeatedKeys & DPAD_UP ) )
	{
		if( gMain.newAndRepeatedKeys & DPAD_DOWN )
		{
			if( gUnknown_02022C84->unk12 <
				sUnknown_082F2AA4[gUnknown_02022C84->unk10] )
...
static void sub_801EC94( void )
{
	...
	if( gUnknown_02022C84->unk10 != 3 )
	{
		charsStr = gUnknown_082F2BA8[gUnknown_02022C84->unk10]
					    [gUnknown_02022C84->unk12];
	...
	{
		u8* tempStr = StringCopy( buffer,
			gUnknown_02022C84->unkB9[gUnknown_02022C84->unk12] );
...
static void sub_801EE2C( void )
{
	int i;
	for( i = 0; i < 10; i++ )
		StringCopy( gSaveBlock1Ptr->unk3C88[i],
			gUnknown_02022C84->unkB9[i] );
}

static u8* sub_801EE6C( int arg0 ) { return gUnknown_02022C84->unkB9[arg0]; }
...
static void sub_801EF1C( u8* arg0 ) { arg0[0] = CHAR_SPACE; }
...
static void sub_801EF4C( u8* arg0 )
{
	arg0[0] = 1;
	StringCopy( &arg0[1], gSaveBlock2Ptr->playerName );
	StringCopy( &arg0[1 + ( PLAYER_NAME_LENGTH + 1 )],
		gUnknown_02022C84->unk1A );
}
...
static u8 sub_801F0B0( void ) { return gUnknown_02022C84->unk10; }
...
static u8* sub_801F0D0( void ) { return gUnknown_02022C84->unk1A; }
...
static u8* sub_801F180( void ) { return gUnknown_02022C84->unk39; }

static u8 sub_801F18C( void ) { return gUnknown_02022C84->unk16; }

static int sub_801F198( void ) { return gUnknown_02022C84->unk15; }

static int sub_801F1A4( void )
{
	u8* str       = sub_801EEA8( );
	u32 character = *str;
	if( character > 0xFF || gUnknown_082F2AA8[character] == character ||
		gUnknown_082F2AA8[character] == 0 )
		return 3;
	else
		return 0;
}

static u8* sub_801F1D0( void ) { return gUnknown_02022C84->unk79; }
...
static void sub_801F2B4( u8 taskId )
{
	...
	case 1:
		...
		// fall through
	case 3:
		for( ; data[1] < 5 && ( ( data[3] >> data[1] ) & 1 ) == 0;
			data[1]++ )
			;
		...
		if( sub_801EFF8( gUnknown_02022C84->unk39,
			    (u8*)gBlockRecvBuffer[data[1]] ) )
		{
...
static bool32 sub_801F534( void ) { return sub_801F644( 0 ); }
...
static void sub_801F5B8( void )
{
	...
	for( i = 0; i < 3; i++ )
	{
		gUnknown_02022C88->unk0[i].unk4 =
			gUnknown_02022C88->unk0[i].unk0(
				&gUnknown_02022C88->unk0[i].unk5 );
	}
}
...
static void sub_801F5EC( u16 arg0, u8 arg1 )
{
	...
	for( i = 0; i < 21; i++ )
	{
		...
		{
			gUnknown_02022C88->unk0[arg1].unk0 =
				gUnknown_082F2C98[i].unk4;
...
static bool32 sub_801FDD8( u8* arg0 ) { return FALSE; }
...
static void sub_801FDDC( u8 left, u8 top, u8 initialCursorPos )
{
	...
	if( gUnknown_02022C88->unk18 != 0xFF )
	{
		FillWindowPixelBuffer(
			gUnknown_02022C88->unk18, PIXEL_FILL( 1 ) );
		PutWindowTilemap( gUnknown_02022C88->unk18 );
		AddTextPrinterParameterized( gUnknown_02022C88->unk18,
			1,
			gText_Yes,
			8,
			1,
		...
		InitMenuInUpperLeftCornerPlaySoundWhenAPressed(
			gUnknown_02022C88->unk18, 2, initialCursorPos );
	}
}
...
static s8 sub_801FF08( void ) { return Menu_ProcessInput( ); }
...
static void sub_801FF18( int arg0, u16 arg1 )
{
	...
	{
		DynamicPlaceholderTextUtil_ExpandPlaceholders(
			gUnknown_02022C88->unk22,
			gUnknown_082F2D40[arg0].unk0 );
...
static void sub_8020118( u16 x, u8* str, u8 fillValue, u8 arg3, u8 arg4 )
{
	...
	AddTextPrinterParameterized3(
		1, 2, x * 8, 1, sp, TEXT_SPEED_FF, str2 );
}
...
static void sub_80201A4( void )
{
	...
	if( var0 != 3 )
	{
		...
		for( i = 0, top = 0; i < 10; i++, top += 12 )
		{
			...
			AddTextPrinterParameterized3(
				2, 0, left, top, sp, TEXT_SPEED_FF, &sp[4] );
		}
	}
	else
	{
...
static void sub_8020420( u16 row, u8* str, u8 arg2 )
{
	...
	AddTextPrinterParameterized3(
		0, 2, 0, row * 15 + 1, color, TEXT_SPEED_FF, str );
}
...
static void sub_8020480( void )
{
	...
	SetGpuReg( REG_OFFSET_WININ,
		WININ_WIN0_BG0 | WININ_WIN0_BG2 | WININ_WIN0_BG3 |
...
static void sub_8020604( void )
{
	...
	ptr = decompress_and_copy_tile_data_to_vram(
		2, gLinkMiscMenu_Gfx, 0, 0, 0 );
	if( ptr )
	{
...
static void sub_80206E8( void )
{
	...
	for( i = 0; i < 15; i++ )
		BlitBitmapToWindow(
			1, gUnknown_02022C88->unk2128, i * 8, 0, 8, 16 );
...
static void sub_80207C0( s16 arg0 )
{
	CpuFill16( arg0,
		...
		0x120 );
	CpuFill16( 0,
		gScanlineEffectRegBuffers[gScanlineEffect.srcBuffer] + 0x90,
		0x20 );
}
