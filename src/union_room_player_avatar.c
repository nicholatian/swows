...
static const u8 gUnknown_082F076A[] = {0x00, 0x02, 0x01, 0x04, 0x03};

static const u8 gUnknown_082F076F[] = {0x01, 0x03, 0x01, 0x04, 0x02};

static const u8 gUnknown_082F0774[] = {0x09,
	0x08,
	0x07,
	0x02,
	0x06,
...
static const u8 gUnknown_082F078C[2] = {
	MOVEMENT_ACTION_FLY_UP, MOVEMENT_ACTION_STEP_END};

static const u8 gUnknown_082F078E[2] = {
	MOVEMENT_ACTION_FLY_DOWN, MOVEMENT_ACTION_STEP_END};
...
static bool32 sub_80199E0( u32 a0, u32 a1, s32 a2, s32 a3 )
{
	...
	else if( gUnknown_082F0740[a0][1] + gUnknown_082F0760[a1][1] + 7 !=
		a3 )
	{
		return FALSE;
	}
...
{
	TrySpawnEventObject( gUnknown_082F0774[playerIdx],
...
{
	RemoveEventObjectByLocalIdAndMap( gUnknown_082F0774[playerIdx],
		gSaveBlock1Ptr->location.mapNum,
		gSaveBlock1Ptr->location.mapGroup );
}
	...
	u32 playerIdx, const u8* movement )
{
	...
	if( TryGetEventObjectIdByLocalIdAndMap( gUnknown_082F0774[playerIdx],
		    gSaveBlock1Ptr->location.mapNum,
		    gSaveBlock1Ptr->location.mapGroup,
		    &objectId ) )
	{
...
static bool32 sub_8019BDC(
	s8* a0, u32 playerIdx, struct UnkStruct_8019BA8* ptr )
{
	switch( *a0 )
	{
	case 0:
		if( SetUnionRoomPlayerEnterExitMovement(
			    playerIdx, gUnknown_082F078C ) == TRUE )
		{
...
void sub_8019E70( u8* sp8, s32 r9 )
{
	...
	{
		s32 r5  = 5 * r9 + r7;
		sp8[r5] = sprite_new( EVENT_OBJ_GFX_MAN_4,
			r5 - 0x38,
			gUnknown_082F0740[r9][0] + gUnknown_082F0760[r7][0],
			gUnknown_082F0740[r9][1] + gUnknown_082F0760[r7][1],
			3,
			1 );
...
static u8 sub_8019F64(
	u32 r1, u32 unused, struct UnkLinkRfuStruct_02022B14* r2 )
{
	if( r1 != 0 )
	{
...
static void sub_8019FA4(
	u32 r5, u32 r6, u8 r8, struct UnkLinkRfuStruct_02022B14* r9 )
{
	s32 x, y;
	s32 r7 = 5 * r5 + r6;
...
static void sub_801A064( u32 r7, struct UnkLinkRfuStruct_02022B14* r8 )
{
	...
	{
		if( sub_80199E0( r7, 0, x, y ) == 1 ||
			sub_80199E0( r7, 0, x2, y2 ) == 1 )
		{
			return;
		}
		sub_8019FA4( r7,
			0,
			sub_8019978( r8->playerGender,
				r8->unk_00.playerTrainerId[0] ),
			r8 );
	}
	for( i = 1; i < 5; i++ )
	{
		...
		else if( sub_80199E0( r7, i, x, y ) == 0 &&
			sub_80199E0( r7, i, x2, y2 ) == 0 )
		{
			sub_8019FA4( r7,
				i,
				sub_8019978( ( r8->unk_04[i - 1] >> 3 ) & 1,
					r8->unk_04[i - 1] & 7 ),
				r8 );
		}
	}
...
static void sub_801A16C( u32 r5, struct UnkLinkRfuStruct_02022B14* r4 )
{
	...
	case 0x54:
		sub_8019CF0(
			r5, r4->playerGender, r4->unk_00.playerTrainerId[0] );
		for( i = 0; i < 5; i++ )
		{
			sub_801A02C( r5, i );
		}
...
void sub_801A274( struct UnkStruct_URoom* unused ) { gUnknown_02022C68 = 300; }
...
bool32 sub_801A2A8(
	struct UnkStruct_Main0* arg0, s16* arg1, s16* arg2, u8* arg3 )
{
	s16 x, y;
	s32 i, j;
	struct UnkStruct_x20* r4;
	...
	for( i = 0, r4 = arg0->arr; i < 8; i++ )
	{
		for( j = 0; j < 5; j++ )
		{
			s32 r3 = 5 * i + j;
			if( x !=
				gUnknown_082F0740[i][0] +
					gUnknown_082F0760[j][0] + 7 )
			{
				continue;
			}
			if( y !=
				gUnknown_082F0740[i][1] +
					gUnknown_082F0760[j][1] + 7 )
			{
				continue;
			}
...
{
	return sub_801A3B0( arg0,
		arg1,
		sub_8019F64( arg0, arg1, &arg2->arr[arg1].unk.field_0 ) );
}
