...
static const u16 gUnknown_085B2890[] =
	INCBIN_U16( "graphics/misc/85B2890.gbapal" );
static const u16 gUnknown_085B28A0[] =
	INCBIN_U16( "graphics/misc/85B28A0.gbapal" );
static const u32 gCaveTransitionTilemap[] =
	INCBIN_U32( "graphics/misc/cave_transition_map.bin.lz" );
static const u32 gCaveTransitionTiles[] =
	INCBIN_U32( "graphics/misc/cave_transition.4bpp.lz" );

// text
bool8 SetUpFieldMove_Flash( void )
{
	// In Ruby and Sapphire, Registeel's tomb is opened by using Fly. In
	// Emerald, Flash is used instead.
...
static bool8 sub_8137304( void )
{
	...
	{
		if( gUnknown_085B27C8[i].unk0 == v0 &&
			gUnknown_085B27C8[i].unk1 == v1 )
		{
...
static void sub_81373F0( void ) { CreateTask( sub_8137404, 0 ); }

static void sub_8137404( u8 taskId ) { gTasks[taskId].func = sub_8137420; }
...
static void sub_8137420( u8 taskId )
{
	...
	SetGpuReg( REG_OFFSET_BG0CNT,
		BGCNT_PRIORITY( 0 ) | BGCNT_CHARBASE( 3 ) |
...
static void sub_81375A8( void ) { CreateTask( sub_81375BC, 0 ); }

static void sub_81375BC( u8 taskId ) { gTasks[taskId].func = sub_81375D8; }
...
static void sub_8137678( u8 taskId )
{
	...
	if( count < 16 )
	{
		gTasks[taskId].data[2]++;
		gTasks[taskId].data[2]++;
		LoadPalette( &gUnknown_085B2890[15 - count],
			0xE0,
			2 * ( count + 1 ) );
	}
	else
