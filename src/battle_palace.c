...
static const u16 gUnknown_0860DE78[] = {ITEM_HP_UP,
	ITEM_PROTEIN,
	ITEM_IRON,
	ITEM_CALCIUM,
	ITEM_CARBOS,
	ITEM_ZINC};
static const u16 gUnknown_0860DE84[] = {ITEM_BRIGHT_POWDER,
	ITEM_WHITE_HERB,
	ITEM_QUICK_CLAW,
	ITEM_LEFTOVERS,
	ITEM_MENTAL_HERB,
...
static void sub_8195980( void )
{
	...
	if( !( gSaveBlock2Ptr->frontier.field_CDC &
		    gUnknown_0860DE98[battleMode][lvlMode] ) )
		gSaveBlock2Ptr->frontier
			.palaceWinStreaks[battleMode][lvlMode] = 0;
...
static void sub_8195AE4( void )
{
	...
	case 2:
		if( gSpecialVar_0x8006 )
			...
			gSaveBlock2Ptr->frontier.field_CDC &=
				gUnknown_0860DEA8[battleMode][lvlMode];
		break;
	}
}
...
static void sub_8195BB0( void )
{
	...
	if( gSaveBlock2Ptr->frontier.palaceWinStreaks[battleMode][lvlMode] <
		...
		gSpecialVar_Result = Random( ) % 3;
			 ...
			 .palaceWinStreaks[battleMode][lvlMode] < 99 )
...
static void sub_8195C7C( void )
{
		...
		9999 )
	{
		...
		if( gSaveBlock2Ptr->frontier.palaceWinStreaks
				[battleMode]
				[( lvlMode > gSaveBlock2Ptr->frontier
...
static void sub_8195D28( void )
{
	...
	if( gSaveBlock2Ptr->frontier.palaceWinStreaks[battleMode][lvlMode] >
		41 )
		gSaveBlock2Ptr->frontier.field_DC6 =
			gUnknown_0860DE84[Random( ) %
				ARRAY_COUNT( gUnknown_0860DE84 )];
	else
		gSaveBlock2Ptr->frontier.field_DC6 =
			gUnknown_0860DE78[Random( ) %
				ARRAY_COUNT( gUnknown_0860DE78 )];
}
...
static void sub_8195DB8( void )
{
	...
	{
		CopyItemName(
			gSaveBlock2Ptr->frontier.field_DC6, gStringVar1 );
