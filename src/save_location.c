...
{
	s32 i;
	u16 locSum = ( gSaveBlock1Ptr->location.mapGroup << 8 ) +
...
static const u16 sSaveLocationReloadLocList[] = // There's only 1 location, and
						// it's presumed its for the
						// save reload feature for
						// battle tower.
	{
...
// this function definitely sets a warp status, but because the list is empty,
// it's unknown what this does yet.
...
void sub_81AFDD0( void ) { gSaveBlock2Ptr->specialSaveWarpFlags |= 0x80; }
