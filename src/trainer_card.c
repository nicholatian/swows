...
// const rom data
static const u32 gUnknown_0856F018[] =
	INCBIN_U32( "graphics/trainer_card/stickers_fr.4bpp.lz" );
static const u16 gUnknown_0856F18C[] =
	INCBIN_U16( "graphics/trainer_card/unknown_56F18C.gbapal" );
static const u16 gEmeraldTrainerCard1Star_Pal[] =
	INCBIN_U16( "graphics/trainer_card/one_star.gbapal" );
static const u16 gFireRedTrainerCard1Star_Pal[] =
	INCBIN_U16( "graphics/trainer_card/one_star_fr.gbapal" );
static const u16 gEmeraldTrainerCard2Star_Pal[] =
	INCBIN_U16( "graphics/trainer_card/two_stars.gbapal" );
static const u16 gFireRedTrainerCard2Star_Pal[] =
	INCBIN_U16( "graphics/trainer_card/two_stars_fr.gbapal" );
static const u16 gEmeraldTrainerCard3Star_Pal[] =
	INCBIN_U16( "graphics/trainer_card/three_stars.gbapal" );
static const u16 gFireRedTrainerCard3Star_Pal[] =
	INCBIN_U16( "graphics/trainer_card/three_stars_fr.gbapal" );
static const u16 gEmeraldTrainerCard4Star_Pal[] =
	INCBIN_U16( "graphics/trainer_card/four_stars.gbapal" );
static const u16 gFireRedTrainerCard4Star_Pal[] =
	INCBIN_U16( "graphics/trainer_card/four_stars_fr.gbapal" );
static const u16 sEmeraldTrainerCardFemaleBackground_Pal[] =
	INCBIN_U16( "graphics/trainer_card/female_bg.gbapal" );
static const u16 sFireRedTrainerCardFemaleBackground_Pal[] =
	INCBIN_U16( "graphics/trainer_card/female_bg_fr.gbapal" );
static const u16 sEmeraldTrainerCardBadges_Pal[] =
	INCBIN_U16( "graphics/trainer_card/badges.gbapal" );
static const u16 sFireRedTrainerCardBadges_Pal[] =
	INCBIN_U16( "graphics/trainer_card/badges_fr.gbapal" );
static const u16 gUnknown_0856F52C[] =
	INCBIN_U16( "graphics/trainer_card/gold.gbapal" );
static const u16 gUnknown_0856F54C[] =
	INCBIN_U16( "graphics/trainer_card/stickers_fr1.gbapal" );
static const u16 gUnknown_0856F56C[] =
	INCBIN_U16( "graphics/trainer_card/stickers_fr2.gbapal" );
static const u16 gUnknown_0856F58C[] =
	INCBIN_U16( "graphics/trainer_card/stickers_fr3.gbapal" );
static const u16 gUnknown_0856F5AC[] =
	INCBIN_U16( "graphics/trainer_card/stickers_fr4.gbapal" );
static const u32 sEmeraldTrainerCardBadges_Tile[] =
	INCBIN_U32( "graphics/trainer_card/badges.4bpp.lz" );
static const u32 sFireRedTrainerCardBadges_Tile[] =
...
static const u8 gUnknown_0856FB20[][2] = {
	{0x4E, 0x4F}, {0x50, 0x51}, {0x3C, 0x3F}};
		...
		else if( gMain.newKeys & B_BUTTON )
		{
			...
			else
			{
				BeginNormalPaletteFade(
					0xFFFFFFFF, 0, 0, 16, sData->var_52C );
				sData->var_0 = 14;
			}
		}
		break;
...
static bool8 LoadCardGfx( void )
{
	...
	case 2:
		if( !sData->isLink )
		{
			if( sData->cardType != CARD_TYPE_FRLG )
				LZ77UnCompWram(
					gUnknown_08DD2010, sData->var_598 );
			else
				LZ77UnCompWram(
					gUnknown_08DD2B78, sData->var_598 );
		}
		else
		{
			if( sData->cardType != CARD_TYPE_FRLG )
				LZ77UnCompWram(
					gUnknown_08DD228C, sData->var_598 );
			else
				LZ77UnCompWram(
					gUnknown_08DD2E5C, sData->var_598 );
		}
		break;
	case 3:
		if( sData->cardType != CARD_TYPE_FRLG )
			LZ77UnCompWram( sEmeraldTrainerCardBadges_Tile,
				sData->var_13A8 );
		else
			LZ77UnCompWram( sFireRedTrainerCardBadges_Tile,
				sData->var_13A8 );
		break;
	case 4:
		if( sData->cardType != CARD_TYPE_FRLG )
			LZ77UnCompWram(
				gEmeraldTrainerCard_Gfx, sData->var_19A8 );
		else
			LZ77UnCompWram(
				gFireRedTrainerCard_Gfx, sData->var_19A8 );
		break;
	case 5:
		if( sData->cardType == CARD_TYPE_FRLG )
...
static void SetPlayerCardData( struct TrainerCard* trainerCard, u8 cardType )
{
	...
	case CARD_TYPE_FRLG:
		...
		trainerCard->pokeblocksWithFriends = GetCappedGameStat(
			GAME_STAT_POKEBLOCKS_WITH_FRIENDS, 0xFFFF );
		if( CountPlayerContestPaintings( ) > 4 )
...
static void TrainerCard_GenerateCardForLinkPlayer(
	struct TrainerCard* trainerCard )
{
	...
	if( trainerCard->gender == FEMALE )
		trainerCard->var_4F = gLinkPlayerFacilityClasses
			[( trainerCard->trainerId % 8 ) + 8];
	else
		trainerCard->var_4F =
			gLinkPlayerFacilityClasses[trainerCard->trainerId % 8];
}
...
void TrainerCard_GenerateCardForPlayer( struct TrainerCard* trainerCard )
{
	...
	*( (u16*)&trainerCard->berryCrushPoints ) =
		gSaveBlock2Ptr->frontier.field_EBA;
...
static void HandleGpuRegs( void )
{
	...
	SetGpuReg( REG_OFFSET_WINOUT,
		WINOUT_WIN01_BG1 | WINOUT_WIN01_BG2 | WINOUT_WIN01_BG3 |
			WINOUT_WIN01_OBJ );
	SetGpuReg( REG_OFFSET_WIN0V, 160 );
	SetGpuReg( REG_OFFSET_WIN0H, 240 );
	if( gReceivedRemoteLinkPlayers )
		EnableInterrupts( INTR_FLAG_VBLANK | INTR_FLAG_HBLANK |
			INTR_FLAG_VCOUNT | INTR_FLAG_TIMER3 |
			INTR_FLAG_SERIAL );
	else
		EnableInterrupts( INTR_FLAG_VBLANK | INTR_FLAG_HBLANK );
}
...
static void sub_80C32EC( u16 arg0 )
{
	...
	SetGpuReg( REG_OFFSET_WIN0V,
		( sData->var_7CA8 * 256 ) | ( 160 - sData->var_7CA8 ) );
}
...
static void InitBgsAndWindows( void )
{
	...
	InitBgsFromTemplates(
		0, gUnknown_0856FAB4, ARRAY_COUNT( gUnknown_0856FAB4 ) );
	ChangeBgX( 0, 0, 0 );
	ChangeBgY( 0, 0, 0 );
	ChangeBgX( 1, 0, 0 );
	ChangeBgY( 1, 0, 0 );
...
static void PrintIdOnCard( void )
{
	...
	AddTextPrinterParameterized3(
		1, 1, xPos, top, gUnknown_0856FB0C, TEXT_SPEED_FF, buffer );
}
...
static void PrintMoneyOnCard( void )
{
	...
	ConvertIntToDecimalStringN(
		gStringVar1, sData->trainerCard.money, 0, 6 );
...
static void PrintPokedexOnCard( void )
{
	...
	if( FlagGet( FLAG_SYS_POKEDEX_GET ) )
	{
		...
		if( !sData->isHoenn )
		{
			xOffset = GetStringRightAlignXOffset(
				1, gStringVar4, 144 );
			top = 72;
		}
		else
...
static const u8* const gUnknown_0856FB40[] = {
	gUnknown_0856FB0C, gUnknown_0856FB12};
...
static void PrintTimeOnCard( void )
{
	...
	AddTextPrinterParameterized3(
		1, 1, r7, r4, gUnknown_0856FB0C, TEXT_SPEED_FF, gStringVar4 );
	r7 += 18;
	AddTextPrinterParameterized3( 1,
		1,
		r7,
		r4,
		gUnknown_0856FB40[sData->var_7],
		TEXT_SPEED_FF,
		gText_Colon2 );
	r7 += width;
...
static void PrintProfilePhraseOnCard( void )
{
	if( sData->isLink )
	{
		AddTextPrinterParameterized3( 1,
			1,
			8,
			gUnknown_0856FB48[sData->isHoenn],
			gUnknown_0856FB0C,
			TEXT_SPEED_FF,
			sData->var_19[0] );
		AddTextPrinterParameterized3( 1,
			1,
			GetStringWidth( 1, sData->var_19[0], 0 ) + 14,
			gUnknown_0856FB48[sData->isHoenn],
			gUnknown_0856FB0C,
			TEXT_SPEED_FF,
			sData->var_19[1] );
		AddTextPrinterParameterized3( 1,
			1,
			8,
			gUnknown_0856FB4A[sData->isHoenn],
			gUnknown_0856FB0C,
			TEXT_SPEED_FF,
			sData->var_19[2] );
		AddTextPrinterParameterized3( 1,
			1,
			GetStringWidth( 1, sData->var_19[2], 0 ) + 14,
			gUnknown_0856FB4A[sData->isHoenn],
			gUnknown_0856FB0C,
			TEXT_SPEED_FF,
			sData->var_19[3] );
...
static void PrintNameOnCard2( void )
{
	...
	if( sData->cardType != CARD_TYPE_FRLG )
	{
		...
		StringExpandPlaceholders(
			sData->var_4D, gText_Var1sTrainerCard );
	}
}
...
static void sub_80C3B50( void )
{
	if( !sData->isHoenn )
		...
		AddTextPrinterParameterized3( 1,
			1,
			GetStringRightAlignXOffset( 1, sData->var_4D, 216 ),
			9,
			gUnknown_0856FB0C,
			TEXT_SPEED_FF,
			sData->var_4D );
...
static const u8 gUnknown_0856FB4C[] = {
	0xfd, 0x02, 0xf0, 0xfd, 0x03, 0xf0, 0xfd, 0x04, 0xff};
...
static void PrintHofTimeOnCard( void )
{
	...
	{
		ConvertIntToDecimalStringN(
			gStringVar1, sData->trainerCard.hofDebutHours, 1, 3 );
...
static void PrintString( u8 top, const u8* str1, u8* str2, const u8* color )
{
	AddTextPrinterParameterized3( 1,
		1,
		gUnknown_0856FB55[sData->isHoenn],
		top * 16 + 33,
		gUnknown_0856FB0C,
		TEXT_SPEED_FF,
		str1 );
	AddTextPrinterParameterized3( 1,
		...
		GetStringRightAlignXOffset(
			1, str2, gUnknown_0856FB57[sData->isHoenn] ),
		top * 16 + 33,
		color,
		TEXT_SPEED_FF,
		str2 );
...
static const u8* const gUnknown_0856FB5C[] = {
	gText_LinkBattles, gText_LinkCableBattles, gText_LinkBattles};
...
static void PrintLinkResultsNumsOnCard( void )
{
	...
	{
		StringCopy(
			sData->var_D9, gUnknown_0856FB5C[sData->cardType] );
		ConvertIntToDecimalStringN( sData->var_165,
			sData->trainerCard.linkBattleWins,
			0,
			4 );
		ConvertIntToDecimalStringN( sData->var_1AB,
			sData->trainerCard.linkBattleLosses,
			0,
			4 );
	}
...
static void PrintWinsLossesStringOnCard( void )
{
	if( sData->hasLinkResults )
	{
		...
		PrintString(
			1, sData->var_D9, gStringVar4, gUnknown_0856FB0C );
	}
}
...
{
	if( sData->hasTrades )
		ConvertIntToDecimalStringN( sData->var_237,
...
static void PrintBerryCrushNumOnCard( void )
{
	if( sData->cardType == CARD_TYPE_FRLG &&
		...
		ConvertIntToDecimalStringN( sData->var_2C3,
			sData->trainerCard.berryCrushPoints,
			1,
			5 );
}
...
static void PrintUnionNumOnCard( void )
{
	if( sData->cardType == CARD_TYPE_FRLG &&
		...
		ConvertIntToDecimalStringN( sData->var_34F,
			sData->trainerCard.unionRoomNum,
			1,
			5 );
}
...
static void PrintPokeblocksNumOnCard( void )
{
		...
		sData->trainerCard.pokeblocksWithFriends )
	{
		ConvertIntToDecimalStringN( gStringVar1,
			...
			5 );
		StringExpandPlaceholders(
			sData->var_395, gText_Var1DarkGreyShadowLightGrey );
	}
}
...
static void PrintContestNumOnCard( void )
{
	if( sData->cardType != CARD_TYPE_FRLG &&
		...
		ConvertIntToDecimalStringN( sData->var_3DB,
			sData->trainerCard.contestsWithFriends,
			1,
			5 );
}
	...
	case CARD_TYPE_RS:
		if( sData->hasBattleTowerWins )
		{
			...
			ConvertIntToDecimalStringN( gStringVar2,
				...
				4 );
			StringExpandPlaceholders(
				sData->var_421, gText_WSlashStraightSlash );
		}
		break;
	case CARD_TYPE_EMERALD:
		...
		{
			ConvertIntToDecimalStringN( gStringVar1,
				sData->trainerCard.frontierBP,
				1,
				5 );
			StringExpandPlaceholders(
				sData->var_421, gText_Var1DarkLightGreyBP );
		}
		break;
	case CARD_TYPE_FRLG:
		break;
			...
			if( sData->trainerCard.monSpecies[i] )
			{
				u8 monSpecies =
					GetMonIconPaletteIndexFromSpecies(
						sData->trainerCard
							.monSpecies[i] );
				WriteSequenceToBgTilemapBuffer( 3,
					16 * i + 224,
					buffer2[i] + 3,
					15,
					4,
...
static void sub_80C41D8( void )
{
	...
	for( i = 0; i < 6; i++ )
	{
		if( sData->trainerCard.monSpecies[i] )
			LoadBgTiles( 3,
				GetMonIconTiles(
					sData->trainerCard.monSpecies[i], 0 ),
				512,
				16 * i + 32 );
	}
}
...
static u8 SetCardBgsAndPals( void )
{
	...
	case 2:
		...
		{
			LoadPalette(
				gEmeraldTrainerCardStarPals[sData->trainerCard
								    .stars],
				0,
				96 );
		...
		{
			LoadPalette(
				gFireRedTrainerCardStarPals[sData->trainerCard
								    .stars],
				0,
				96 );
...
static void TrainerCard_PrintStarsAndBadgesOnCard( void )
{
	...
	FillBgTilemapBufferRect( 3,
		143,
		15,
		gUnknown_0856FB78[sData->isHoenn],
...
static void sub_80C4EE4( void )
{
	...
	for( i = 0; i < 4; i++ )
		CopyEasyChatWord(
			sData->var_19[i], sData->trainerCard.var_28[i] );
}
...
static void sub_80C4FF0( void )
{
	...
	{
		sub_818D938(
			FacilityClassToPicIndex( sData->trainerCard.var_4F ),
			TRUE,
			gUnknown_0856FB18[sData->isHoenn]
					 [sData->trainerCard.gender][0],
			gUnknown_0856FB18[sData->isHoenn]
					 [sData->trainerCard.gender][1],
			8,
			2 );
	}
	else
	{
		sub_818D938(
			FacilityClassToPicIndex(
				gUnknown_0856FB20[sData->cardType]
