...
static const union AnimCmd sSpriteAnim_853EE2C[] = {
	ANIMCMD_FRAME( 0, 3 ), ANIMCMD_JUMP( 0 )};
...
static const union AnimCmd sSpriteAnim_853EEB4[] = {
	ANIMCMD_FRAME( 0, 5 ), ANIMCMD_JUMP( 0 )};
...
static const union AnimCmd sSpriteAnim_853EEF0[] = {
	ANIMCMD_FRAME( 0, 15 ), ANIMCMD_JUMP( 0 )};
...
static void sub_80A9FD0( u8 taskId )
{
	...
	else
	{
		...
		SetGpuReg(
			REG_OFFSET_BLDALPHA, BLDALPHA_BLEND( var, 16 - var ) );
	}
}
...
void LaunchStatusAnimation( u8 battlerId, u8 statusAnimId )
{
	...
	LaunchBattleAnimation(
		gBattleAnims_StatusConditions, statusAnimId, 0 );
