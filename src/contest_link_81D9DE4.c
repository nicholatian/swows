...
static void sub_81D9F68( u8 taskId )
{
	...
	if( gNumLinkContestPlayers < 4 )
		SetTaskFuncWithFollowupFunc(
			taskId, sub_81DA488, sub_81DA10C );
	else
...
static void sub_81DA160( u8 taskId )
{
	...
	case 0:
		...
		{
			if( sub_80FC4F4( &gContestMons[gContestPlayerMonIndex],
...
static void sub_81DA244( u8 taskId )
{
	...
	case 0:
		if( GetMultiplayerId( ) == 0 )
		{
			...
			if( sub_80FC4F4( &gRngValue, sizeof( gRngValue ) ) ==
				1 )
				gTasks[taskId].data[0]++;
		}
		else
...
static void sub_81DA488( u8 taskId )
{
	...
	case 0:
		if( GetMultiplayerId( ) == 0 )
		{
			...
			if( sub_80FC4F4( &gContestMons[gNumLinkContestPlayers],
				    ( 4 - gNumLinkContestPlayers ) *
					    sizeof( struct
						    ContestPokemon ) ) == 1 )
				gTasks[taskId].data[0]++;
		}
