...
static const u8* const gUnknown_08618160[] = {Unknown_08617F07,
	Unknown_08617F97,
	Unknown_08618020,
	Unknown_08618092,
	Unknown_086180D7,
...
static void berry_fix_main( void )
{
	...
	case 3:
		...
		{
			berry_fix_mb_manager->mb.masterp =
	...
	case 4:
		...
		if( berry_fix_mb_manager->mb.probe_count != 0 ||
			( !( berry_fix_mb_manager->mb.response_bit & 2 ) ||
				!( berry_fix_mb_manager->mb.client_bit &
					2 ) ) )
		{
			berry_fix_mb_manager->unk2 = 0;
		}
...
static void berry_fix_gpu_set( void )
{
	...
	InitBgsFromTemplates(
		0, gUnknown_08618108, ARRAY_COUNT( gUnknown_08618108 ) );
	ChangeBgX( 0, 0, 0 );
	ChangeBgY( 0, 0, 0 );
	ChangeBgX( 1, 0, 0 );
	ChangeBgY( 1, 0, 0 );
...
static void berry_fix_text_print( int scene )
{
	...
	AddTextPrinterParameterized3(
		1, 1, 0, 0, sUnknown_08618158, -1, gUnknown_08618160[scene] );
	PutWindowTilemap( 1 );
	...
	LZ77UnCompVram(
		gUnknown_08618178[scene][0], (void*)BG_CHAR_ADDR( 1 ) );
	LZ77UnCompVram(
		gUnknown_08618178[scene][1], (void*)BG_SCREEN_ADDR( 31 ) );
