...
const u16 gUnknown_082FF1D8[] =
	INCBIN_U16( "graphics/link/minigame_digits.gbapal" );
const u32 gUnknown_082FF1F8[] =
	INCBIN_U32( "graphics/link/minigame_digits.4bpp.lz" );
// unused
const u32 gUnknown_082FF2B8[] =
	INCBIN_U32( "graphics/link/minigame_digits2.4bpp.lz" );
...
#define SPECIES_SPRITE( species, sprite ) \
	[SPECIES_##species] = {sprite, 0x800, SPECIES_##species}
#define SPECIES_PAL( species, pal ) \
	[SPECIES_##species] = {pal, SPECIES_##species}
