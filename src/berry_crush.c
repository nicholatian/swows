...
struct BerryCrushGame* sub_8020C00( void ) { return gUnknown_02022C90; }
...
static void sub_8020D8C( void )
{
	...
	gUnknown_02022C90->unk84.separate.others[gUnknown_02022C90->unk8]
		.unk0           = gSpecialVar_ItemId - FIRST_BERRY_INDEX;
	gUnknown_02022C90->unkE = 1;
...
static void sub_8020E3C( void ) { SetVBlankCallback( sub_8020F74 ); }

void sub_8020E4C( void ) { SetVBlankCallback( NULL ); }
...
void sub_8020E58( void )
{
	...
	{
	case 2:
		if( gUnknown_02022C90->unk16 >
			gSaveBlock2Ptr->berryCrush.berryCrushResults[0] )
		{
			gUnknown_02022C90->unk25_1 = 1;
			gSaveBlock2Ptr->berryCrush.berryCrushResults[0] =
				gUnknown_02022C90->unk16;
		}
		break;
	case 3:
		if( gUnknown_02022C90->unk16 >
			gSaveBlock2Ptr->berryCrush.berryCrushResults[1] )
		{
			gUnknown_02022C90->unk25_1 = 1;
			gSaveBlock2Ptr->berryCrush.berryCrushResults[1] =
				gUnknown_02022C90->unk16;
	...
	case 4:
		if( gUnknown_02022C90->unk16 >
			gSaveBlock2Ptr->berryCrush.berryCrushResults[2] )
		{
			gUnknown_02022C90->unk25_1 = 1;
			gSaveBlock2Ptr->berryCrush.berryCrushResults[2] =
				gUnknown_02022C90->unk16;
	...
	case 5:
		if( gUnknown_02022C90->unk16 >
			gSaveBlock2Ptr->berryCrush.berryCrushResults[3] )
		{
			gUnknown_02022C90->unk25_1 = 1;
			gSaveBlock2Ptr->berryCrush.berryCrushResults[3] =
				gUnknown_02022C90->unk16;
...
static void sub_8020FA0( u8 taskId )
{
	if( gUnknown_02022C90->unk4 )
		gUnknown_02022C90->unk4(
			gUnknown_02022C90, gUnknown_02022C90->unk36 );
...
void sub_8020FC4( struct BerryCrushGame* arg0 )
{
	...
	for( i = 0; i < arg0->unk9; i++ )
		StringCopy(
			arg0->unk84.players[i].unk14, gLinkPlayers[i].name );
...
int sub_802104C( void )
{
	...
	case 7:
		...
		CopyToBgTilemapBuffer(
			2, gBerryCrushContainerCapTilemap, 0, 0 );
...
void sub_80214A8(
	struct BerryCrushGame* arg0, struct BerryCrushGame_138* arg1 )
{
	u8 i;
	u8 spriteId;
	s16 var0, var1;
...
// void sub_80216E0(struct BerryCrushGame *arg0, struct BerryCrushGame_138
// *arg1)
// {
//     u8 sp4;
...
//                 arg1->unk4C[i]->pos1.y = gUnknown_082F41D2[i][1] + (136 -
//                 var2 * 4); arg1->unk4C[i]->pos2.x = gUnknown_082F41D2[i][0]
//                 / (var3 * 4); arg1->unk4C[i]->pos2.y =
//                 gUnknown_082F41D2[i][1]; if (var4E->unk4 & 0x2)
