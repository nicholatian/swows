...
u16* sub_801B058( void ) { return gSaveBlock1Ptr->unk_322C.unk_338; }

void DestroyWonderNews( void ) { s_DestroyWonderNews( ); }
...
bool32 sub_801B078( const struct WonderNews* src )
{
	...
	gSaveBlock1Ptr->unk_322C.wonderNews.crc  = CalcCRC16WithTable(
                (void*)&gSaveBlock1Ptr->unk_322C.wonderNews.data,
...
{
	const struct WonderNews* data =
		&gSaveBlock1Ptr->unk_322C.wonderNews.data;
	if( data->unk_02 == 0 )
		return FALSE;
...
static void s_DestroyWonderNews( void )
{
	CpuFill32( 0,
		GetSavedWonderNews( ),
		sizeof( gSaveBlock1Ptr->unk_322C.wonderNews.data ) );
...
bool32 sub_801B21C( const struct WonderCard* data )
{
	...
	DestroyWonderCard( );
	memcpy( &gSaveBlock1Ptr->unk_322C.wonderCard.data,
		data,
		sizeof( struct WonderCard ) );
	gSaveBlock1Ptr->unk_322C.wonderCard.crc = CalcCRC16WithTable(
		(void*)&gSaveBlock1Ptr->unk_322C.wonderCard.data,
		sizeof( struct WonderCard ) );
...
static bool32 sub_801B2CC( const struct WonderCard* data )
{
	...
	if( data->unk_08_0 > 2 )
		return FALSE;
	if( !( data->unk_08_6 == 0 || data->unk_08_6 == 1 ||
		    data->unk_08_6 == 2 ) )
		return FALSE;
	if( data->unk_08_2 > 7 )
		return FALSE;
...
{
	const struct WonderCard* data =
		&gSaveBlock1Ptr->unk_322C.wonderCard.data;
	if( data->unk_08_6 == 0 )
		return FALSE;
...
static bool32 sub_801B460(
	const struct MEventBuffer_3430_Sub* data1, const u16* data2, int size )
{
	int i;
	for( i = 0; i < size; i++ )
	{
...
static int sub_801B4CC( void )
{
	...
	return sub_801B438(
		&gSaveBlock1Ptr->unk_322C.buffer_310.data, data->unk_09 );
}
...
bool32 sub_801B508( const u16* data )
{
	...
	if( sub_801B460(
		    &gSaveBlock1Ptr->unk_322C.buffer_310.data, data, size ) )
		return FALSE;

	for( i = 0; i < size; i++ )
	{
		if( gSaveBlock1Ptr->unk_322C.buffer_310.data.unk_08[1][i] ==
				0 &&
			gSaveBlock1Ptr->unk_322C.buffer_310.data
					.unk_08[0][i] == 0 )
		{
			gSaveBlock1Ptr->unk_322C.buffer_310.data.unk_08[1][i] =
				data[1];
			gSaveBlock1Ptr->unk_322C.buffer_310.data.unk_08[0][i] =
				data[0];
			return TRUE;
		}
	}
...
u32 sub_801B6EC( const u16* a0,
	const struct MEventStruct_Unk1442CC* a1,
	const void* unused )
{
	if( a1->unk_14 == 0 )
		return 0;
...
static void sub_801B7D8( u32 command )
{
	...
	if( data->unk_08_0 == 2 )
	{
		...
		{
		case 0:
			dest = &gSaveBlock1Ptr->unk_322C.buffer_310.data
					.unk_00;
			break;
		case 1:
			dest = &gSaveBlock1Ptr->unk_322C.buffer_310.data
...
u16 mevent_081445C0( u32 command )
{
	...
	case 0: {
		...
		if( data->unk_08_0 == 2 )
		{
			struct MEventBuffer_3430_Sub* buffer =
				&gSaveBlock1Ptr->unk_322C.buffer_310.data;
...
void sub_801B940( void ) { gUnknown_02022C70 = FALSE; }
...
void sub_801B990( u32 a0, u32 a1 )
{
	if( gUnknown_02022C70 )
	{
		...
		case 2:
			sub_801BA8C( 2,
				a1,
				gSaveBlock1Ptr->unk_322C.unk_344[1],
				5 );
			break;
		case 0:
			sub_801BA8C( 0,
				a1,
				gSaveBlock1Ptr->unk_322C.unk_344[0],
				5 );
			break;
		case 1:
			sub_801BA8C( 1,
...
{
	CpuFill32( 0,
		gSaveBlock1Ptr->unk_322C.unk_344,
		sizeof( gSaveBlock1Ptr->unk_322C.unk_344 ) );
}
