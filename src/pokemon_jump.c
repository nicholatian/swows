...
static void sub_802AC2C(
	struct PokemonJump1_MonInfo* monInfo, struct Pokemon* mon );
...
void sub_802A9A8( u16 partyIndex, MainCallback callback )
{
	...
	if( gReceivedRemoteLinkPlayers )
	{
		...
		if( gUnknown_02022CFC )
		{
			...
			sub_802AC2C(
				&gUnknown_02022CFC
					 ->unk82A8[gUnknown_02022CFC->unk6],
...
void sub_802AB20( void )
{
	...
	for( i = 0; i < MAX_RFU_PLAYERS; i++ )
	{
		...
		gUnknown_02022CFC->unk82E4[i].unkC =
			gPkmnJumpSpecies[index].unk2;
	}

	gUnknown_02022CFC->unk83AC =
		&gUnknown_02022CFC->unk82E4[gUnknown_02022CFC->unk6];
}
...
static void sub_802AEA4( void )
{
	...
	for( i = 1, count = 0; i < gUnknown_02022CFC->unk5; i++ )
	{
		...
		if( sub_802E264(
			    &gUnknown_02022CFC->unk82E4[i], i, &var1, &var2 ) )
		{
		...
		if( gUnknown_02022CFC->unk82E4[i].unk18 &&
			gUnknown_02022CFC->unk8B[i] ==
				gUnknown_02022CFC->unk70 )
			count++;
	}
...
static void sub_802B008( void )
{
	if( !gUnknown_02022CFC->unk2C )
		sub_802E138( gUnknown_02022CFC->unk82E4,
			&gUnknown_02022CFC->unk70 );
...
static void sub_802B078( void )
{
	...
	{
		if( gUnknown_02022CFC->unk82E4[gUnknown_02022CFC->unk6]
					.unk18 == 1 &&
...
static bool32 sub_802B3D4( void )
{
	...
	case 1:
		if( !sub_802B964( ) )
		{
			...
			{
				gUnknown_02022CFC->unk72 =
					gUnknown_02022CFC->unkE;
...
static bool32 sub_802B4CC( void )
{
	...
	case 1:
		if( !sub_802BB84( ) )
		{
			sub_802E354( gUnknown_02022CFC->unk78,
...
static bool32 sub_802BA58( void )
{
	...
	{
	case 0:
		sub_802C808( gUnknown_02022CFC->unk72,
			&gUnknown_02022CFC->unk3E,
			&gUnknown_02022CFC->unk40 );
		sub_802D7E8(
			gUnknown_02022CFC->unk3E, gUnknown_02022CFC->unk40 );
		gUnknown_02022CFC->unkA++;
		break;
	case 1:
	case 4:
	...
	case 3:
		...
		{
			gUnknown_02022CFC->unk40 =
				sub_802C880( gUnknown_02022CFC->unk3E,
					gUnknown_02022CFC->unk40 );
			if( gUnknown_02022CFC->unk40 &&
				AddBagItem( gUnknown_02022CFC->unk3E,
					gUnknown_02022CFC->unk40 ) )
			{
				if( !CheckBagHasSpace(
					    gUnknown_02022CFC->unk3E, 1 ) )
				{
					sub_802D884(
						gUnknown_02022CFC->unk3E );
...
static void sub_802BD84( u8 taskId )
{
	...
	struct PokemonJump1* ptr =
		(struct PokemonJump1*)GetWordTaskArg( taskId, 14 );
	...
	case 1:
		...
		{
			if( !taskData[i + 2] &&
				sub_802E0D0( i, &ptr->unk82A8[i] ) )
			{
				StringCopy( ptr->unk82E4[i].unk1C,
					gLinkPlayers[i].name );
				taskData[i + 2] = 1;
				taskData[1]++;
...
static void sub_802BEE4( void )
{
	if( gUnknown_02022CFC->unk46 )
	{
		...
		if( gUnknown_02022CFC->unk14 > 6 &&
			gUnknown_02022CFC->unk18 < 7 )
		{
...
static void sub_802BF7C( void )
{
	...
	else
	{
		...
		{
			gUnknown_02022CFC->unk28 =
				gUnknown_082FB63C[gUnknown_02022CFC->unk50] +
				( gUnknown_02022CFC->unk51 * 7 );
			gUnknown_02022CFC->unk4E =
				gUnknown_082FB64C[sub_802C098( ) %
					ARRAY_COUNT( gUnknown_082FB64C )] +
				2;
		...
		else
		{
			...
			var0 = gUnknown_082FB63C[15 -
				gUnknown_02022CFC->unk50];
			gUnknown_02022CFC->unk28 =
				var0 + ( gUnknown_02022CFC->unk51 * 7 );
...
static int sub_802C098( void )
{
	// The number 1103515245 comes from the example implementation of rand
	// and srand
	gUnknown_02022CFC->unk24 =
		gUnknown_02022CFC->unk24 * 1103515245 + 24691;
...
static int sub_802C0DC( void ) { return gUnknown_02022CFC->unk10; }
...
static void sub_802C260( void ) { gUnknown_02022CFC->unk46 = 0; }

static void sub_802C270( void ) { gUnknown_02022CFC->unk46 = 1; }
	...
	for( i = 0; i < numLinkPlayers; i++ )
	{
		...
		case 1:
			if( gUnknown_02022CFC->unk82E4[i].unk12 != 1 ||
				gUnknown_02022CFC->unk82E4[i].unkE !=
					gUnknown_02022CFC->unk9A[i] )
			{
				if( i == gUnknown_02022CFC->unk6 )
					gUnknown_02022CFC->unk82E4[i].unk12 =
						1;

				whichSound |= 0x1;
				gUnknown_02022CFC->unk82E4[i].unk4 =
					0x7FFFFFFF;
				gUnknown_02022CFC->unk9A[i] =
					gUnknown_02022CFC->unk82E4[i].unkE;
			}
...
static void sub_802C43C( void )
{
	...
	if( gUnknown_02022CFC->unk64 &&
		( sub_802C618( ) == TRUE || !gUnknown_02022CFC->unk14 ) )
	{
	...
	if( gUnknown_02022CFC->unk58 )
	{
		...
		if( var1 > gUnknown_02022CFC->unk54 )
		{
			...
			memcpy( gUnknown_02022CFC->unk81,
				gUnknown_02022CFC->unk7C,
				sizeof( u8 ) * MAX_RFU_PLAYERS );
		}
	}
}
...
static bool32 sub_802C538( void )
{
	...
	if( gUnknown_02022CFC->unk14 == 6 &&
		!gUnknown_02022CFC->unk83AC->unk0 )
	{
		if( gUnknown_02022CFC->unk83AC->unk12 == 1 &&
			sub_802C0DC( ) == 1 )
		{
...
static void sub_802C780( void ) { gUnknown_02022CFC->unk44 = 0; }

static int sub_802C790( int arg0 ) { return gUnknown_082FB6EC[arg0]; }
...
u16 sub_802C8AC( void ) { return GetLinkPlayerCount( ); }

u16 sub_802C8BC( void ) { return gUnknown_02022CFC->unk6; }
...
bool32 sub_802C908( u16 species ) { return sub_802AC00( species ) > -1; }
...
void sub_802C920( void )
{
	...
	{
		if( GetMonData(
			    &gPlayerParty[i], MON_DATA_SANITY_HAS_SPECIES ) )
		{
...
void sub_802C9D4( struct PokemonJump2* arg0,
	struct PokemonJump1_MonInfo* jumpMon,
	u16 x,
	u16 y,
	u8 multiplayerId )
{
...
void sub_802CB14( struct PokemonJump2* arg0, int multiplayerId )
{
	...
	arg0->unk81BC[multiplayerId]->data[7] =
		arg0->unk81A8[multiplayerId] - gSprites;
...
//     for (i = 0; i < 4; i++)
//     {
//         spriteId = CreateSprite(&gUnknown_082FBEB8[i],
//         gUnknown_082FBEA8[count], gUnknown_082FBE58[i * 10], 2);
