...
EWRAM_DATA ALIGNED(
	4 ) struct UnkLinkRfuStruct_02022B14 gUnknown_02022B14       = {};
...
const u8 sWireless_ASCIItoRSETable[]                 = {0xff,
        ...
        0x93,
        0x94};
const u8 sWireless_RSEtoASCIITable[]                 = {0x20,
        0x86,
        0x87,
        0x88,
        0x89,
...
const struct UnkLinkRfuStruct_02022B2C gUnknown_082ED608 = {0x04,
	0x20,
	0x00,
	0x00,
	0x02,
	...
	0x258,
	0x12c};
const u8 gUnknown_082ED620[]                             = {0, 3, 2, 1, 0};
const u32 gUnknown_082ED628[]                            = {0x000000,
        0x000001,
        0x000003,
        0x000007,
        0x00000f,
        ...
        0x7fffff,
        0xffffff};
const u8 gUnknown_082ED68C[] = {0, 0, 1, 1, 2, 2, 2, 2, 3};
...
const struct
{
	u8* buffer;
	u32 size;
} gUnknown_082ED6B8[]         = {{gBlockSendBuffer, 200},
        {gBlockSendBuffer, 200},
        {gBlockSendBuffer, 100},
        {gBlockSendBuffer, 220},
        {gBlockSendBuffer, 40}};
const u16 gUnknown_082ED6E0[] = {0x0002, 0x7f7d, 0x0000, 0xFFFF};

const char sUnref_082ED6E8[][15]   = {"RFU WAIT",
        "RFU BOOT",
        "RFU ERROR",
        "RFU RESET",
        "RFU CONFIG",
...
const char sUnref_082ED6E9[][16]   = {"              ",
        ...
        "RECOVER SUUSES",
        "RECOVER FAILED"};
const TaskFunc gUnknown_082ED7E0[] = {sub_801084C, sub_8010AAC, sub_8010D0C};
...
ALIGNED( 4 )
const char gUnknown_082ED82C[31] = {' ',
	' ',
	' ',
	' ',
	' ',
	...
	' ',
	0x00};
const char gUnknown_082ED84B[16] = {' ',
	' ',
	' ',
	' ',
	' ',
	...
	' ',
	0x00};
const char gUnknown_082ED85B[9]  = {
        ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 0x00};
...
const char gUnknown_082ED8A8[3][8]           = {"CHILD ", "PARENT", "SEARCH"};
...
u32 sub_800BEC0( void )
{
	...
	if( gUnknown_03004140.unk_04 != 0x17 &&
		gUnknown_03004140.unk_04 != 0x01 )
	{
...
s32 sub_800BF4C( void ( *func1 )( u8, u8 ), void ( *func2 )( u16 ) )
{
	...
	CpuFill16( 0,
		&gUnknown_03004140,
		offsetof( struct UnkRfuStruct_1, filler_48 ) );
	gUnknown_03004140.unk_06 = -1;
...
void sub_800BFA0( void )
{
	CpuFill16( 0,
		&gUnknown_03004140,
		offsetof( struct UnkRfuStruct_1, unk_40 ) );
	gUnknown_03004140.unk_06 = -1;
}
...
void sub_800C048( void ) { gUnknown_03004140.unk_04 = 0x15; }
...
u8 sub_800C054( u8 r5, u16 r7, u16 r8, const u16* r6 )
{
	...
	if( gUnknown_03004140.unk_04 != 0 &&
		( gUnknown_03004140.unk_04 != 0x08 || r5 != 1 ) )
	{
...
bool8 sub_800C36C( u16 a0 )
{
	...
	if( gUnknown_03007890->unk_00 == 1 )
	{
		if( sp2 )
		{
			for( i = 0; i < 4; i++ )
			{
				if( ( gUnknown_03004140.unk_30 >> i ) & 1 &&
					( sp2 >> i ) & 1 )
				{
					gUnknown_03004140.unk_34[i] = 0;
				}
	...
	else
	{
		...
		do
		{
			if( gUnknown_03004140.unk_04 != 0 )
			{
				...
				{
				case 23:
					r2 = sub_800BEC0( ) == 0x8001 ? 0x44
								      : 0xFF;
					gUnknown_03004140.unk_04 =
						gUnknown_03004140.unk_05 = 0;
					sub_800D30C( r2, 0 );
					break;
				case 1:
		...
		} while( gUnknown_03004140.unk_04 == 18 ||
...
static void sub_800C7B4( u16 r8, u16 r6 )
{
	...
	if( gUnknown_03004140.unk_0e != 0 )
	{
		...
		case 28:
			if( r6 == 0 )
			{
				if( gUnknown_03004140.unk_0b == 1 &&
					gUnknown_03004140.unk_1a > 1 )
				{
					gUnknown_03004140.unk_1a--;
				}
				gUnknown_03004140.unk_04 =
					gUnknown_03004140.unk_05 = 10;
			}
			break;
		case 29:
			if( r6 == 0 )
		...
		case 33:
					...
					&sp0, &gUnknown_03004140.unk_10 ) )
			{
				if( !sp0 )
				{
					...
					gUnknown_03004140.unk_14 =
						gUnknown_03004140.unk_10;
				}
				else
				{
					gUnknown_03004140.unk_04 =
		...
		case 50:
			if( r6 == 0 )
			{
				...
				for( gUnknown_03004140.unk_10 = 0;
					gUnknown_03004140.unk_10 < 4;
					gUnknown_03004140.unk_10++ )
				{
					if( ( gUnknown_03007890->unk_03 >>
						    gUnknown_03004140
							    .unk_10 ) &
						1 )
					{
		...
		case 51:
			if( r6 == 0 &&
				!rfu_CHILD_getConnectRecoveryStatus( &sp0 ) &&
				sp0 < 2 )
			{
				gUnknown_03004140.unk_04 = 18;
			}
			if( gUnknown_03004140
					.unk_34[gUnknown_03004140.unk_10] &&
				--gUnknown_03004140.unk_34[gUnknown_03004140
								   .unk_10] ==
					0 )
			{
				gUnknown_03004140.unk_04 = 18;
		...
		case 52:
				...
				!rfu_CHILD_getConnectRecoveryStatus( &sp0 ) )
			{
				...
				gUnknown_03004140
					.unk_34[gUnknown_03004140.unk_10] = 0;
				gUnknown_03004140.unk_30                  = 0;
				gUnknown_03004140.unk_0a                  = 0;
				sub_800D30C( gUnknown_03004140.unk_1e, 0x01 );
				gUnknown_03004140.unk_1e = 0;
		...
		case 39:
			if( r6 == 0 )
			{
				...
				{
					gUnknown_03004140.unk_04 =
						gUnknown_03004140.unk_11;
					gUnknown_03004140.unk_05 =
						gUnknown_03004140.unk_12;
				...
				else if( gUnknown_03004140.unk_05 == 15 )
				{
					...
					gUnknown_03004140.unk_02 = 1;
					sub_800D30C( 0x41, 0x00 );
					gUnknown_03004140.unk_24 |= 1
						<< gUnknown_03004140.unk_10;
					gUnknown_03004140.unk_28
						[gUnknown_03004140.unk_10] =
						gUnknown_03004140.unk_26;
					rfu_clearSlot(
						4, gUnknown_03004140.unk_10 );
					tmp  = &sp0;
					*tmp = rfu_NI_CHILD_setSendGameName(
						gUnknown_03004140.unk_10,
						0x0e );
					if( *tmp )
					{
	...
	else if( r6 == 3 && gUnknown_03004140.unk_0f &&
		( r8 == 0x24 || r8 == 0x26 || r8 == 0x27 ) )
	{
		rfu_REQ_RFUStatus( );
		rfu_waitREQComplete( );
		...
		if( r6 == 0 )
		{
			...
			if( gUnknown_03004140.unk_07 )
			{
				if( gUnknown_03007890->unk_00 == 0xFF )
				{
					...
					else if( gUnknown_03004140.unk_04 !=
							6 &&
						gUnknown_03004140.unk_04 != 7 )
					{
						gUnknown_03004140.unk_07 = 1;
...
static void sub_800CF34( void )
{
	...
	if( gUnknown_03004140.unk_04 == 5 || gUnknown_03004140.unk_04 == 6 ||
		gUnknown_03004140.unk_04 == 7 ||
		gUnknown_03004140.unk_04 == 8 )
	{
		flags = ( ( gUnknown_03007890->unk_02 ^
				  gUnknown_03004140.unk_0c ) &
				gUnknown_03007890->unk_02 ) &
			~gUnknown_03007890->unk_07;
		...
		for( i = 0; i < 4; i++ )
		{
			...
			else if( gUnknown_03004140.unk_24 & r4 )
			{
				if( gUnknown_03007880[i]->unk_34 == 0x46 )
				{
					...
					{
						r5 = 0x02;
						for( ptr = gUnknown_03004140
								   .unk_20;
							*ptr != 0xFFFF;
							ptr++ )
						{
							if( gUnknown_03007890
									->unk_14[i]
									.unk_04 ==
								*ptr )
							{
		...
		if( gUnknown_03004140.unk_0d )
		{
			...
			if( gUnknown_03007890->unk_06 &&
				( ( gUnknown_03004140.unk_03 &
					  gUnknown_03004140.unk_00 ) !=
					gUnknown_03004140.unk_00 ) )
			{
				r5 = 0x00;
			}
			if( r5 )
			{
				...
				gUnknown_03004140.unk_14 =
					gUnknown_03004140.unk_0d;
				gUnknown_03004140.unk_0d = 0;
				sub_800D30C( 0x12, 0x01 );
			}
		}
		if( gUnknown_03004140.unk_24 == 0 &&
			gUnknown_03004140.unk_04 == 8 )
		{
			if( gUnknown_03004140.unk_07 == 0 )
			{
...
static void sub_800D158( void )
{
	...
	{
		if( --gUnknown_03004140.unk_28[gUnknown_03004140.unk_10] ==
				0 ||
			gUnknown_03007880[gUnknown_03004140.unk_10]->unk_0 ==
				0x27 )
		{
			sub_800D630( );
			gUnknown_03004140.unk_04 = 24;
			rfu_clearSlot( 4, gUnknown_03004140.unk_10 );
			gUnknown_03004140.unk_24 &=
				~( 1 << gUnknown_03004140.unk_10 );
	...
	if( gUnknown_03004140.unk_04 == 24 )
	{
		...
		if( gUnknown_03004140.unk_02 == 0 )
		{
			gUnknown_03004140.unk_04 = gUnknown_03004140.unk_05 =
				0;
			sub_800D334( gUnknown_03007890->unk_02 |
				gUnknown_03007890->unk_03 );
...
{
	if( gUnknown_03004140.unk_04 == 15 &&
		gUnknown_03007880[gUnknown_03004140.unk_10]->unk_0 == 0x26 )
	{
...
static void sub_800D358( u8 a0 )
{
	...
	if( gUnknown_03007890->unk_04 )
	{
		for( i = 0; i < 4; i++ )
		{
			if( gUnknown_03007880[i]->unk_0 & 0x8000 &&
				gUnknown_03007880[i]->unk_1a & a0 )
			{
				rfu_changeSendTarget( 0x20,
					i,
					gUnknown_03007880[i]->unk_1a & ~a0 );
			}
		}
	...
	if( gUnknown_03007890->unk_05 )
	{
		for( i = 0; i < 4; i++ )
		{
			if( gUnknown_03007880[i]->unk_34 & 0x8000 &&
				gUnknown_03007880[i]->unk_4e & a0 )
			{
	...
	if( gUnknown_03007890->unk_06 )
	{
		...
		for( i = 0; i < 4; i++ )
		{
			if( gUnknown_03007870[i]->unk_0 == 0x8024 &&
				a0 & gUnknown_03007870[i]->unk_3 )
			{
...
static void sub_800D434( void )
{
	...
	if( gUnknown_03004140.unk_18 )
	{
		...
		if( gUnknown_03007890->unk_05 )
		{
			...
			{
				if( gUnknown_03007880[i]->unk_34 & 0x8000 &&
					gUnknown_03007880[i]->unk_36 >
						gUnknown_03004140.unk_18 )
				{
					rfu_NI_stopReceivingData( i );
				}
			}
...
{
	if( gUnknown_03004140.unk_04 == 9 || gUnknown_03004140.unk_04 == 10 ||
		gUnknown_03004140.unk_04 == 11 )
	{
...
void sub_800DD94(
	struct UnkLinkRfuStruct_02022B14* data, u8 r9, bool32 r2, s32 r3 )
{
	s32 i;

	for( i = 0; i < 2; i++ )
	{
		data->unk_00.playerTrainerId[i] =
...
bool8 sub_800DE7C( struct UnkLinkRfuStruct_02022B14* buff1, u8* buff2, u8 idx )
{
	...
	if( gUnknown_03004140.unk_06 == 1 )
	{
		...
		if( sub_8010454( gUnknown_03007890->unk_14[idx].unk_04 ) &&
			( ( gUnknown_03007890->unk_07 >> idx ) & 1 ) )
		{
			memcpy( buff1,
				&gUnknown_03007890->unk_14[idx].unk_06,
				0xD );
			memcpy( buff2,
				gUnknown_03007890->unk_14[idx].playerName,
		...
		else
		{
			...
			memset( buff2,
				0,
				sizeof( gUnknown_03007890->unk_14[idx]
						.playerName ) );
		}
	}
	else
...
void CreateWirelessStatusIndicatorSprite( u8 x, u8 y )
{
	...
	{
		sprId = CreateSprite(
			&sWirelessStatusIndicatorSpriteTemplate, x, y, 0 );
		gSprites[sprId].data[7] = 0x1234;
		gSprites[sprId].data[6] = GetSpriteTileStartByTag(
			sWirelessStatusIndicatorSpriteSheet.tag );
...
void DestroyWirelessStatusIndicatorSprite( void )
{
	if( gSprites[gWirelessStatusIndicatorSpriteId].data[7] == 0x1234 )
	{
		...
		CpuCopy16( &gDummyOamData,
			(struct OamData*)OAM + 125,
...
void LoadWirelessStatusIndicatorSpriteGfx( void )
{
	if( GetSpriteTileStartByTag(
		    sWirelessStatusIndicatorSpriteSheet.tag ) == 0xFFFF )
	{
...
void sub_800E174( void )
{
		...
		gSprites[gWirelessStatusIndicatorSpriteId].data[7] == 0x1234 )
	{
		...
		if( sprite->anims[sprite->data[2]][sprite->data[4]]
				.frame.duration < sprite->data[3] )
		{
			sprite->data[4]++;
			sprite->data[3] = 0;
			if( sprite->anims[sprite->data[2]][sprite->data[4]]
		...
		gMain.oamBuffer[125].x =
			sprite->pos1.x + sprite->centerToCornerVecX;
		gMain.oamBuffer[125].y =
			sprite->pos1.y + sprite->centerToCornerVecY;
		gMain.oamBuffer[125].paletteNum = sprite->oam.paletteNum;
		gMain.oamBuffer[125].tileNum    = sprite->data[6] +
			sprite->anims[sprite->data[2]][sprite->data[4]]
				.frame.imageValue;
		CpuCopy16( gMain.oamBuffer + 125,
			(struct OamData*)OAM + 125,
			sizeof( struct OamData ) );
		if( sub_8011A74( ) == 1 )
		{
...
void CopyTrainerRecord(
	struct TrainerNameRecord* dest, u32 trainerId, const u8* name )
{
...
void RecordMixTrainerNames( void )
{
	if( gWirelessCommType != 0 )
	{
		...
		struct TrainerNameRecord* newRecords =
			calloc( 20, sizeof( struct TrainerNameRecord ) );

		// Check if we already have a record saved for connected
		// trainers.
		...
		for( i = 0; i < GetLinkPlayerCount( ); i++ )
		{
				...
				gLinkPlayers[i].language != LANGUAGE_JAPANESE )
			{
				CopyTrainerRecord( &newRecords[nextSpace],
					(u16)gLinkPlayers[i].trainerId,
					gLinkPlayers[i].name );

				// If we already had a record for this trainer,
				// wipe it so that the next step doesn't
				// duplicate it.
				if( connectedTrainerRecordIndices[i] >= 0 )
				{
					memset( gSaveBlock1Ptr
							->trainerNameRecords[connectedTrainerRecordIndices
									[i]]
							.trainerName,
						0,
						8 );
		...
		// Copy all non-empty records to the new list, in the order
		// they appear on the old list. If the list is full, the last
		// (oldest) records will be dropped.
		for( i = 0; i < 20; i++ )
		{
			if( NameIsNotEmpty(
		...
		memcpy( gSaveBlock1Ptr->trainerNameRecords,
			newRecords,
			20 * sizeof( struct TrainerNameRecord ) );
		free( newRecords );
	}
}
...
bool32 sub_800E540( u16 id, u8* name )
{
	...
	for( i = 0; i < 20; i++ )
	{
		...
		if( !NameIsNotEmpty( gSaveBlock1Ptr->trainerNameRecords[i]
					     .trainerName ) )
		{
			return FALSE;
		}
...
{
	if( !rfu_initializeAPI( gUnknown_03004140.unk_50,
		    sizeof gUnknown_03004140.unk_50,
		    gIntrTable + 1,
		    TRUE ) )
	{
		gLinkType = 0;
...
void sub_800E748( u8 taskId )
{
	...
	case 2:
		sub_800C054(
			gUnknown_03005000.unk_0c, 0, 240, gUnknown_082ED6E0 );
...
s32 sub_800E87C( u8 idx ) { return gUnknown_082ED6A5[idx]; }
...
void sub_800E88C( s32 r2, s32 r5 )
{
	...
	else
	{
		...
		{
			for( i = 0;
				i < 4 && gUnknown_03005000.unk_cde[i] != r4;
				i++ )
				;
			if( i == 4 )
			{
...
void sub_800E94C( u8 taskId )
{
	...
	case 6:
		sub_800C054(
			gUnknown_03005000.unk_0c, 0, 0xf0, gUnknown_082ED6E0 );
	...
	case 12: {
		...
		rfu_setRecvBuffer( 16,
			gUnknown_03005000.unk_c3e,
			gUnknown_03005000.unk_c3f,
			70 );
...
static void sub_800EAB4( void )
{
	...
	for( i = 0; i < 4; i++ )
	{
		...
		{
			rfu_setRecvBuffer(
				16, i, gUnknown_03005000.unk_14[i], 14 );
			rfu_clearSlot( 3, i );
		}
		r5 >>= 1;
	}
...
void sub_800EB44( u8 taskId )
{
	...
	case 18:
		break;
	case 13:
		if( rfu_UNI_setSendData( 1 << gUnknown_03005000.unk_c3e,
			    gUnknown_03005000.unk_4c,
			    14 ) == 0 )
		{
...
void sub_800ED10( void ) { sub_800C054( 1, 0, 240, gUnknown_082ED6E0 ); }

void sub_800ED28( void ) { sub_800C27C( FALSE ); }
...
void sub_800ED34( u16 unused )
{
	...
	if( gUnknown_03007870[gUnknown_03005000.unk_c3e]->unk_12 )
	{
		...
		sub_800D7D8( &gUnknown_03005000.unk_124,
			gUnknown_03005000.unk_c3f );
...
static void sub_800EDBC( u16 unused ) { gUnknown_03005000.unk_cdb = 1; }
...
void sub_800EDD4( void )
{
	...
	for( i = 0; i < 3; i++ )
	{
		...
		{
			DestroyTask(
				FindTaskIdByFunc( gUnknown_082ED7E0[i] ) );
		}
	}
}
...
{
	if( gUnknown_03005000.unk_04 == 7 &&
		!sub_800C12C(
			gUnknown_03007890->unk_14[gUnknown_03005000.unk_c3d]
				.unk_00,
			240 ) )
	{
...
void sub_800EF7C( void ) { gUnknown_03005000.unk_04 = 14; }
...
void sub_800EFB0( void )
{
	...
	for( i = 0; i < 5; i++ )
	{
		for( j = 0; j < 7; j++ )
		{
			gUnknown_03005000.unk_c87[i][j][1] =
				gRecvCmds[i][j] >> 8;
...
static void sub_800F048( void )
{
	...
	{
		u8 r2 = sub_800DAC8(
			&gUnknown_03005000.unk_c1c, gUnknown_03005000.unk_4c );
	...
	{
		sub_800D9DC(
			&gUnknown_03005000.unk_9e8, gUnknown_03005000.unk_4c );
		sub_800DA68(
			&gUnknown_03005000.unk_c1c, gUnknown_03005000.unk_4c );
	}
}
...
bool32 sub_800F1E0( void )
{
	...
	if( gUnknown_03005000.unk_04 >= 20 && gUnknown_03005000.unk_0e == 1 )
	{
		...
		rfu_REQ_recvData( );
		rfu_waitREQComplete( );
		if( ( gUnknown_03004140.unk_03 & gUnknown_03005000.unk_ce2 ) ==
			gUnknown_03005000.unk_ce2 )
		{
			...
			for( i = 0; i < 4; i++ )
			{
				if( flags & 1 )
				{
					...
					{
						if( gUnknown_03005000.unk_cee
									[i] !=
								0xFF &&
							( gUnknown_03005000.unk_14
									[i]
									[0] >>
								5 ) !=
								( ( gUnknown_03005000
			...
			sub_800F86C( 0 );
			sub_8010528( );
			if( gUnknown_03005000.unk_ce5 &&
				!gUnknown_03005000.unk_cd9 )
			{
				...
				sub_800E88C( gUnknown_03005000.unk_ce2,
					gUnknown_03005000.unk_ce2 |
						gUnknown_03005000.unk_ce5 );
				gUnknown_03005000.unk_ce9 =
					gUnknown_03005000.unk_ce5;
				gUnknown_03005000.unk_ce2 |=
					gUnknown_03005000.unk_ce5;
				gUnknown_03005000.unk_ce5 = 0;
				rfu_UNI_setSendData( gUnknown_03005000.unk_ce2,
					gUnknown_03005000.unk_c87,
					70 );
				gUnknown_03005000.unk_cda = sub_800E87C(
					gUnknown_03005000.unk_ce2 );
...
void sub_800F498( u16* a0, u8* a1 )
{
	...
	if( a0[0] )
	{
		...
		gUnknown_03005000.unk_102 =
			( gUnknown_03005000.unk_102 + 1 ) & 7;
		for( i = 0; i < 7; i++ )
		{
			a1[2 * i + 1] = a0[i] >> 8;
			a1[2 * i + 0] = a0[i];
...
bool32 sub_800F4F0( void )
{
	...
	{
		rfu_REQ_disconnect( gUnknown_03007890->unk_02 |
			gUnknown_03007890->unk_03 );
		rfu_waitREQComplete( );
...
void sub_800F638( u8 unused, u32 flags )
{
	...
	for( i = 0; i < gUnknown_03005000.unk_6c.unk_02; i++ )
	{
		if( !( flags & 1 ) )
		{
			...
			for( j = 0; j < 7; j++ )
			{
				gUnknown_03000D90[j + 1] =
					( r10[12 * i + ( j << 1 ) + 1] << 8 ) |
					r10[12 * i + ( j << 1 ) + 0];
			}
			for( j = 0; j < 7; j++ )
			{
				gUnknown_03000D80[2 * j + 1] =
					gUnknown_03000D90[j] >> 8;
				gUnknown_03000D80[2 * j + 0] =
					gUnknown_03000D90[j];

				j++;
				j--; // Needed to match;
			}
			sub_800D888( &gUnknown_03005000.unk_9e8,
				gUnknown_03000D80 );
...
void sub_800F804( void ) { gUnknown_03005000.unk_00 = rfu_func_080F97B8; }

void Rfu_set_zero( void ) { gUnknown_03005000.unk_00 = NULL; }
...
static void sub_800F86C( u8 unused )
{
	...
	for( i = 0; i < MAX_RFU_PLAYERS; i++ )
	{
		...
		case 0x7700:
			if( gUnknown_03007890->unk_00 == 0 )
			{
				gUnknown_03005000.playerCount =
					gRecvCmds[i][1];
				gUnknown_03005000.unk_cce = sub_800F74C(
					(u8*)( gRecvCmds[i] + 2 ) );
			}
			break;
		case 0x8800:
			if( gUnknown_03005000.unk_80[i].unk_12 == 0 )
			{
				...
				gUnknown_03005000.unk_80[i].unk_02 =
					gRecvCmds[i][1];
				gUnknown_03005000.unk_80[i].unk_11 =
					gRecvCmds[i][2];
		...
		case 0x8900:
			...
			{
				gUnknown_03005000.unk_80[i].unk_00 =
					gRecvCmds[i][0] & 0xff;
				gUnknown_03005000.unk_80[i].unk_08 |=
					( 1 << gUnknown_03005000.unk_80[i]
							.unk_00 );
				for( j = 0; j < 6; j++ )
					gBlockRecvBuffer[i][gUnknown_03005000
								    .unk_80[i]
								    .unk_00 *
							6 +
						j] = gRecvCmds[i][j + 1];
				if( gUnknown_03005000.unk_80[i].unk_08 ==
					gUnknown_082ED628[gUnknown_03005000
								  .unk_80[i]
								  .unk_02] )
				{
			...
			break;
		case 0xa100:
			sub_800FE84( gUnknown_082ED6B8[gRecvCmds[i][1]].buffer,
				(u16)gUnknown_082ED6B8[gRecvCmds[i][1]].size );
			break;
		case 0x5f00:
...
bool8 sub_800FC88( void )
{
	...
	{
		if( gUnknown_03005000.unk_80[i].unk_12 != 2 ||
			gUnknown_03005000.unk_5c[i] != 1 )
			return FALSE;
	}
	return TRUE;
...
void sub_800FE50( u16* a0 )
{
	...
	{
		memcpy( gUnknown_03005000.unk_f2,
			a0,
			sizeof( gUnknown_03005000.unk_f2 ) );
		sub_800FD14( 0x2f00 );
	}
}
...
static void rfufunc_80F9F44( void )
{
	if( gSendCmd[0] == 0 )
	{
		...
		{
			if( ( gRecvCmds[GetMultiplayerId( )][0] & 0xff00 ) ==
				0x8800 )
				gUnknown_03005000.unk_00 = sub_800FFB0;
		}
	}
...
static void sub_800FFB0( void )
{
	...
	for( i = 0; i < 7; i++ )
		gSendCmd[i + 1] =
			( src[( i << 1 ) +
				  gUnknown_03005000.unk_6c.unk_00 * 12 + 1]
				<< 8 ) |
			src[( i << 1 ) + gUnknown_03005000.unk_6c.unk_00 * 12 +
				0];
	gUnknown_03005000.unk_6c.unk_00++;
	if( gUnknown_03005000.unk_6c.unk_02 <=
		gUnknown_03005000.unk_6c.unk_00 )
	{
...
static void rfufunc_80FA020( void )
{
	...
	{
		gSendCmd[0] =
			( ~0x76ff ) | ( gUnknown_03005000.unk_6c.unk_02 - 1 );
		for( i = 0; i < 7; i++ )
			gSendCmd[i + 1] =
				( src[( i << 1 ) +
					  ( gUnknown_03005000.unk_6c.unk_02 -
						  1 ) *
						  12 +
					  1]
					<< 8 ) |
				src[( i << 1 ) +
					( gUnknown_03005000.unk_6c.unk_02 -
						...
						12 +
					0];
		if( (u8)gRecvCmds[mpId][0] ==
			gUnknown_03005000.unk_6c.unk_02 - 1 )
		{
			if( gUnknown_03005000.unk_80[mpId].unk_08 !=
				gUnknown_082ED628[gUnknown_03005000
							  .unk_80[mpId]
							  .unk_02] )
			{
				sub_800F638( mpId,
					gUnknown_03005000.unk_80[mpId]
						.unk_08 );
...
{
	rfu_REQ_disconnect(
		gUnknown_03007890->unk_02 | gUnknown_03007890->unk_03 );
	rfu_waitREQComplete( );
	sub_801011C( );
}
...
void sub_8010390( void )
{
	...
	if( GetMultiplayerId( ) != 0 )
	{
		if( gUnknown_03005000.unk_124.unk_8c2 == 0 &&
			gSendCmd[0] == 0 )
		{
			sub_800FD14( 0x6600 );
			gUnknown_03005000.unk_00 = sub_80102B8;
...
u8 sub_80104F4( void ) { return gUnknown_03005000.playerCount; }
...
bool8 sub_8010540( void )
{
	...
	for( i = 0; i < 4; i++ )
	{
		if( gUnknown_03005000.unk_cd1[i] < 5 ||
			gUnknown_03005000.unk_cd1[i] > 6 )
		{
			if( gUnknown_03007880[i]->unk_34 == 0x46 ||
				gUnknown_03007880[i]->unk_34 == 0x48 )
			{
				if( gUnknown_03005000.unk_cd5[i] == 8 )
				{
					...
					rfu_clearSlot( 8, i );
					rfu_NI_setSendData( 1 << i,
						8,
						gUnknown_03005000.unk_cd1 + i,
						1 );
					retval = TRUE;
				}
			}
...
void sub_80106D4( void )
{
	...
	rfu_NI_setSendData( 1 << gUnknown_03005000.unk_c3e,
		8,
		&gUnknown_03005000.unk_c85,
		1 );
}
...
void sub_8010750( void )
{
	...
	for( i = 0; i < 4; i++ )
	{
		if( gUnknown_03007880[i]->unk_0 == 0x26 ||
			gUnknown_03007880[i]->unk_0 == 0x27 )
		{
			if( gUnknown_03005000.unk_cd5[i] == 10 )
				gUnknown_03005000.unk_cd5[i] = 11;
			rfu_clearSlot( 4, i );
...
s32 sub_80107A0( void )
{
	...
	{
		if( gUnknown_03007880[gUnknown_03005000.unk_c3e]->unk_0 ==
				0x26 ||
			gUnknown_03007880[gUnknown_03005000.unk_c3e]->unk_0 ==
				0x27 )
			rfu_clearSlot( 4, gUnknown_03005000.unk_c3e );
	}
	if( gUnknown_03007880[gUnknown_03005000.unk_c3e]->unk_34 == 0x46 ||
		gUnknown_03007880[gUnknown_03005000.unk_c3e]->unk_34 == 0x48 )
	{
...
void sub_8010AAC( u8 taskId )
{
	...
	u8 r4 = gUnknown_03005000
			.unk_cde[gUnknown_082ED68C[gUnknown_03005000.unk_ce9]];
	if( gUnknown_03005000.unk_f1 == 1 || gUnknown_03005000.unk_f1 == 2 )
	{
		gUnknown_03005000.unk_ce8 = 0;
		DestroyTask( taskId );
	...
	case 5:
		if( IsLinkTaskFinished( ) && GetBlockReceivedStatus( ) & 1 )
		{
			CpuFill16( 0,
				gBlockRecvBuffer,
				sizeof( struct UnkRfuStruct_8010A14 ) );
			ResetBlockReceivedFlag( 0 );
			gUnknown_03005000.unk_ce8 = 0;
			if( gUnknown_03005000.unk_ce6 )
			{
...
void sub_8010D0C( u8 taskId )
{
	...
	case 2:
		...
		{
			sub_8010A14( (const struct UnkRfuStruct_8010A14*)
					gBlockRecvBuffer );
			ResetBlockReceivedFlag( 0 );
			gReceivedRemoteLinkPlayers = 1;
			DestroyTask( taskId );
...
void sub_8010DB4( void )
{
	if( gUnknown_03005000.unk_ee == 1 && gUnknown_03004140.unk_02 == 0 )
	{
		if( gMain.callback2 == c2_mystery_gift_e_reader_run ||
			gUnknown_03004140.unk_3c->unk_04 )
			gWirelessCommType = 2;
		SetMainCallback2( CB2_LinkError );
		gMain.savedCallback = CB2_LinkError;
		sub_800AF18( ( gUnknown_03005000.unk_0a << 16 ) |
				( gUnknown_03005000.unk_10 << 8 ) |
				gUnknown_03005000.unk_12,
			gUnknown_03005000.unk_124.unk_8c2,
			gUnknown_03005000.unk_9e8.unk_232,
			sub_8011A74( ) == 2 );
		gUnknown_03005000.unk_ee = 2;
		CloseLink( );
	}
	else if( gUnknown_03005000.unk_9e8.unk_233 == 1 ||
		gUnknown_03005000.unk_124.unk_8c3 == 1 )
	{
		if( gUnknown_03004140.unk_02 )
			sub_800D630( );
...
void sub_80110B8( u32 a0 )
{
	...
	if( sub_800F7DC( )->unk_0a_0 == 0x45 )
	{
		...
		for( i = 0; i < 4; i++ )
		{
			...
			{
				r7 |= ( ( 0x80 |
						( ( gLinkPlayers[gUnknown_03005000
									 .unk_cde[i]]
								  .gender &
							  1 )
							<< 3 ) |
...
void sub_80111A0( void ) { gUnknown_03005000.unk_ee = 0; }
...
void sub_80111FC( void ) { gUnknown_03005000.unk_00 = sub_80111DC; }
...
void sub_801120C( u8 a0, u8 unused1 )
{
	...
	case 0x11:
		...
		for( i = 0; i < 4; i++ )
		{
			...
			{
				struct UnkLinkRfuStruct_02022B14* structPtr =
					&gUnknown_03007890->unk_14[i].unk_06;
				if( structPtr->unk_0a_0 ==
					sub_800F7DC( )->unk_0a_0 )
				{
					gUnknown_03005000.unk_cd1[i] = 0;
					gUnknown_03005000.unk_cd5[i] = 0;
					rfu_setRecvBuffer( 0x20,
						i,
						gUnknown_03005000.unk_cd5 + i,
						1 );
				}
				else
				{
	...
	case 0x14:
		...
		{
			rfu_REQ_disconnect( gUnknown_03005000.unk_ce7 ^
				gUnknown_03004140.unk_00 );
			rfu_waitREQComplete( );
		}
...
void sub_8011674( u8 a0, u8 unused1 )
{
	...
	case 0x33:
		...
		else if( gUnknown_03005000.unk_ce4 != 2 &&
			gReceivedRemoteLinkPlayers == 1 )
		{
			sub_8011170( a0 );
			sub_800C27C( 0 );
		...
		if( gUnknown_03007890->unk_00 == 0xFF &&
			gUnknown_03004140.unk_07 == 0 &&
			FuncIsActiveTask( sub_800EB44 ) == TRUE )
			gUnknown_03005000.unk_04 = 0x11;
...
void sub_8011A50( void ) { gUnknown_03005000.unk_ce4 = 2; }
...
u8 sub_8011A74( void ) { return gUnknown_03005000.unk_f1; }
...
bool32 sub_8011A9C( void ) { return gUnknown_03005000.unk_ce8; }

bool8 Rfu_IsMaster( void ) { return gUnknown_03005000.unk_0c; }

void RfuVSync( void ) { rfu_syncVBlank_( ); }

void sub_8011AC8( void ) { CpuFill32( 0, gRecvCmds, sizeof( gRecvCmds ) ); }
...
void sub_8011AFC( void )
{
	...
	if( IsWirelessAdapterConnected( ) )
	{
		...
		SetGpuReg( REG_OFFSET_DISPCNT,
			DISPCNT_OBJ_ON | DISPCNT_BG0_ON | DISPCNT_BG2_ON |
				DISPCNT_OBJ_1D_MAP );
		RunTasks( );
		AnimateSprites( );
		BuildOamBuffer( );
...
bool32 sub_8011B90( void ) { return FuncIsActiveTask( sub_800EB44 ); }
...
u8 sub_8011CE4( const u8* a0, u16 a1 )
{
	...
	{
		u16 trainerId =
			ReadU16( gUnknown_03007890->unk_14[i]
					 .unk_06.unk_00.playerTrainerId );
		if( sub_8010454( gUnknown_03007890->unk_14[i].unk_04 ) &&
			!StringCompare( a0,
				gUnknown_03007890->unk_14[i].playerName ) &&
			a1 == trainerId )
		{
			ret = i;
...
void sub_8011D6C( u32 a0 )
{
	...
	rfu_UNI_setSendData(
		gUnknown_03005000.unk_ce2, gUnknown_03005000.unk_c87, 70 );
...
void sub_8011DE0( u32 a0 )
{
	if( a0 != 0 )
	{
		...
		for( i = 0; i < 4; i++ )
		{
			if( gUnknown_03005000.unk_cde[i] == a0 &&
				( gUnknown_03005000.unk_ce2 >> i ) & 1 )
				var |= 1 << i;
		}
		if( var )
			sub_8011E94( var, 2 );
...
void sub_8011E2C( u8 taskId )
{
	if( gSendCmd[0] == 0 && gUnknown_03005000.unk_ce8 == 0 )
	{
		...
		gUnknown_03005000.playerCount -=
			gUnknown_082ED695[gTasks[taskId].data[0]];
...
void sub_8011EF4( u8 taskId )
{
	...
	if( sub_800EE94( ) )
	{
		...
		if( id != 0xFF )
		{
			...
			else if( sub_800F7DC( )->unk_0a_0 == 0x15 ||
				sub_800F7DC( )->unk_0a_0 == 0x16 )
			{
				data[15]++;
			}
			else
...
bool32 sub_801200C( s16 a1, struct UnkLinkRfuStruct_02022B14* structPtr )
{
	...
	{
		struct UnkLinkRfuStruct_02022B14* structPtr2 =
			&gUnknown_03005000.unk_10A;
...
void sub_801209C( u8 taskId )
{
	...
	{
		u16 trainerId = ReadU16(
			gUnknown_03005000.unk_10A.unk_00.playerTrainerId );
		u8 id = sub_8011CE4( gUnknown_03005000.playerName, trainerId );
		if( id != 0xFF )
		{
			if( !sub_801200C( gTasks[taskId].data[1],
				    &gUnknown_03007890->unk_14[id].unk_06 ) )
			{
				if( gUnknown_03007890->unk_14[id].unk_02 !=
						0xFF &&
					!sub_800C12C(
						gUnknown_03007890->unk_14[id]
							.unk_00,
						0x5A ) )
				{
...
void sub_8012188(
	const u8* name, struct UnkLinkRfuStruct_02022B14* structPtr, u8 a2 )
{
	u8 taskId, taskId2;
...
bool32 sub_8012240( void )
{
	...
	for( i = 0; i < 4; i++ )
	{
		if( ( gUnknown_03004140.unk_00 >> i ) & 1 &&
			gUnknown_03005000.unk_cd1[i] == 0 )
			return FALSE;
	}
...
void sub_801229C( void )
{
	...
	if( gUnknown_03005000.unk_0c == 1 )
	{
		for( i = 0; i < 4; i++ )
		{
			...
			{
				nullsub_13(
					gUnknown_03007890->unk_14[i].unk_04,
					1,
					i + 3,
					4 );
				nullsub_5( (void*)&gUnknown_03007890->unk_14[i]
						   .unk_06,
					6,
					i + 3 );
				nullsub_5( gUnknown_03007890->unk_14[i]
						   .playerName,
					0x16,
					i + 3 );
			}
		...
		for( i = 0; i < 4; i++ )
		{
			for( j = 0; j < 14; j++ )
			{
				nullsub_13( gUnknown_03005000.unk_14[i][j],
					j * 2,
					i + 11,
					2 );
			}
	...
	else if( gUnknown_03007890->unk_02 != 0 &&
		gUnknown_03007890->unk_07 != 0 )
	{
		for( i = 0; i < 4; i++ )
		{
		...
		nullsub_13(
			gUnknown_03007890->unk_14[gUnknown_03005000.unk_c3e]
				.unk_04,
			1,
			3,
			4 );
		nullsub_5( (void*)&gUnknown_03007890
				   ->unk_14[gUnknown_03005000.unk_c3e]
				   .unk_06,
			6,
			3 );
		nullsub_5( gUnknown_03007890->unk_14[gUnknown_03005000.unk_c3e]
				   .playerName,
			0x16,
			3 );
	}
		...
		for( i = 0; i < gUnknown_03007890->unk_08; i++ )
		{
			if( gUnknown_03007890->unk_14[i].unk_02 != 0xFF )
			{
				nullsub_13(
					...
					4 );
				nullsub_13(
					gUnknown_03007890->unk_14[i].unk_00,
					6,
					i + 3,
					4 );
				nullsub_5( gUnknown_03007890->unk_14[i]
...
u32 sub_80124C0( void ) { return gUnknown_03005000.unk_9e8.unk_232; }

u32 GetRfuRecvQueueLength( void ) { return gUnknown_03005000.unk_124.unk_8c2; }
