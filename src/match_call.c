...
static const struct MatchCallTrainerTextInfo sMatchCallTrainers[] = {
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 8 ),
                        TEXT_ID( 2, 8 ),
                        TEXT_ID( 3, 8 )},
	...
	},
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 12 ),
                        TEXT_ID( 2, 12 ),
                        TEXT_ID( 3, 12 )},
	...
	},
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 2 ),
                        TEXT_ID( 2, 2 ),
                        TEXT_ID( 3, 2 )},
	...
	},
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 1 ),
                        TEXT_ID( 2, 1 ),
                        TEXT_ID( 3, 1 )},
	...
	},
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 10 ),
                        TEXT_ID( 2, 10 ),
                        TEXT_ID( 3, 10 )},
	...
	},
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 9 ),
                        TEXT_ID( 2, 9 ),
                        TEXT_ID( 3, 9 )},
	...
	},
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 6 ),
                        TEXT_ID( 2, 6 ),
                        TEXT_ID( 3, 6 )},
	...
	},
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 4 ),
                        TEXT_ID( 2, 4 ),
                        TEXT_ID( 3, 4 )},
	...
	},
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 7 ),
                        TEXT_ID( 2, 7 ),
                        TEXT_ID( 3, 7 )},
	...
	},
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 5 ),
                        TEXT_ID( 2, 5 ),
                        TEXT_ID( 3, 5 )},
	...
	},
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 3 ),
                        TEXT_ID( 2, 3 ),
                        TEXT_ID( 3, 3 )},
	...
	},
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 11 ),
                        TEXT_ID( 2, 11 ),
                        TEXT_ID( 3, 11 )},
	...
	},
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 14 ),
                        TEXT_ID( 2, 14 ),
                        TEXT_ID( 3, 14 )},
	...
	},
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 13 ),
                        TEXT_ID( 2, 13 ),
                        TEXT_ID( 3, 13 )},
	...
	},
	{
		...
		.unused                              = 0,
		.battleTopicTextIds                  = {TEXT_ID( 1, 15 ),
                        TEXT_ID( 2, 3 ),
                        TEXT_ID( 3, 3 )},
...
static bool32 UpdateMatchCallMinutesCounter( void )
{
	...
	if( gMatchCallState.minutes > curMinutes ||
		curMinutes - gMatchCallState.minutes > 9 )
	{
...
static bool32 SelectMatchCallTrainer( void )
{
	...
	if( GetRematchTrainerLocation( matchCallId ) ==
...
static const u16 sUnknown_0860EA4C[] =
	INCBIN_U16( "graphics/unknown/unknown_60EA4C.gbapal" );
static const u8 sUnknown_0860EA6C[] =
	INCBIN_U8( "graphics/interface/menu_border.4bpp" );
static const u16 sPokeNavIconPalette[] =
	INCBIN_U16( "graphics/pokenav/icon.gbapal" );
static const u32 sPokeNavIconGfx[] =
	INCBIN_U32( "graphics/pokenav/icon.4bpp.lz" );
...
static bool32 LoadMatchCallWindowGfx( u8 taskId )
{
	...
	if( !decompress_and_copy_tile_data_to_vram(
		    0, sPokeNavIconGfx, 0, 0x279, 0 ) )
	{
		RemoveWindow( taskData[2] );
		DestroyTask( taskId );
		return FALSE;
...
static bool32 PrintMatchCallIntroEllipsis( u8 taskId )
{
	...
	if( !IsDma3ManagerBusyWithBgCopy( ) )
	{
		InitMatchCallTextPrinter(
			taskData[2], sText_PokenavCallEllipsis );
		return TRUE;
	}
	...
	if( !ExecuteMatchCallTextPrinter( taskData[2] ) )
	{
		...
		if( !gMatchCallState.triggeredFromScript )
			SelectMatchCallMessage(
				gMatchCallState.trainerId, gStringVar4 );
...
static bool32 sub_81963F0( u8 taskId )
{
	...
	if( !IsDma3ManagerBusyWithBgCopy( ) && !IsSEPlaying( ) )
	{
		...
		{
			sub_81973A4( );
			playerObjectId = GetEventObjectIdByLocalIdAndMap(
				EVENT_OBJ_ID_PLAYER, 0, 0 );
...
static void DrawMatchCallTextBoxBorder(
	u32 windowId, u32 tileOffset, u32 paletteId )
{
	...
	FillBgTilemapBufferRect_Palette0( bg,
		( ( paletteId << 12 ) & 0xF000 ) | ( tileNum + 0 ),
		x - 1,
		y - 1,
		1,
		1 );
	FillBgTilemapBufferRect_Palette0( bg,
		( ( paletteId << 12 ) & 0xF000 ) | ( tileNum + 1 ),
		x,
		y - 1,
		width,
		1 );
	FillBgTilemapBufferRect_Palette0( bg,
		( ( paletteId << 12 ) & 0xF000 ) | ( tileNum + 2 ),
		x + width,
		y - 1,
		1,
		1 );
	FillBgTilemapBufferRect_Palette0( bg,
		( ( paletteId << 12 ) & 0xF000 ) | ( tileNum + 3 ),
		x - 1,
		y,
		1,
		height );
...
static void sub_8196694( u8 taskId )
{
	...
	if( ++taskData[0] > 8 )
	{
		...
		WriteSequenceToBgTilemapBuffer(
			0, taskData[2] | ~0xFFF, 1, 15, 4, 4, 17, 1 );
		CopyBgTilemapBufferToVram( 0 );
	}
}
...
bool32 SelectMatchCallMessage( int trainerId, u8* str )
{
	...
	{
		matchCallText =
			GetDifferentRouteMatchCallText( matchCallId, str );
		retVal = TRUE;
...
static const struct MatchCallText* GetSameRouteMatchCallText(
	int matchCallId, u8* str )
{
...
static const struct MatchCallText* GetDifferentRouteMatchCallText(
	int matchCallId, u8* str )
{
	u16 textId =
		sMatchCallTrainers[matchCallId].differentRouteMatchCallTextId;
	int mask  = 0xFF;
	u32 topic = ( textId >> 8 ) - 1;
	u32 id    = ( textId & mask ) - 1;
	return &sMatchCallBattleRequestTopics[topic][id];
...
static const struct MatchCallText* GetBattleMatchCallText(
	int matchCallId, u8* str )
{
	int mask;
	u32 textId, topic, id;
...
static const struct MatchCallText* GetGeneralMatchCallText(
	int matchCallId, u8* str )
{
	int i;
	int count;
	...
	if( !( rand & 1 ) )
	{
		...
		if( count )
		{
			...
			{
				gBattleFrontierStreakInfo.streak =
					GetFrontierStreakInfo( i, &topic );
			...
			id = sMatchCallTrainers[matchCallId]
	...
	int matchCallId, const struct MatchCallText* matchCallText, u8* str )
{
	PopulateMatchCallStringVars(
		matchCallId, matchCallText->stringVarFuncIds );
	StringExpandPlaceholders( str, matchCallText->text );
}

static u8* const sMatchCallTextStringVars[] = {
	gStringVar1, gStringVar2, gStringVar3};

static void PopulateMatchCallStringVars(
	int matchCallId, const s8* stringVarFuncIds )
{
	int i;
	for( i = 0; i < 3; i++ )
	{
		if( stringVarFuncIds[i] >= 0 )
			PopulateMatchCallStringVar( matchCallId,
				stringVarFuncIds[i],
...
static void PopulateMatchCallStringVar(
	int matchCallId, int funcId, u8* destStr )
{
...
static void PopulateTrainerName( int matchCallId, u8* destStr )
{
	...
	for( i = 0; i < 6; i++ )
	{
		...
		{
			StringCopy(
				destStr, sMultiTrainerMatchCallTexts[i].text );
			return;
		}
	}
...
static void PopulateSpeciesFromTrainerLocation( int matchCallId, u8* destStr )
{
	...
	while( gWildMonHeaders[i].mapGroup != MAP_GROUP( UNDEFINED ) )
	{
		...
		if( gWildMonHeaders[i].mapGroup != MAP_GROUP( UNDEFINED ) )
		{
			...
			{
				StringCopy(
				   destStr, gSpeciesNames[species[Random( ) % numSpecies]] );
				return;
			}
		}
#endif /* 0 */
...
static void PopulateSpeciesFromTrainerParty( int matchCallId, u8* destStr )
{
	...
	trainerId = GetLastBeatenRematchTrainerId(
		sMatchCallTrainers[matchCallId].trainerId );
	...
	default:
		speciesName =
			gSpeciesNames[party.NoItemDefaultMoves[monId].species];
		break;
	case F_TRAINER_PARTY_CUSTOM_MOVESET:
		speciesName =
			gSpeciesNames[party.NoItemCustomMoves[monId].species];
		break;
	case F_TRAINER_PARTY_HELD_ITEM:
		speciesName =
			gSpeciesNames[party.ItemDefaultMoves[monId].species];
		break;
	case F_TRAINER_PARTY_CUSTOM_MOVESET | F_TRAINER_PARTY_HELD_ITEM:
		speciesName =
			gSpeciesNames[party.ItemCustomMoves[monId].species];
		break;
	}
...
{
	StringCopy( destStr,
		sBattleFrontierFacilityNames[gBattleFrontierStreakInfo
						     .facilityId] );
}
...
static void PopulateBattleFrontierStreak( int matchCallId, u8* destStr )
{
	...
	ConvertIntToDecimalStringN(
		destStr, gBattleFrontierStreakInfo.streak, 0, i );
}
...
static bool32 sub_8196D74( int matchCallId )
{
	...
	var1                     = ( ( dayCount ^ easyChatWord ) +
                       ( easyChatWord ^
                               GetGameStat( GAME_STAT_TRAINER_BATTLES ) ) ) ^
		otId;
	var2 = var1 % var0;
...
static u16 GetFrontierStreakInfo( u16 facilityId, u32* topicTextId )
{
			...
			for( j = 0; j < 2; j++ )
			{
				if( streak <
					gSaveBlock2Ptr->frontier
						.domeRecordWinStreaks[i][j] )
					streak = gSaveBlock2Ptr->frontier
							 .domeRecordWinStreaks
								 [i][j];
			}
		}
		*topicTextId = 3;
	...
	case FRONTIER_FACILITY_TOWER:
		for( i = 0; i < 4; i++ )
		{
			for( j = 0; j < 2; j++ )
			{
				if( streak <
					gSaveBlock2Ptr->frontier
						.towerRecordWinStreaks[i][j] )
					streak = gSaveBlock2Ptr->frontier
							 .towerRecordWinStreaks
								 [i][j];
			}
		}
		*topicTextId = 2;
	...
	case FRONTIER_FACILITY_PALACE:
		for( i = 0; i < 2; i++ )
		{
			for( j = 0; j < 2; j++ )
			{
				if( streak <
					gSaveBlock2Ptr->frontier
						.palaceRecordWinStreaks[i][j] )
					streak =
						gSaveBlock2Ptr->frontier
							.palaceRecordWinStreaks
								[i][j];
			}
		}
		*topicTextId = 2;
	...
	case FRONTIER_FACILITY_PIKE:
		for( i = 0; i < 2; i++ )
		{
			for( j = 0; j < 2; j++ )
			{
				// BUG: should be looking at battle pike
				// records.
				if( streak <
					gSaveBlock2Ptr->frontier
						.factoryRecordWinStreaks[i]
									[j] )
					streak =
						gSaveBlock2Ptr->frontier
							.factoryRecordWinStreaks
								[i][j];
			}
		}
		*topicTextId = 2;
	...
	case FRONTIER_FACILITY_ARENA:
		for( i = 0; i < 2; i++ )
		{
			if( streak < gSaveBlock2Ptr->frontier
					     .arenaRecordStreaks[i] )
				streak = gSaveBlock2Ptr->frontier
						 .arenaRecordStreaks[i];
		}
		*topicTextId = 2;
