...
static const u16 gRotatingBall_Pal[] =
	INCBIN_U16( "graphics/interface/bag_spinner.gbapal" );
static const u8 gRotatingBall[] =
	INCBIN_U8( "graphics/interface/bag_spinner.4bpp" );
static const u8 gCherryUnused[] = INCBIN_U8( "graphics/unused/cherry.4bpp" );
static const u16 gCherryUnused_Pal[] =
...
static const union AffineAnimCmd* const sBagAffineAnimCmds[] = {
	sSpriteAffineAnim_BagNormal, sSpriteAffineAnim_BagShake};
...
static void UpdateSwitchPocketRotatingBallCoords( struct Sprite* sprite )
{
	sprite->centerToCornerVecX =
		sprite->data[1] - ( ( sprite->data[3] + 1 ) & 1 );
...
void RemoveBagItemIconSprite( u8 id ) { RemoveBagSprite( id + 2 ); }

void sub_80D4FAC( void ) { sub_8122344( &gBagMenu->spriteId[4], 8 ); }

void sub_80D4FC8( u8 arg0 ) { sub_81223FC( &gBagMenu->spriteId[4], 8, arg0 ); }
...
static void LoadBerryGfx( u8 berryId )
{
	...
	LZDecompressWram(
		gBerryPicTable[berryId].tiles, &gDecompressionBuffer[0x1000] );
