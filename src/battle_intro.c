...
static void BattleIntroSlide1( u8 taskId )
{
	...
	case 3:
		...
		// Scanline settings have already been set in
		// CB2_InitBattleInternal()
		for( i = 0; i < 80; i++ )
			gScanlineEffectRegBuffers[gScanlineEffect.srcBuffer]
						 [i] = gTasks[taskId].data[2];
...
static void BattleIntroSlide2( u8 taskId )
{
	...
	if( gTasks[taskId].data[0] != 4 )
		SetGpuReg( REG_OFFSET_BLDALPHA,
			BLDALPHA_BLEND( gTasks[taskId].data[4], 0 ) );
}
	...
	u16 tilesOffset )
{
	...
	CpuCopy16( gMonSpritesGfxPtr->sprites[battlerPosition] +
...
#ifdef NONMATCHING
void unref_sub_8119094( u8 arg0,
	u8 arg1,
	u8 battlerPosition,
	u8 arg3,
	u8 arg4,
	...
	u8 arg7 )
{
	...
	int offset;
	DmaCopy16( 3,
		gMonSpritesGfxPtr->sprites[battlerPosition] +
			BG_SCREEN_SIZE * arg3,
